                                                ...
                                                <table class="formBgStyle" style="width: 98%; text-align: left;" cellpadding="3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="formItemBgStyleForAlignLeft" colspan="2" >
                                                            ...
                                                            &nbsp;<asp:Button ID="BT_DeletePhoto" runat="server" CssClass="inpu" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <div>
                                                            ...
                                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,ShuJuXingZhengMoBanGeShi%>"></asp:Label><a href="Template/UserInformationImportAddTemplate.xls"><asp:Label ID="Label24" runat="server" Text="<%$ Resources:lang,SJDRXZMB%>"></asp:Label></a>
                                                            <div id="ProgressBar">
