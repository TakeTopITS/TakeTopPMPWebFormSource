                                ...
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" valign="top" style="padding: 5px 5px 5px 5px;">
                                                            ...
                                                            <table class="formBgStyle" style="width: 98%; text-align: left;" cellpadding="3" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft" colspan="4">
                                                                        ...
                                                                        <asp:Button ID="btn_TrainingDelete" runat="server" Enabled="False" CssClass="inpu" Text="<%$ Resources:lang,ShanChu %>" OnClick="btn_TrainingDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft" >
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <div>
                                                                                    ...
                                                                                    <asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/EmployeeTrainingDataImportTemplate.xls"><asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,YGPXSJDRMB%>"></asp:Label></a>
                                                                                    <div id="ProgressBar">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft" colspan="4" >
                                                                        ...
                                                                        &nbsp;
                                                                        <asp:Button ID="BT_TrainingDelete" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_TrainingDelete_Click" Text="<%$ Resources:lang,ShanChu %>" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                                            ...
                                                            <table class="formBgStyle" style="width: 98%; text-align: left;" cellpadding="3" cellspacing="0">
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <div>
                                                                                    ...
                                                                                    <asp:Label ID="Label54" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/SpecialOperationDataImportTemplate.xls"><asp:Label ID="Label61" runat="server" Text="<%$ Resources:lang,TZZYSJDRMB%>"></asp:Label></a>
                                                                                    <div id="Div1">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                                        ...
                                                                        &nbsp;<asp:Button ID="Btn_OperationDelete" runat="server" CssClass="inpu" Enabled="False" Text="<%$ Resources:lang,ShanChu %>" OnClick="Btn_OperationDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                                                        ...
                                                                        <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                                                                        <ContentTemplate>
                                                                                            <div>
                                                                                                ...
                                                                                                <asp:Label ID="Label71" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/SpecialEquipmentDataImportTemplate.xls"><asp:Label ID="Label70" runat="server" Text="<%$ Resources:lang,TZSBSJDRMB%>"></asp:Label></a>
                                                                                                <div id="Div2">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                                                    ...
                                                                                    &nbsp;<asp:Button ID="BT_EquipmentDelete" runat="server" CssClass="inpu" Enabled="False" Text="<%$ Resources:lang,ShanChu %>" OnClick="BT_EquipmentDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                        ...
                                                                        <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="formItemBgStyleForAlignLeft" colspan="3">
                                                                                    ...
                                                                                    <asp:Button ID="BT_ProjectDelete" runat="server" Enabled="False" CssClass="inpu" Text="<%$ Resources:lang,ShanChu %>" OnClick="BT_ProjectDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="formItemBgStyleForAlignLeft" style="width: 100px; ">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                                                    ...
                                                                                    &nbsp;<asp:Button ID="BT_HolderDelete" runat="server" CssClass="inpu" Enabled="False" Text="<%$ Resources:lang,ShanChu %>" OnClick="BT_HolderDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                        ...
                                                                        <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                                                        <ContentTemplate>
                                                                                            <div>
                                                                                                ...
                                                                                                <asp:Label ID="Label108" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/PositionManagementDataImportTemplate.xls"><asp:Label ID="Label109" runat="server" Text="<%$ Resources:lang,GWGLSJDRMB%>"></asp:Label></a>
                                                                                                <div id="Div4">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                                                    ...
                                                                                    &nbsp;<asp:Button ID="BT_PostDelete" runat="server" CssClass="inpu" Enabled="False" Text="<%$ Resources:lang,ShanChu %>" OnClick="BT_PostDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
