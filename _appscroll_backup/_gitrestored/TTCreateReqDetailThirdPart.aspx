                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left;" class="formItemBgStyleForAlignLeft">
                                                                                    ...
                                                                                    <asp:Button ID="BT_Open" runat="server" CssClass="inpuActive" ToolTip ="<%$ Resources:lang,JiHuo%>" Enabled="False" OnClick="BT_Open_Click"  />
                                                                                                    ...
                                                                                                    &nbsp;
                                                                                    <asp:Button ID="BT_Delete" runat="server" CssClass="inpuDelete" ToolTip ="<%$ Resources:lang,ShanChu%>"  Enabled="False" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                                         </td></tr></table>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="继续分派">
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <table style="width: 95%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                            <tr>
                                                                                <td width="70%" class="ItemAlignLeft" class="formItemBgStyleForAlignLeft">
