                    ...
                    <td>
                        <table width="99%">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:ImageButton ID="BT_Delete" runat="server" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" ImageUrl="ImagesSkin/Delete.png" OnClick="BT_Delete_Click"></asp:ImageButton></td>
                            </tr>
                        </table>
