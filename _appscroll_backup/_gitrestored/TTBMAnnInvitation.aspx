                            ...
                            <table>
                                <tr>
                                    ...
                                    <td align="center" style="padding-top: 5px;">
                                        <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                            <tr>
                                                <td class="ItemAlignLeft">&nbsp;&nbsp;&nbsp;<asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,GongYingShang%>"></asp:Label>:<asp:TextBox ID="txt_SupplierInfo" runat="server" Width="120px"></asp:TextBox>
                                                </td>
                                                <td>
