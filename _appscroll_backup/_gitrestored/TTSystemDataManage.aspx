                            ...
                            <tr>
                                <td>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="border-right: solid 1px #d0d0d0; padding: 5px 5px 5px 5px;" class="ItemAlignLeft"
                                                valign="top">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:TextBox ID="TXT_DataName" runat="server" Width="250"></asp:TextBox></td>
                                                                                <td>
                                                                                    <asp:Button ID="BT_SaveDBPath" runat="server" CssClass="inpu" OnClick="BT_SaveDBPath_Click" Text="<%$ Resources:lang,BaoCun%>" /></td>
                                                                                <td>
                                                                                    <asp:Button ID="BT_CopyData" runat="server" CssClass="inpuLong" OnClick="BT_CopyData_Click" Text="<%$ Resources:lang,KaiShiBeiFen%>" /></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                            ...
                                            <td style="border-right: solid 1px #d0d0d0; padding: 5px 5px 5px 5px;" class="ItemAlignLeft"
                                                ...
                                                <table style="width: 98%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left; width: 60%; height: 25px;" class="formItemBgStyleForAlignLeft">&nbsp;</td>
                                                    </tr>
                                                </table>
                                                <br />
                                            </td>
