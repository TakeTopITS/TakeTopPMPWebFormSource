                        ...
                        <tr>
                            <td>
                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td valign="top" width="170" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0">
             ...
             Visible="False"></asp:Label>
                                                        ...
                                                        <table class="formBgStyle" width="98%" cellpadding="3" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:Button ID="BT_Update" runat="server" Text="<%$ Resources:lang,BaoCun%>" OnClick="BT_Update_Click" Enabled="False"
                                                                    CssClass="inpu" />&nbsp;
                                                                <asp:Button ID="BT_Delete" runat="server" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Enabled="False" 
                                                                    CssClass="inpu" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <tr>
                                                    <td colspan="6" style="height: 9px; text-align: center;">
                                                        <table cellpadding="0" cellspacing="0" width="98%" class="ItemAlignLeft">
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="100%" class="ItemAlignLeft">
                                                                        <tr>
