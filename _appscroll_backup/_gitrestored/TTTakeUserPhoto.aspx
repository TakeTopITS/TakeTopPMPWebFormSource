<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTTakeUserPhoto.aspx.cs"
    Inherits="TTTakeUserPhoto" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TakeTopMakePhoto</title>
    <style type="text/css">
        html, body
        {
            height: 100%;
...
<body>
    ...
    <asp:Button ID="BT_SaveUserPhoto" runat="server" CssClass="inpuLong" Text="<%$ Resources:lang,BaoCunYongHuXiangPian%>"
        OnClick="BT_SaveUserPhoto_Click" />
    </form>
</body>
