                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table cellpadding="0" cellspacing="0" width="100%" class="ItemAlignLeft" class="bian">
                                                ...
                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="Number">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Button ID="BT_ID" runat="server" CommandName="Update" CssClass="tt-sms-btn" Text='<%# DataBinder.Eval(Container.DataItem,"ID") %>' />
                                                            </ItemTemplate>
                            ...
                            <tr>
                                <td class="ItemAlignLeft" style="padding-top: 5px; width: 100%"></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <div class="modalPopup-text" style="width: 400px; height: 400px; overflow: auto;">
                            <table>
                                <tr>
                                    ...
                                    <td style="width: 10px; padding: 5px 5px 5px 5px;" valign="top" class="ItemAlignLeft">
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px; text-align: left;">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                <tr>
                                    ...
                                    <td colspan="3" class="ItemAlignLeft" class="auto-style3">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td class="ItemAlignLeft" class="auto-style3" style="height: 30px" colspan="3">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td class="ItemAlignLeft" class="auto-style3" colspan="3" style="height: 30px">
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px; text-align: left;">
                            ...
                            <table width="98%" cellpadding="4" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="ItemAlignLeft" style="width: 650px; height: 27px">
                                ...
                                <tr>
                                    <td class="ItemAlignLeft" colspan="2" style="height: 22px; text-align: left;">
                                </tr>
