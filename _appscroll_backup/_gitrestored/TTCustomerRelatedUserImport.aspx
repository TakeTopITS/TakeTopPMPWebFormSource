                                    ...
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                <table width="1600" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="29">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ItemAlignLeft" background="ImagesSkin/main_top_bj.jpg" style="text-align: left;" colspan="4">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        ...
                                                                        :<a href="Template/CustomerVisiblePersonnelImportTemplate.xls"><asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,KHKSRYDRMB%>"></asp:Label>
                                                                        </a>
                                                                        <div id="ProgressBar">
