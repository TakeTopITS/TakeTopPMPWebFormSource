                                        ...
                                        <tr>
                                            <td width="220px" valign="top" style="padding: 5px 5px 5px 5px; border-right: solid 1px #d0d0d0"
                                                ...
                                                <table width="220px" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td style="height: 13px;" class="ItemAlignLeft">
                                                        ...
                                                        <td>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;<asp:Button ID="BT_DeleteDocType" runat="server" OnClick="BT_DeleteDocType_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                                        ...
                                                        <td style="background: #F0F0F0; width: 100%; text-align: left;">
                                                            <table style="width: 99%; height: 12px;">
                                                                <tr>
                                                                    ...
                                                                    <td  class="ItemAlignLeft">
                                                                        <asp:TextBox ID="TB_DocName" runat="server" Width="80px"></asp:TextBox>
                                                                    </td>

                                                                    <td  align="right">
                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ShangChuanZhe%>"></asp:Label>:</td>
                                                                    <td >
                                                                        <asp:TextBox ID="TB_UploadManName" runat="server" Width="80px"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="21%" class="ItemAlignLeft">
                                                                                    <strong>
