        ...
        <form id="form1" runat="server">
                            ...
                            <tr>
                                <td>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="width: 250px; border-right: solid 1px #d0d0d0; padding: 10px 5px 5px 5px"
                                                ...
                                                <table style="width: 99%; text-align: center;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <asp:Button ID="BT_Update" runat="server" CssClass="inpu" OnClick="BT_Update_Click"
                                                            ...
                                                            &nbsp;
                                                        <asp:Button ID="BT_Delete" runat="server" CssClass="inpu" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
            ...
            <div class="layui-layer layui-layer-iframe" id="popFindAgencyWindow" name="fixedDiv"
                ...
                <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                    ...
                    <table>
                        <tr>
                            <td style="width: 900px; padding: 5px 5px 5px 5px;" valign="top" class="ItemAlignLeft">
