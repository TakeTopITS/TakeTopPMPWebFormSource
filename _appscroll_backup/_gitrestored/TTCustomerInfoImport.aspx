                                        ...
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                <table width="1600" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="29">&nbsp;</td>
                                                        <td class="ItemAlignLeft" background="ImagesSkin/main_top_bj.jpg" class="titlezi" colspan="4">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        ...
                                                                        :<a href="Template/CustomerArchiveInformationImportTemplate.xls"><asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,KHXXDRMB%>"></asp:Label>
                                                                        </a>
                                                                        <div id="ProgressBar">
