                                                                    ...
                                                                    <td valign="top" style="color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td style="color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                                                    <asp:Button ID="BT_DeletePlan" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_DeletePlan_Click"  OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"/>
                                                                                </td>
