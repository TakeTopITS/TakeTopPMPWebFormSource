<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTCollaborationDetailMainReadOnly.aspx.cs" Inherits="TTCollaborationDetailMainReadOnly" %>
...
<frameset rows="88,*" cols="*" frameborder="no" border="0" framespacing="0">
    <frame src="TTTakeTopPMPLogoForm.aspx" name="topFrame"  scrolling="no" />
      <frameset cols="55%,*" frameborder="no" border="0" framespacing="0"  >
      <frame src="TTCollaborationDetailReadOnly.aspx?CoID=<%=Request.QueryString["CoID"].ToString()%>" name="leftFrame"   / >
