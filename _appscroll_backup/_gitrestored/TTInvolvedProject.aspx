                    ...
                    <div id="AboveDiv">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                            ...
                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="false" PageSize="10"
                                                                ...
                                                                ShowHeader="true" Height="1px" OnPageIndexChanged="DataGrid1_PageIndexChanged"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundColumn DataField="Actor" HeaderText="<%$ Resources:lang,MyActor %>">
                                                                    ...
                                                                    <asp:BoundColumn DataField="JoinDate" HeaderText="<%$ Resources:lang,JoinTime %>" DataFormatString="{0:yyyy/MM/dd}">
                                                                    ...
                                                                    <asp:HyperLinkColumn DataNavigateUrlField="PMCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}"
                                                                        ...
                                                                        DataTextField="PMName" HeaderText="<%$ Resources:lang,PM %>" Target="_blank">
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="<%$ Resources:lang,WenDang %>">
                                                                        ...
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="5.5%" />
                                ...
                                <%-- <td width="250" valign="top" style="padding: 5px 5px 5px 5px; border-left: solid 1px #d0d0d0; border-right: solid 1px #d0d0d0;"
