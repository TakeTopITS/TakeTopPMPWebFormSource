                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td class="ItemAlignLeft" colspan="2" style="height: 6px; text-align: right;">
                                        <table width="100%">
                                            <tr>
                                                <td class="ItemAlignLeft" style="width: 550px; height: 27px"><span style="font-size: 10pt">(<asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXinXi%>"></asp:Label>:</span><asp:CheckBox ID="CB_SMS" runat="server"
