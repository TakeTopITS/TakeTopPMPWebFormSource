                                        ...
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" style="padding: 5px 5px 5px 5px;">
                                                <table cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="formItemBgStyleForAlignRight">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="formItemBgStyleForAlignLeft" colspan="3">
                                                            ...
                                                            &nbsp;&nbsp;<asp:Button ID="BT_DeleteChart" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeleteChart_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="formItemBgStyleForAlignLeft">
                                                            ...
                                                            <table width="98%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td valign="top" class="ItemAlignLeft" style="padding: 10px 1px 1px 1px; border: 0px solid rgba(193, 189, 189, 0.39)">
