...
<body><center>
    <form id="form1" runat="server">
		<table cellSpacing="0" cellPadding="0" width="75%" class="ItemAlignLeft" border="0">
			<TR>
			...
			<tr>
				...
				<TD class="ItemAlignLeft" bgColor="#ebebff">
						...
						<TR vAlign="top" height="*">
							<TD colSpan="2" height="148">
								<TABLE cellSpacing="0" cellPadding="4" width="100%" border="0">
									...
									<tr>
										<td vAlign="middle" class="ItemAlignLeft" height="80"><asp:button id="BackBtn" runat="server" Width="100" CssClass="ButtonCss" Text="<%$ Resources:lang,FanHui%>" OnClick="BackBtn_Click"></asp:button></td>
									</tr>
									<tr>
