                                ...
                                <tr>
                                    <td valign="top">
                                        <table cellpadding="0" cellspacing="0" width="98%">
                                            <tr>
                                                <td class="ItemAlignLeft" style="padding: 0px 5px 0px 5px; font-weight: bold; height: 24px; color: #394f66;">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <table style="width: 100%" cellpadding="4" cellspacing="0">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 25%;" class="tdLeft">
                                                                ...
                                                                <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td class="tdTopLine" class="ItemAlignLeft">&nbsp;<asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,HeTongZongE%>"></asp:Label>:
