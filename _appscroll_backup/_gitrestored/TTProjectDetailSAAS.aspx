                                                ...
                                                <table width="98%">
                                                    <tr>
                                                        <td style="height: 20px; text-align: left">&nbsp;
                                                           <table width="100%">
                                                               <tr>
                                                                   <td width="460px" class="ItemAlignLeft">
                                                                       <table>
                                                                           <tr>
                                                                               <td>
                                        ...
                                        <tr>
                                            <td style="text-align: left;">
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="padding-top: 5px" class="ItemAlignLeft">
                                                                    ...
                                                                    <td colspan="2" class="formItemBgStyleForAlignLeft">
                                                                        <table width="80%">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="ItemAlignLeft" style="padding-left: 2px;">
                            ...
                            <tr style="height: 15px">
                                <td style="text-align: left; height: 9px; padding-left: 15px;">
                                    <div id="DivProject1" runat="server">
                                        ...
                                        <asp:HyperLink ID="HL_RelatedConstract" runat="server" NavigateUrl="TTProjectRelatedConstract.aspx" Target="_blank" Text="<%$ Resources:lang,Contract%>"></asp:HyperLink>
