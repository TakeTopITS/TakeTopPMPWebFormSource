                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="240px" valign="top" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 240px; height: 13px;" class="ItemAlignLeft">
                                                        ...
                                                        <td>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="BT_DeleteDocType" runat="server" OnClick="BT_DeleteDocType_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                            ...
                                            <td valign="top" style="text-align: left; padding-left: 10px">
                                                <table style="width: 99%; height: 12px; margin-top: 5px">
                                                    <tr>
                                                        <td style="background: #F0F0F0; width: 100%;" class="ItemAlignLeft">
