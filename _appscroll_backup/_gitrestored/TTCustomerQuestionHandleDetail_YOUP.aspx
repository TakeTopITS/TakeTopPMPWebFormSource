                                                ...
                                                <table width="98%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align: left; font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                            ...
                                                            <asp:Button ID="BT_DeleteQuestion" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_DeleteQuestion_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"/>
