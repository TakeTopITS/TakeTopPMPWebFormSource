                                                ...
                                                <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="ItemAlignLeft">
                                                            <table width="380" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td width="29">
                                                            ...
                                                            <table style="width: 98%;">
                                                                <tr>
                                                                    <td colspan="2" style="text-align: left;">
                                                                        ...
                                                                        (<asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,GuanLianHuiYi%>"></asp:Label>:<asp:HyperLink ID="HL_RelatedMeetingID"
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td class="ItemAlignLeft" width="24%">
