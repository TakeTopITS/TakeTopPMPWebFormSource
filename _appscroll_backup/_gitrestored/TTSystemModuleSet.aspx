                                ...
                                <td height="31" class="page_topbj">
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" style="width: 80px; padding-top: 3px;">
                                            ...
                                            <td width="20px" class="ItemAlignLeft">&nbsp;</td>
                                                                        ...
                                                                        <table style="width: 100%; margin-top: 5px; padding: 3px 0px 3px 0px;" class="tableBorder"
                                                                                ...
                                                                                <td>
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="text-align: right; background-color: #f5f7fa" class="tdRight3">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="7">
                                                                                    ...
                                                                                    &nbsp;<asp:Button ID="BT_Delete" runat="server" Text="<%$ Resources:lang,ShanChu%>" Enabled="false" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" OnClick="BT_Delete_Click" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td width="5%" class="ItemAlignLeft" class="itemStyle">
                                                                                                <strong>
                                                                                                    <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,BianHao%>"></asp:Label></strong>
                                                                                            </td>
                                                                                            <td width="10%" class="ItemAlignLeft" class="itemStyle">
                                                                                                <strong>
                                                                                            ...
                                                                                            <td width="6%" class="ItemAlignLeft" class="itemStyle">
                                                                                                <strong>
                                                                                            ...
                                                                                            <td width="3%" class="ItemAlignLeft" class="itemStyle">
                                                                                                <strong>
                                                                                            ...
                                                                                            <td width="12%" class="ItemAlignLeft" class="itemStyle">
                                                                                                <strong>
                                                                        ...
                                                                        <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateColumn HeaderText="顺序">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="TB_SortNumber" runat="server" Width="25px" Text="0"
