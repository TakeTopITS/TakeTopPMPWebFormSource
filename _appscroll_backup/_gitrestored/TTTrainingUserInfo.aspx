                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <div>
                                                                                    ...
                                                                                    <asp:Label ID="Label35" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/EmployeeTrainingDataImportTemplate.xls"><asp:Label ID="Label34" runat="server" Text="<%$ Resources:lang,YGPXSJDRMB%>"></asp:Label></a>
                                                                                    <div id="ProgressBar">
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                                                            <ContentTemplate>
                                                                                <div>
                                                                                    ...
                                                                                    <asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/EmployeeTrainingRecordDataImportTemplate.xls"><asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,YGPXJLSJDRMB%>"></asp:Label></a>
                                                                                    <div id="Div5">
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                                                                        <ContentTemplate>
                                                                                            <div>
                                                                                                ...
                                                                                                <asp:Label ID="Label70" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/SpecialEquipmentDataImportTemplate.xls"><asp:Label ID="Label69" runat="server" Text="<%$ Resources:lang,TZSBSJDRMB%>"></asp:Label></a>
                                                                                                <div id="Div2">
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                                                                        <ContentTemplate>
                                                                                            <div>
                                                                                                ...
                                                                                                <asp:Label ID="Label90" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/WelderCertificationDataImportTemplate.xls"><asp:Label ID="Label89" runat="server" Text="<%$ Resources:lang,HGCZSJDRMB%>"></asp:Label></a>
                                                                                                <div id="Div3">
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                                                        <ContentTemplate>
                                                                                            <div>
                                                                                                ...
                                                                                                <asp:Label ID="Label107" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/PositionManagementDataImportTemplate.xls"><asp:Label ID="Label106" runat="server" Text="<%$ Resources:lang,GWGLSJDRMB%>"></asp:Label></a>
                                                                                                <div id="Div4">
