                                            ...
                                            <td class="ItemAlignLeft">
                                                <table width="145" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td background="ImagesSkin/main_top_bj.jpg" class="titlezi">价格调整列表
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td class="ItemAlignLeft">
                                                <table width="145" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td background="ImagesSkin/main_top_bj.jpg" class="titlezi">价格调整管理
                                                        </td>
                                                        <td width="5">
                                                            <%-- <img src="ImagesSkin/main_top_r.jpg" width="5" height="31" />--%>
                                                        </td>
                            ...
                            <tr>
                                <td class="ItemAlignLeft" style="padding: 5px 5px 5px 5px" valign="top">
                                    <table class="ItemAlignLeft" border="1" cellpadding="0" cellspacing="0" width="96%">
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                <table class="ItemAlignLeft" border="0" cellpadding="0" cellspacing="0" width="280">
                                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" colspan="2">
                                                <table class="ItemAlignLeft" border="0" cellpadding="0" cellspacing="0" width="600">
                                                    <tr>
                                                        <td align="right" width="120">备注:</td>
                                                        <td class="ItemAlignLeft" width="480">
                                            ...
                                            <td class="ItemAlignLeft">
                                                <table width="145" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td background="ImagesSkin/main_top_bj.jpg" class="titlezi">价格调整日志
                                                        </td>
                                                        <td width="5">
                                                            <%-- <img src="ImagesSkin/main_top_r.jpg" width="5" height="31" />--%>
                                                        </td>
