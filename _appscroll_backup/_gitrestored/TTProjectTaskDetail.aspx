                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td style="text-align: left;">
                                                                                                                        ...
                                                                                                                        <NickLee:NumberBox MaxAmount="1000000000000" MinAmount="-1000000000000" ID="NB_ManHour" runat="server" OnBlur="" OnFocus="" OnKeyPress=""
                                                                                                                            PositiveColor="" Width="50px">0.00</NickLee:NumberBox>
                                                                                                                        <asp:Label ID="Label4811" runat="server" Text="<%$ Resources:lang,Tian %>"></asp:Label>
                                                                                                                    ...
                                                                                                                    <td style="text-align: right;">
                                                                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,WeiHuanLiang %>" />:
                                                                                                                        <asp:Label ID="LB_RequireNumber" runat="server" />
                                                                                                                    </td>
                                                                                                                    <td style="text-align: right;">
