                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                            ...
                            <tr>
                                <td class="ItemAlignLeft" colspan="4" style="padding-left: 20px; font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                    <table width="100%">
                                        <tr>
                            ...
                            <tr>
                                <td class="ItemAlignLeft" width="100%">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="border-right: solid 1px #d0d0d0; padding: 5px 0px 0px 5px; overflow: auto;"
                                                                                            ...
                                                                                            <td>
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="85px" class="ItemAlignLeft">
                                                                                                            <strong>
                                                                                                        ...
                                                                                                        <td width="103px" class="ItemAlignLeft">
                                                                                                            <strong>
                                                                                                        ...
                                                                                                        <td class="ItemAlignLeft">
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,Plan%>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                        <td class="ItemAlignLeft">
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,PingHe%>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                            ...
                                            <%--  <td style="width: 230px; padding: 5px 0px 0px 5px; border-left: solid 1px #d0d0d0" valign="top" class="ItemAlignLeft">
