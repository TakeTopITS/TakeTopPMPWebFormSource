<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTSuperWorkPlanMain.aspx.cs" Inherits="TTSuperWorkPlanMain" %>
...
<frameset id="TakeTopMDI" rows="*,1" cols="*">
   <frameset id="bodyFrame" cols="50,*" frameborder="yes" border="1" framespacing="0" class="bian">
     <frame name="Left" src="TTSuperWorkPlan.aspx?ProjectID=<%=Request.QueryString["ProjectID"].ToString()%>">   
