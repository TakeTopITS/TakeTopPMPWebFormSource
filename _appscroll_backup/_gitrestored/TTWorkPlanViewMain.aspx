<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTWorkPlanViewMain.aspx.cs" Inherits="TTWorkPlanViewMain" %>
...
<frameset id="TakeTopMDI" rows="*,1" cols="*">
    <frameset id="bodyFrame" cols="50,*" frameborder="yes" border="1" framespacing="0" class="bian">
       ...
       <frame name="Left" src="TTWorkPlanView.aspx?ProjectID=<%=Request.QueryString["ProjectID"].ToString()%>">    
