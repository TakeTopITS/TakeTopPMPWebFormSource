                                        ...
                                        <ContentTemplate>
                                            ...
                                            <asp:Panel ID="Panel_RelatedBusiness" runat="server" Visible="false">
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <%--  <tr>
                                                        <td colspan="8" class="ItemAlignLeft" style="padding-right: 7%;">
                            ...
                            <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; text-align: left; padding: 0px 5px 0px 5px;">
                                ...
                                <table style="width: 100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="ItemAlignLeft" class="formItemBgStyleForAlignLeft">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left" colspan="2" class="formItemBgStyleForAlignLeft">
                                            ...
                                            <asp:Button ID="BT_DeleteAssign" runat="server" Enabled="False" OnClick="BT_DeleteAssign_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
