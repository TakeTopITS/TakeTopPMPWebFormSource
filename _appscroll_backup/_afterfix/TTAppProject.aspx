...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        /* 与主界面 TakeTopAPPMain #AboveDiv 相同的滚动容器方案：
           用明确的滚动 div 作为触摸滚动目标，避免依赖文档根元素（移动端触摸滚动不生效） */
        .app-scroll {
            height: 100vh;
            overflow-y: auto;
            overflow-x: hidden;
                                ...
                                <tr>
                                    <td class="ItemAlignLeft">
                                        <a id="aAPPBackPriorPage" href="TakeTopAPPMain.aspx" target="_top" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';">
                                            ...
                                            <img id="IMG_Waiting" src="Images/Processing.gif" alt="�����У����Ժ�..." style="display: none;" />
                                        </a>
                                    </td>
                                </tr>
                            </table>
