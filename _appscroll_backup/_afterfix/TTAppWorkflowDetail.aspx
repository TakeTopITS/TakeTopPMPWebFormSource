...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //同锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
    ...
    <script type="text/javascript" language="javascript">
        ...
        //锟斤拷示锟斤拷锟斤拷锟?        function setTBContendVisible() {
            ...
            if (this.document.getElementById("divContent").style.display === "none") {
                ...
                this.document.getElementById("divScale").innerHTML = "锟斤拷";
            }
            else {
                        ...
                        <tr>
                                ...
                                <a id="aAPPBackPriorPage" href="javascript:window.history.go(-1)" runat="server" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';" target="_top">
                                    <table width="150px" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="5">
                                                <img id="IMG_Waiting" src="Images/Processing.gif" alt="加载中，请稍后..." style="display: none;" />
                                            </td>
                                        </tr>
                                    </table>
                                </a>
                            ...
                            <td style="width: 30px; text-align: left; vertical-align: middle;">
                                <a href="javascript:ChangeMenu(0)" style="vertical-align: middle;">
                                    <asp:Image ID="IMG_LRArrow" ImageUrl="Images/UpDnArrow.png" Width="18px" Height="24px" border="0" alt="放大缩小" runat="server" ToolTip="流程图" Style="vertical-align: middle;" />
                                </a>
                            </td>
                            ...
                            <img src="ImagesSkin/ExpenseMgt.png" width="24" height="24" class="noBorder" style="vertical-align: middle;" />
                                        ...
                                        <td style="text-align: left; padding-left: 10px; color: #394f66; vertical-align: middle;">
                                            <asp:HyperLink ID="HL_ApproveRecord" runat="server" NavigateUrl="TTWorkflowApproveRecord.aspx" Target="_blank" ToolTip="流程图" Style="vertical-align: middle;">
                                                            ...
                                                            <td class="formItemBgStyleForAlignLeft" style="height: 1px;">
                                                                ...
                                                                <asp:DataGrid ID="DataGrid5" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCreated="DataGrid5_ItemCreated" OnItemCommand="DataGrid5_ItemCommand" ShowHeader="False" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:HyperLinkColumn DataNavigateUrlField="OperatorCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}" DataTextField="OperatorName" HeaderText="操作人" Target="_blank">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                        </asp:HyperLinkColumn>
                                                                        ...
                                                                        <asp:BoundColumn DataField="Operation" HeaderText="操作">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="6%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:BoundColumn DataField="CheckingTime" HeaderText="检查时间">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="16%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:TemplateColumn HeaderText="Status">
                                                                            <ItemTemplate>
                                    ...
                                    <tr>
                                        <td class="ItemAlignLeft">
                                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="我的工作流"">
                                                    <HeaderTemplate>
                                                ...
                                                <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="处理记录"">
                                                    <HeaderTemplate>
                                                ...
                                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="基本信息"">
                                                    <HeaderTemplate>
                                                        ...
                                                        <table style="width: 100%; text-align: left;">
                                                                ...
                                                                <td style="text-align: left; height: 1px;">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundColumn DataField="ActiveTime" HeaderText="提交时间">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="20%" />
                                                                            </asp:BoundColumn>
                                                                            <asp:TemplateColumn HeaderText="Status">
                                                                                <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                <td style="background-color: buttonface; text-align: left; height: 12px;"><strong>
                                                                    ...
                                                                    <asp:HyperLink ID="HL_StepApproveRecord" runat="server" Target="_blank">锟斤拷锟斤拷锟斤拷录</asp:HyperLink></td>
                                                            </tr>
                                                        </table>
                                                        <br />
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCommand="DataGrid1_ItemCommand" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="20" ShowHeader="False" Width="100%">
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:BoundColumn DataField="DepartRelated" HeaderText="相关部门"
                                                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                                                    </asp:BoundColumn>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center;">
                                    ...
                                    <asp:DataGrid ID="DataGrid3" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" ShowHeader="False" Width="100%">
                                        <Columns>
                                            <asp:HyperLinkColumn DataNavigateUrlField="IdentifyString" DataNavigateUrlFormatString="TTActorGroupMemberView.aspx?IdentifyString={0}" DataTextField="ActorGroup" HeaderText="成员角色" Target="_blank">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="25%" />
                                            </asp:HyperLinkColumn>
                                            <asp:BoundColumn DataField="WorkDetail" HeaderText="要说明的工作量">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="25%" />
