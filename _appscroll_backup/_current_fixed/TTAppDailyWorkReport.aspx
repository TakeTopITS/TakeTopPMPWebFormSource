...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () { initSwipeBack();// 锟斤拷始锟斤拷锟斤拷锟斤拷锟斤拷锟截癸拷锟斤�? initSwipeBack();// 锟斤拷始锟斤拷锟斤拷锟斤拷锟斤拷锟截癸拷锟斤�?
                                                                                ...
                                                                                <div class="npbx">
                                                                                    ...
                                                                                    <table cellpadding="4" cellspacing="0" width="100%">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan ="2" class="ItemAlignLeft" valign="top" style="width: 8%; padding-left: 5px" class="tdLeft">
                                                                                                <span style="font-size: 10pt">
                                                                                                   <b> <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,MeiRiZongJie%>"></asp:Label> </b></span>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan ="2" class="ItemAlignLeft" valign="top" style="width: 8%; padding-left: 5px" class="tdLeft">
                                                                                                <span style="font-size: 10pt">
                                                                                                   <b> <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ChengGuo%>"></asp:Label> </b></span>
                                                                                       <br />
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan ="2" class="ItemAlignLeft" valign="top" style="width: 8%; padding-left: 5px" class="tdLeft">
                                                                                                <span style="font-size: 10pt;">
                                                                                                   <b> <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,DiZhi%>"></asp:Label></b></span>
