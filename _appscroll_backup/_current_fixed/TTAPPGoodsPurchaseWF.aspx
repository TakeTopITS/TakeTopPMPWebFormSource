...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () { initSwipeBack();// 初始化滑动返回功�? initSwipeBack();// 初始化滑动返回功�?             /*  if (top.location != self.location) { } else { CloseWebPage(); }*/

        });
    </script>
</head>
<body><div id="swipeFeedback" class="swipe-feedback"><asp:Label ID="Label634424" runat="server" Text="<%$ Resources:lang,XYHDKHHSYYXXHDKSXBYM%>" /></div> <!-- 滑动反馈�?-->
    <center>
                                    ...
                                    <tr>
                                        <td class="ItemAlignLeft">
                                            ...
                                            <a id="aAPPBackPriorPage" href="javascript:window.history.go(-1)" target="_top" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';">
                                                ...
                                                <img id="IMG_Waiting" src="Images/Processing.gif" alt="请稍候，处理�?.." style="display: none;" />
                                            </a>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <asp:DataGrid ID="DataGrid5" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCommand="DataGrid5_ItemCommand" OnPageIndexChanged="DataGrid5_PageIndexChanged" PageSize="25" ShowHeader="false" Width="100%">
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LBT_Delete" runat="server" CommandName="Delete" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="&lt;div&gt;&lt;img src=ImagesSkin/Delete.png border=0 alt='Deleted' /&gt;&lt;/div&gt;"></asp:LinkButton>
                                            </ItemTemplate>
                                ...
                                <tr>
                                    <td colspan="2" style="padding: 5px 5px 5px 5px;">
                                        ...
                                        <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                            <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="采购单明�?>
                                                <HeaderTemplate>
                                                ...
                                                <ContentTemplate>
                                                    <table class="ItemAlignLeft" cellpadding="0" cellspacing="0" width="99%">
                                                        <tr>
                                                            <td class="ItemAlignLeft" style="padding-bottom: 5px;">
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="SupplyNumber" HeaderText="已供�?>
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0"
                                            ...
                                            <cc1:TabPanel ID="TabPanel7" runat="server" HeaderText="采购需求计�? TabIndex="3">
                                                <HeaderTemplate>
                                                    ...
                                                    <div id="DivID2" style="width: 100%; height: 428px; overflow: auto; text-align: left;">
                                                        ...
                                                        <asp:DataGrid ID="DataGrid8" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="RequireNumber" HeaderText="需求数�?>
                                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="6%" />
                                                                </asp:BoundColumn>
                                                                ...
                                                                <asp:BoundColumn DataField="RequireTime" DataFormatString="{0:yyyy/MM/dd}" HeaderText="需求时�?>
                                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="6%" />
                                                                </asp:BoundColumn>
                                                                <asp:BoundColumn DataField="Unit" HeaderText="Unit">
                                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="5%" />
                                                                ...
                                                                <asp:TemplateColumn HeaderText="源类�?>
                                                                    <ItemTemplate>
                                                    ...
                                                    <div id="Div1" style="width: 100%; height: 300px; overflow: auto;">
                                                        ...
                                                        <asp:DataGrid ID="DataGrid24" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="SaleOrderNumber" HeaderText="在单�?销售单)">
                                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="7%" />
                                                                </asp:BoundColumn>
                                                                <asp:BoundColumn DataField="PurchaseOrderNumber" HeaderText="在订�?">
                                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" />
                                                                </asp:BoundColumn>
                                                            </Columns>
                                                            <EditItemStyle BackColor="#2461BF" />
                                            ...
                                            <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="关联合同">
                                                ...
                                                <ContentTemplate>
                                                    <br />
                                                    <div id="Div1" style="width: 100%; height: 300px; overflow: auto;">
                                                        <table class="ItemAlignLeft" cellpadding="0" cellspacing="0" width="200%">
                                            ...
                                            <cc1:TabPanel ID="TabPanel8" runat="server" HeaderText="供应商物�?>
                                                <HeaderTemplate>
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <div id="Div11" style="width: 100%; height: 428px; overflow: auto;">
                                                        <table class="ItemAlignLeft" width="200%">
                                                            <tr>
                                                                <td>
                                                                    <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0"
                                                                        width="100%">
                                    ...
                                    <td>
                                        ...
                                        <asp:DataGrid ID="DataGrid12" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="OpenDate" DataFormatString="{0:yyyy/MM/dd}" HeaderText="开票日�?>
                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="6%" />
                                                </asp:BoundColumn>
                                            </Columns>
                                            <EditItemStyle BackColor="#2461BF" />
                                    ...
                                    <td>
                                        ...
                                        <asp:DataGrid ID="DataGrid9" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="SaleTime" DataFormatString="{0:yyyy/MM/dd}" HeaderText="销售时�?>
                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="20%" />
                                                </asp:BoundColumn>
