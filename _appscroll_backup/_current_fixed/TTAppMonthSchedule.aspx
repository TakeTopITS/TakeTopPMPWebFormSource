...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () { initSwipeBack();// 锟斤拷始锟斤拷锟斤拷锟斤拷锟斤拷锟截癸拷锟斤�? initSwipeBack();// 锟斤拷始锟斤拷锟斤拷锟斤拷锟斤拷锟截癸拷锟斤�?             /*  if (top.location != self.location) { } else { CloseWebPage(); }*/
        });
...
<body><div id="swipeFeedback" class="swipe-feedback"><asp:Label ID="Label634424" runat="server" Text="<%$ Resources:lang,XYHDKHHSYYXXHDKSXBYM%>" /></div> <!-- 锟斤拷锟斤拷锟斤拷锟斤拷锟斤�?-->
                            ...
                            <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="ItemAlignLeft">
                                        ...
                                        <a id="aAPPBackPriorPage" href="TakeTopAPPMain.html" target="_top" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';">
                    ...
                    <tr>
                        <td class="ItemAlignLeft" style="padding: 2px 2px 2px 2px;">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td class="ItemAlignLeft" style="background-color:ButtonFace;">
                                ...
                                <tr>
                                   <td valign="top" class="ItemAlignLeft" style="padding-top:10px;">
                            ...
                            <DayPilot:DayPilotMenu ID="DayPilotMenu1" runat="server">
                                ...
                                <%--    <DayPilot:MenuItem Text="Send" Action="JavaScript" JavaScript="showAlertAtMouse('Sending event (id ' + e.value() + ')');">
                                    </DayPilot:MenuItem>
                                ...
                                <%--  <DayPilot:MenuItem Action="PostBack" Command="Delete" Text="Delete (PostBack)" />
                                    <DayPilot:MenuItem Action="NavigateUrl" NavigateUrl="javascript:showAlertAtMouse('Going somewhere else (id {0})');"
                                        Text="NavigateUrl test" />--%>
                            </DayPilot:DayPilotMenu>

                            <DayPilot:DayPilotMenu ID="DayPilotMenu2" runat="server" ClientObjectName="menu2">
                                <DayPilot:MenuItem Text="Open" Action="JavaScript" JavaScript="showAlertAtMouse('Opening event (id ' + e.value() + ')');">
                                </DayPilot:MenuItem>
                                <DayPilot:MenuItem Text="Send" Action="JavaScript" JavaScript="showAlertAtMouse('Sending event (id ' + e.value() + ')');">
                                </DayPilot:MenuItem>
                                <DayPilot:MenuItem Text="-" Action="NavigateUrl"></DayPilot:MenuItem>
                            ...
                            <DayPilot:DayPilotMenu ID="DayPilotMenuSelection" runat="server" ClientObjectName="dpms">
                                ...
                                <%--    <DayPilot:MenuItem Action="PostBack" Command="Insert" Text="Create new event (PostBack)" />
                                    ...
                                    <DayPilot:MenuItem Action="JavaScript" JavaScript="showAlertAtMouse('Start: ' + e.start.toString() + '\nEnd: ' + e.end.toString())"
