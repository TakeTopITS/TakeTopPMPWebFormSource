...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            initSwipeBack();// 初始化滑动返回功�? initSwipeBack();// 初始化滑动返回功�?
                                ...
                                <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="ItemAlignLeft">
                                            <a id="aAPPBackPriorPage" href="TTAPPRegularWLMain.aspx" target="_top" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';">
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ItemAlignLeft" class="auto-style1" width="40%"><strong>
                                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,MingCheng %>"></asp:Label>
                                                                </strong>&nbsp; </td>

                                                                <td class="ItemAlignLeft" class="auto-style1"><strong>
                                    ...
                                    <td valign="top" style="padding: 10px 5px 5px 5px;">
                                        <table class="formBgStyle" style="width: 100%;" cellpadding="3" cellspacing="0">
                                            <tr style="display: none;">
                                                ...
                                                <td class="ItemAlignLeft" style="width: 85%" class="formItemBgStyleForAlignLeft">
