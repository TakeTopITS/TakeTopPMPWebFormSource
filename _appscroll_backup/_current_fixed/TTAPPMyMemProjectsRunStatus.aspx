...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function popShowByURL(url, title, width, height, parentWindow) {
            ...
            // 使用全屏弹窗，顶部和底部都对�?            layer.open({
                ...
                success: function (layero, index) {
                    // 添加全屏样式�?                    layero.addClass('fullscreen-popup');
                    ...
                    // 设置标题�?                    var titleBar = layero.find('.layui-layer-title');
                    titleBar.css({
                        'height': '45px',
                        'line-height': '45px',
                        'background': '#e7e7e8',
        ...
        // 自定义全屏弹窗函�?        function showFullScreenPopup(url, title) {
            // 创建遮罩�?            var overlay = document.createElement('div');
            ...
            // 创建标题�?            var header = document.createElement('div');
            ...
            // 添加到页�?            document.body.appendChild(overlay);
        ...
        // 增强的弹窗函�?- 主要使用自定义全屏弹�?        function showGanttPopup(projectId, projectName) {
            ...
            // 优先使用自定义全屏弹�?            return showFullScreenPopup(url, title);
        }
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%; height: 12px; text-align: left;" valign="top">
                                                            <cc2:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" Width="100%" runat="server" ActiveTabIndex="0">
                                                                <cc2:TabPanel ID="TabPanel3" runat="server" HeaderText="项目状�?>
                                                                    <HeaderTemplate>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td>
                                                                                                                        ...
                                                                                                                        <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                                                                                            ...
                                                                                                                            <Columns>
                                                                                                                                <asp:TemplateColumn HeaderText="项目状�?">
                                                                                                                                    <ItemTemplate>
