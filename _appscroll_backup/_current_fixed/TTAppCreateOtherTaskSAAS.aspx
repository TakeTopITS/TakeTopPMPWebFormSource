                                                    ...
                                                    <td align="right" style="padding: 5px 5px 0px 5px;">
                                                        ...
                                                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="20"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <%--  <asp:BoundColumn DataField="Priority" HeaderText="锟斤拷锟饺硷�?>
                            ...
                            <table cellpadding="3" cellspacing="0" style="width: 100%" class="formBgStyle">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <CKEditor:CKEditorControl runat="server" ID="HE_Operation" Toolbar="" Width="99%" Height="150px" Visible="False" />
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        &nbsp;<asp:Button ID="BT_DeleteAssign" runat="server" CssClass="inpu" Enabled="False"
                                            OnClick="BT_DeleteAssign_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
                                    </td>
                                </tr>
                                <tr>
