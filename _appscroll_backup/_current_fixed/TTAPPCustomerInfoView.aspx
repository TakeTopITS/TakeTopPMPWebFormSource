...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            // 手风琴功�?            $('.accordion-header').click(function () {
                var $content = $(this).next('.accordion-content');
                var $icon = $(this).find('.accordion-icon');

                // 关闭其他打开的部�?                $('.accordion-content').not($content).removeClass('active').slideUp(300);
            ...
            // 默认打开第一个部�?            $('.accordion-header').first().click();

            // 电话号码长按时提�?            $('.phone-link').on('contextmenu', function (e) {
                e.preventDefault();
