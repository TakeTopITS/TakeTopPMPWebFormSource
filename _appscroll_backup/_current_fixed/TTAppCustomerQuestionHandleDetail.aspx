...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //页锟斤拷锟斤拷锟斤拷锟斤�?ajax锟截凤拷锟斤拷锟斤拷锟斤拷珊锟街达拷械牟锟斤拷锟斤拷锟斤拷锟斤拷锟揭伙拷锟絝untion
        //$load锟斤拷锟斤拷示锟斤拷
        //$load(function () {
        ...
        var $load = function (loadFunc) {
            $(function () {
                initSwipeBack();// 锟斤拷始锟斤拷锟斤拷锟斤拷锟斤拷锟截癸拷锟斤�? initSwipeBack();// 锟斤拷始锟斤拷锟斤拷锟斤拷锟斤拷锟截癸拷锟斤�?                if (typeof (Sys) != 'undefined') {
        ...
        $load(function () {
            ...
            // 锟睫革拷锟斤拷锟斤拷锟截硷拷锟斤拷锟斤拷�?            fixCalendarPosition();
        ...
        // 锟斤拷锟斤拷页锟斤拷锟斤拷锟铰硷拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷獠匡拷乇�?
        ...
        // 锟斤拷锟接硷拷锟斤拷锟铰硷拷锟斤拷锟斤拷ESC锟斤拷锟截闭碉拷锟斤�?        document.addEventListener('keydown', function (e) {
            if (e.keyCode === 27) { // ESC锟斤�?                popClose();
            }
        });
    </script>
</head>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div id="appScroll" class="app-scroll">
                    ...
                    <div class="napbac">
                        ...
                        <div class="napbox">
                            ...
                            <div class="npbxs">
                                <div class="mline">
                                    <div style="display: flex; margin-bottom: 5px;">
                                        <div style="width: 120px;">
                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,XuQiuMingCheng%>"></asp:Label>:
                                        </div>
                                        <div>
                                ...
                                <div class="mline">
                                    <div style="display: flex; margin-bottom: 5px;">
                                        <div style="width: 120px;">
                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,KeHuMingCheng%>"></asp:Label>:
                                        </div>
                                        <div>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td style="vertical-align: middle;">
                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ZhiJieChengYuan%>"></asp:Label>:
                                                    </td>
                                                    <td>
                        ...
                        <!-- 锟斤拷锟斤拷锟斤拷锟斤拷 - 锟斤拷锟斤拷锟斤拷form锟节碉拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤�?-->
                        ...
                        <div class="layui-layer layui-layer-iframe" id="popDetailWindow" name="fixedDiv"
                            ...
                            <div class="layui-layer-title" style="background: #e7e7e8; padding: 10px 15px; border-bottom: 1px solid #ddd;" id="popwindow_title">
                                ...
                                <span class="layui-layer-setwin" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%);">
                                    <a onclick="return popClose();" class="layui-layer-ico layui-layer-close layui-layer-close1 notTab" href="javascript:;" style="display: block; width: 30px; height: 30px; line-height: 30px; text-align: center;">锟斤�?/a>
                                </span>
                            </div>
                                    ...
                                    <div>
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,KeHuYiJian%>"></asp:Label>
                                            </div>
                                            <div>
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,ChuLiFangShi%>"></asp:Label>
                                            </div>
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,YongShi%>"></asp:Label>
                                            </div>
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:lang,LianLuoRen%>"></asp:Label>
                                            </div>
                                            <div style="display: flex; gap: 10px; align-items: center;">
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,LianXiFangFa%>"></asp:Label>
                                            </div>
                                            <div>
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,ChuLi%>"></asp:Label>
                                            </div>
                                            <div>
                                                <CKEditor:CKEditorControl ID="HT_HandleDetail" Toolbar="" runat="server" Width="100%" Height="100px" Visible="False" />
                                            </div>
                                        </div>
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,XiaCi%>"></asp:Label>
                                            </div>
                                            <!-- 锟睫革拷锟斤拷锟斤拷选锟斤拷锟斤拷位锟斤�?-->
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            <div style="font-weight: bold; margin-bottom: 5px;">
                                                <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,TiQian%>"></asp:Label>
                                            </div>
                                            <div style="display: flex; gap: 10px; align-items: center;">
                                                ...
                                                <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,Tian%>"></asp:Label>
                                            </div>
                                        </div>
