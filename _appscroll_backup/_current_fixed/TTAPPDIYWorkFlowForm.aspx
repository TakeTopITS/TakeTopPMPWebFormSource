...
<head>
    ...
    <script type="text/javascript">
        ...
        SimpleDrag.prototype = {
            //鎷栨斁瀵硅�?瑙﹀彂瀵硅�?            initialize: function (drag) {
                this.Drag = $(drag);
                this._x = this._y = 0;
        ...
        //浜х敓XML锛岄檮鍔犲埌琛ㄥ�?        function ClickCreateXMLToForm(objID) {
        ...
        //閫愭鏀惧ぇ鍏冪礌澶у�?        function toIncreaseSize(objID, largestSize) {
    ...
    <script type="text/javascript">
        function autoClickActiveButton() {
            ...
            if (aHref == "") {
                ...
                alert("Please select workflow template or workflow!")
                return;
            }
    ...
    <center>
        ...
        <form id="form1" runat="server">
            ...
            <div style="z-index: -2;">
                    ...
                    <tr>
                        <td valign="top">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top" style="padding: 0px 5px 30px 5px;" onmouseover="hideWFMain()">
                ...
                <div id="divToolBar" name="divTooBar" class="ToolBar" style="width: 100%; text-align: left; padding-top: 0px; padding-bottom: 40px; background-color: aliceblue;">

                    <table width="100%">
                        <tr>
                            <td class="ItemAlignLeft" width="50px">
                        ...
                        <tr>
                            <td class="ItemAlignLeft" style="padding-top: 4px; padding-bottom: 4px;">
                ...
                <tr>
                    <td id="td_WFMain" style="padding: 5px 5px 5px 5px; width: 370px; vertical-align: top;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="40%" class="ItemAlignLeft" style="font-size: smaller;">
                                                        ...
                                                        <td class="ItemAlignLeft" style="font-size: smaller;">
                            ...
                            <tr>
                                <td class="ItemAlignLeft" width="40%" style="padding: 1px 1px 1px 1px;">&nbsp;</td>
                                <td class="ItemAlignLeft" width="60%" style="padding: 1px 1px 1px 1px;">&nbsp;</td>
                            </tr>
                            <tr>
                                        ...
                                        <tr style="display: none;">
                                            <td colspan="3" class="tdRight" style="text-align: center; padding: 2px 0px 2px 5px; border-bottom: solid 1px  #d0d0d0; width: 370px;">
                                                <asp:HyperLink ID="HL_WFXSNFile" runat="server"
                                                    Target="_blank" Font-Names="瀹嬩�? Font-Size="10pt">
                                                ...
                                                <asp:HyperLink ID="HL_OldWFXMLFile" runat="server"
                                                    Target="_blank" Font-Names="瀹嬩�? Font-Size="10pt" Text="<%$ Resources:lang,ShuJuWenJian%>"></asp:HyperLink>
