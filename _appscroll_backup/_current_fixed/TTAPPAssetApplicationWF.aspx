                ...
                <div id="appScroll" class="app-scroll">
                                                            ...
                                                            <td class="ItemAlignLeft">
                                                                ...
                                                                <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="30px"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="AssetName" HeaderText="资产�?>
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="15%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:BoundColumn DataField="ModelNumber" HeaderText="资产�?>
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="15%" />
                                                                        </asp:BoundColumn>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popAssignWindow" name="fixedDivNoConfirm"
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%">
                                <tr>
                                    <td class="ItemAlignLeft" style="width: 100px; height: 6px;">
