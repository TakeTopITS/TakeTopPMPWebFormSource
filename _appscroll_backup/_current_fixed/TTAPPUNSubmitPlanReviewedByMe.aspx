                                                ...
                                                <a id="aAPPBackPriorPage" href="javascript:window.history.go(-1)" target ="_top" onclick="javascript:document.getElementById('IMG_Waiting').style.display = 'block';">
                                                    ...
                                                    <table width="245" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td background="ImagesSkin/main_top_bj.jpg" class="titleziAPP"><asp:Label ID="Label1" runat ="server" Text="<%$ Resources:lang,Back%>" />
                                                            </td>
                                                            <td width="5">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundColumn DataField="PlanName" HeaderText="PlanName">
                                                                     ...
                                                                     <asp:HyperLinkColumn DataNavigateUrlField="CreatorCode" DataNavigateUrlFormatString="TTAPPUserInforSimple.aspx?UserCode={0}"
                                                                        DataTextField="CreatorName" HeaderText="制定�? >
