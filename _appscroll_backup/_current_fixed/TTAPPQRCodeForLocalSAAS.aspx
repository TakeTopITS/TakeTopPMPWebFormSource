            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr id="TD_SAAS" runat="server">
                    <td align="center" style="padding-top: 10px;">
                        ...
                        <br />
                        1�?如果你是在泰顶拓鼎网站上租用的泰顶拓鼎软件，那么可以用你的微信扫描下面的二维码关�?泰顶拓鼎  微信公众�?                         <br />
                        <br />
                        <img src="ImagesSkin/TakeTopWXGZHQRCode.png" style="width: 150px; height: 150px;" />
                        <br />
                        <br />
                        2�?点击公众号上�?管理平台，打开你的APP登录界面
                        <br />
                        <br />

                        3�?在登录界面第一行输入你的公司简�?问系统管理员)，第二行输入你的登录帐号，第三行输入密码，如下图:
                        <br />
                        ...
                        �?上面信息会保存在缓存里，第二次登录时会自动填充，不用重复输入�?                        <br />
                        <br />
