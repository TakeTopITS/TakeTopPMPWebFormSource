...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () { initSwipeBack();// 初始化滑动返回功�? initSwipeBack();// 初始化滑动返回功�?
            //
        ...
        //点击DATAGRID行内任何一点，都能触发行内的链�?        function SetDataGridTrClickLink() {
...
<body><div id="swipeFeedback" class="swipe-feedback"><asp:Label ID="Label634424" runat="server" Text="<%$ Resources:lang,XYHDKHHSYYXXHDKSXBYM%>" /></div> <!-- 滑动反馈�?-->
                            ...
                            <td>
                                ...
                                <asp:DataGrid ID="DataGrid2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <%--  <asp:BoundColumn DataField="ContactName" HeaderText="联系�?>
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                            </asp:BoundColumn>
                                        ...
                                        <%-- <asp:BoundColumn DataField="AreaAddress" HeaderText="区域">
                                            ...
                                            <asp:HyperLinkColumn DataNavigateUrlField="CustomerCode" DataNavigateUrlFormatString="TTContactList.aspx?RelatedType=Customer&RelatedID={0}"
                                                HeaderText="相关联系�? Target="_blank" Text="<%$ Resources:lang,XiangGuanLianXiRen %>">
                                            ...
                                            <asp:HyperLinkColumn DataNavigateUrlField="CustomerCode" DataNavigateUrlFormatString="TTMakeProjectFromOther.aspx?RelatedType=Customer&RelatedID={0}"
                                                HeaderText="转项�? Target="_blank" Text="<%$ Resources:lang,ZhuanChengXiangMu %>">
                                                <ItemStyle CssClass="itemBorder" Horizontalalign="left" />
                                            </asp:HyperLinkColumn>--%>
                                    </Columns>
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="BeginDate" DataFormatString="{0:yyyy/MM/dd}" HeaderText="开始日�?>
                                                    ...
                                                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:HyperLinkColumn DataNavigateUrlField="OperatorCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}"
                                                                DataTextField="OperatorName" HeaderText="受理�? Target="_blank">
    ...
    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="10%" />
                                                            ...
                                                            <asp:HyperLinkColumn DataNavigateUrlField="RecorderCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}"
                                                                DataTextField="RecorderCode" HeaderText="记录�? Target="_blank">
                                            ...
                                            <cc1:TabPanel ID="TabPanel5" runat="server" HeaderText="物料销售订单记�? TabIndex="0">
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <asp:DataGrid ID="DataGrid6" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="Amount" HeaderText="总金�?>
                                            ...
                                            <cc1:TabPanel ID="TabPanel6" runat="server" HeaderText="报价�?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:DataGrid ID="DataGrid9" runat="server" AutoGenerateColumns="False" OnItemCommand="DataGrid9_ItemCommand"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn HeaderText="系列�?>
                                                                        ...
                                                                        <asp:BoundColumn DataField="WarrantyPeriod" HeaderText="保修�?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:DataGrid runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="GoodsName" HeaderText="物料�?>
                                                                        ...
                                                                        <asp:BoundColumn DataField="CheckOutNumber" HeaderText="已出�?>
                                        ...
                                        <asp:DataGrid ID="DataGrid15" runat="server" AutoGenerateColumns="False" Height="1px" AllowPaging="True" PageSize="30" OnItemCommand="DataGrid15_ItemCommand" OnPageIndexChanged="DataGrid15_PageIndexChanged"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkColumn DataNavigateUrlField="CreatorCode" DataNavigateUrlFormatString="TTUserInforView.aspx?UserCode={0}"
                                                    DataTextField="CreatorName" HeaderText="创建�? Target="_blank">
                                                    <ItemStyle CssClass="itemBorder" Horizontalalign="left" Width="6%" />
                                                </asp:HyperLinkColumn>
                                                <asp:BoundColumn DataField="ContactName" HeaderText="联系�?>
                                                    <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="8%" />
