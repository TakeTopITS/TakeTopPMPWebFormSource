...
<head>
    ...
    <script type="text/javascript">
        ...
        //隐藏或显示工作流标题�?        function hideOrDisplayWFMain() {
                                ...
                                <tr>
                                    <td width="20px" style="padding-left: 15px; padding-top: 5px; vertical-align: middle;">
                                        ...
                                        <%--   <a href="javascript:ChangeMenu(0)">
                                            <img src="Images/LeftRightArrow.png" width="18" height="24" border="0" alt="隐藏右边�?>
                                        </a>--%>
                    ...
                    <td>
                        ...
                        <td id="td_WFMain" width="300" style="padding: 5px 5px 5px 5px; vertical-align: top;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="ItemAlignLeft" width="100%" style="padding: 20px 1px 1px 1px;">
