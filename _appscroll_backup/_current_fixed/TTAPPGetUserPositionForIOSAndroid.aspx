...
<script type="text/javascript">
    ...
    var isWxConfigReady = false; //config鏄惁楠岃瘉閫氳�?    var loadingIndex;
    var mk, map;
    function wxApi() {
        ...
        wx.ready(function () {
            ...
            wx.getLocation({
                type: 'wgs84', // 榛樿涓簑gs84鐨刧ps鍧愭爣锛屽鏋滆杩斿洖鐩存帴缁檕penLocation鐢ㄧ殑鐏槦鍧愭爣锛屽彲浼犲�?gcj02'
                success: function (res) {
                    var latitude = res.latitude; // 绾害锛屾诞鐐规暟锛岃寖鍥翠�?0 ~ -90
                    var longitude = res.longitude; // 缁忓害锛屾诞鐐规暟锛岃寖鍥翠�?80 ~ -180�?

                    var lng = '';	//鐧惧害缁忓害
                    var lat = '';	//鐧惧害绾�?                    var convertor = new BMap.Convertor();
                    ...
                    //wx.openLocation({
                    //latitude: latitude, // 绾害锛屾诞鐐规暟锛岃寖鍥翠�?0 ~ -90
                    //longitude: longitude, // 缁忓害锛屾诞鐐规暟锛岃寖鍥翠�?80 ~ -180�?
                    //name: '鎴戠殑浣嶇疆', // 浣嶇疆鍚?
                    //address: '', // 鍦板潃璇︽儏璇存�?                    //scale: 10, // 鍦板浘缂╂斁绾у埆,鏁村舰鍊?鑼冨洿浠?~28銆傞粯璁や负鏈€�?
                    //infoUrl: '' // 鍦ㄦ煡鐪嬩綅缃晫闈㈠簳閮ㄦ樉绀虹殑瓒呴摼鎺?鍙偣鍑昏烦�?
                    //});
                }
            });
        });
