...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //点击DATAGRID行内任何一点，都能触发行内的链�?        function setTrClickLink(gridId) {
            //阻止事件冒泡
                        ...
                        <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width: 30%; text-align: left; padding-top: 5px;" onclick="javascript:ChangeMenu(0);">
                                    <asp:Image ID="IMG_LRArrow" ImageUrl="Images/UpDnArrow.png" Width="18px" Height="24px" border="0" alt="隐藏右边�? runat="server" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
