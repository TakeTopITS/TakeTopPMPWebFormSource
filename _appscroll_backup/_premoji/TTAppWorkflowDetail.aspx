...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //��ʾ�����?        function setTBContendVisible() {
                        ...
                        <tr>
                            ...
                            <td style="width: 30px; text-align: left; vertical-align: middle;">
                                <a href="javascript:ChangeMenu(0)" style="vertical-align: middle;">
                                    <asp:Image ID="IMG_LRArrow" ImageUrl="Images/UpDnArrow.png" Width="18px" Height="24px" border="0" alt="�Ŵ���С" runat="server" ToolTip="�Ŵ���С" Style="vertical-align: middle;" />
                                </a>
                            </td>
                            ...
                            0.00</NickLee:NumberBox><asp:Label ID="Label4811" runat="server" Text="<%$ Resources:lang,Tian %>" Visible="false" Style="vertical-align: middle;"></asp:Label>
                                        ...
                                        <td style="width: 60px; text-align: center; color: #394f66; vertical-align: middle;">
                                            <asp:HyperLink ID="HL_WFChartView" runat="server" Target="_blank" ToolTip="����ͼ" Style="vertical-align: middle;">
                            ...
                            <img src="ImagesSkin/ExpenseMgt.png" width="24" height="24" class="noBorder" style="vertical-align: middle;" />
                                        ...
                                        <td style="text-align: left; padding-left: 10px; color: #394f66; vertical-align: middle;">
                                            <asp:HyperLink ID="HL_ApproveRecord" runat="server" NavigateUrl="TTWorkflowApproveRecord.aspx" Target="_blank" ToolTip="������¼" Style="vertical-align: middle;">
                                                            ...
                                                            <td class="formItemBgStyleForAlignLeft" style="height: 1px;">
                                                                ...
                                                                <asp:DataGrid ID="DataGrid5" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCreated="DataGrid5_ItemCreated" OnItemCommand="DataGrid5_ItemCommand" ShowHeader="False" Width="100%">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:HyperLinkColumn DataNavigateUrlField="OperatorCode" DataNavigateUrlFormatString="TTUserInforSimple.aspx?UserCode={0}" DataTextField="OperatorName" HeaderText="������" Target="_blank">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                        </asp:HyperLinkColumn>
                                                                        <asp:BoundColumn DataField="WorkDetail" HeaderText="Ҫ��˵Ĺ���?>
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="20%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:BoundColumn DataField="FinishedTime" HeaderText="ʱ��(����)">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="8%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:BoundColumn DataField="Operation" HeaderText="����">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="6%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:BoundColumn DataField="CheckingTime" HeaderText="������ʱ��">
                                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="16%" />
                                                                        </asp:BoundColumn>
                                                                        <asp:TemplateColumn HeaderText="Status">
                                                                            <ItemTemplate>
                                    ...
                                    <tr>
                                        <td class="ItemAlignLeft">
                                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="�ҵĹ�������">
                                                    <HeaderTemplate>
                                                                ...
                                                                <td style="text-align: left; height: 1px;">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" Height="1px"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundColumn DataField="Actor" HeaderText="�е���ɫ">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="FinishedTime" HeaderText="ʱ��(Сʱ)">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="12%" />
                                                                            </asp:BoundColumn>
                                                                            ...
                                                                            <asp:BoundColumn DataField="StepId" HeaderText="����ID">
                                                ...
                                                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="��������">
                                                    <HeaderTemplate>
                                                        ...
                                                        <table style="width: 100%; text-align: left;">
                                                                ...
                                                                <td style="text-align: left; height: 1px;">
                                                                    ...
                                                                    <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundColumn DataField="LimitedTime" HeaderText="ʱ��(Сʱ)">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="15%" />
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="LimitedOperator" HeaderText="�ر�����">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="ActiveTime" HeaderText="����ʱ��">
                                                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="20%" />
                                                                            </asp:BoundColumn>
                                                                            <asp:TemplateColumn HeaderText="Status">
                                                                                <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                <td style="background-color: buttonface; text-align: left; height: 12px;"><strong>
                                                                    ...
                                                                    <asp:HyperLink ID="HL_StepApproveRecord" runat="server" Target="_blank">������¼</asp:HyperLink></td>
                                                            </tr>
                                                        </table>
                                                        <br />
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" OnItemCommand="DataGrid1_ItemCommand" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="20" ShowHeader="False" Width="100%">
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:BoundColumn DataField="limitedOperator" HeaderText="��������">
                                                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                                                    </asp:BoundColumn>
                                                                                                    <asp:BoundColumn DataField="LimitedTime" HeaderText="ʱ��(Сʱ)">
                                                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="12%" />
                                                                                                    ...
                                                                                                    <asp:BoundColumn DataField="DepartRelated" HeaderText="�������?>
                                                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                                                    </asp:BoundColumn>
                                                                                                    <asp:BoundColumn DataField="NextSortNumber" HeaderText="��һ��">
                                                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="10%" />
                                                                                                    </asp:BoundColumn>
                                                                                                    <asp:TemplateColumn>
                                                                                                        <ItemTemplate>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center;">
                                    ...
                                    <asp:DataGrid ID="DataGrid3" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="1px" ShowHeader="False" Width="100%">
                                        <Columns>
                                            <asp:HyperLinkColumn DataNavigateUrlField="IdentifyString" DataNavigateUrlFormatString="TTActorGroupMemberView.aspx?IdentifyString={0}" DataTextField="ActorGroup" HeaderText="�����ɫ��? Target="_blank">
                                                <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="25%" />
                                            </asp:HyperLinkColumn>
