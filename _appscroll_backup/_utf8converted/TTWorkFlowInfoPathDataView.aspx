 ...
 <%--   <script type="text/javascript" src="js/pageoffice.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function hideDivByApp() {
            ...
            //璺宠浆璇彞
            if (system.win || system.mac || system.xll) {//杞悜鍚庡彴鐧婚檰椤甸潰
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            //渚濇祦绋嬫ā鏉挎楠ゅ畾涔夌殑姝ゅ嚱鏁拌缃〃鍗曞悇绉嶅睘鎬?
            try {
                setWorkflowForm();
            }
            catch (error) {
...
<body onload="TakeTopInfoPath_Init();hideDivByApp();" onclick="aHandlerForWorkflowDIYFormDataPopWindow(arguments[0])">
    ...
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="4" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td class="tdRight" colspan="11" style="text-align: left; padding-left: 50px;">
                                ...
                                <a href='TTRelatedDIYBusinessForm.aspx?RelatedType=Contract&RelatedID=<%#DataBinder .Eval (Container .DataItem ,"ConstractID") %>&IdentifyString= <%# ShareClass.GetWLTemplateIdentifyString(ShareClass.getBusinessFormTemName("Contract", Eval("ConstractID").ToString())) %>'>
                ...
                <ItemTemplate>
                    <table width="98%" cellspacing="0" cellpadding="2">
                        <tr>
                            ...
                            <td style="width: 12%;" class="tdLeft">
                                ...
                                <table class="formBgStyle" cellpadding="3" cellspacing="0" style="width: 98%; margin-top: 2px; background-color: white;"
                                    ...
                                    <tr>
                                        <td style="text-align: left; width: 15%;">
                                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,ZhaoBiaoBianHao%>"></asp:Label>锛?
                                        </td>
                                        ...
                                        <td style="text-align: left; width: 10%;">
                                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,XiangMuMingCheng%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" style="width: 30%;">
                                            <%# DataBinder.Eval(Container.DataItem,"ProjectName") %>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,HeTongHao%>"></asp:Label>锛?/td>
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,ZhaoBianDaiLi%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" colspan="3">
                                            <%# DataBinder.Eval(Container.DataItem,"BiddingAgent") %>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,LianXiDianHua%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,ZhaoBiaoRen%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" colspan="3">

                                            <%# DataBinder.Eval(Container.DataItem,"UserCode") %>
                                        </td>
                                        <td style="text-align: left; width: 15%;">
                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,LianXiDianHua%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label44" runat="server" Text="<%$ Resources:lang,XiaoShou%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" colspan="3">

                                            <%# DataBinder.Eval(Container.DataItem,"SalesCode") %>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label45" runat="server" Text="<%$ Resources:lang,LianXiDianHua%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,XiangMuJingLi%>"></asp:Label>锛?/td>
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JiShuFuZeRen%>"></asp:Label>锛?/td>
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label46" runat="server" Text="<%$ Resources:lang,XiangMuJinBanRen%>"></asp:Label>锛?/td>
                                        <td align="right" colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    <td style="text-align: right; width: 30%;">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label49" runat="server" Text="<%$ Resources:lang,NiWaiSuoXing%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" colspan="2">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,BiaoShuGouMaiRiQi%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">

                                            <%# DataBinder.Eval(Container.DataItem,"TenderBuyTime") %>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,TiQianYuJingTianShu%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label47" runat="server" Text="<%$ Resources:lang,TouBiaoBaoJia%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" colspan="3">

                                            <%# DataBinder.Eval(Container.DataItem,"BiddingPrice") %>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label48" runat="server" Text="<%$ Resources:lang,KongZhiJia%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft" colspan="3">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,BaoZhengJin%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,BaoZhengJinZhiFuRiQi%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                        ...
                                        <td class="ItemAlignLeft" colspan="3">
                                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:lang,TiQianYuJingTianShu%>"></asp:Label>锛?
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:lang,BaoZhengJinShouHuiRiQi%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,BaoZhengJinShouHuiShu%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                            <%# DataBinder.Eval(Container.DataItem,"ReceiveMargin") %>
                                        </td>

                                        <td class="ItemAlignLeft" colspan="3">
                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,TiQianYuJingTianShu%>"></asp:Label>锛?
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,KaiBiaoRiQi%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">

                                            <%# DataBinder.Eval(Container.DataItem,"BidOpeningDate") %>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label23" runat="server" Text="<%$ Resources:lang,TiQianYuJingTianShu%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label25" runat="server" Text="<%$ Resources:lang,ZBFJNRQ%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,TiQianYuJingTianShu%>"></asp:Label>锛?/td>
                                        <td class="ItemAlignLeft">
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,XiangMuSuoSuoZhuanYe%>"></asp:Label>锛?/td>
                                    ...
                                    <tr>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label>锛?/td>
        ...
        <table class="DemoTable">
            ...
            <tr>
                <td class="ItemAlignLeft" style="padding-left: 20px;">
                    <br />
                                ...
                                <asp:DataList ID="DataList29" runat="server" CellPadding="4" ForeColor="#333333" Width="800px">
                                    ...
                                    <ItemTemplate>
                                        <table style="width: 100%; table-layout: fixed;">
                                            <tr>
                                                <td class="ItemAlignLeft" style="color: Blue; font-style: italic; text-decoration: none; width: 300px;">
                                                ...
                                                <td class="ItemAlignLeft" style="width: 35%; color: Blue; font-style: italic; text-decoration: none;">
                                                ...
                                                <td class="ItemAlignLeft" style="color: Blue; font-style: italic; text-decoration: none;">
                                            ...
                                            <tr>
                                                <td colspan="4" style="text-overflow: ellipsis; word-break: keep-all; overflow: hidden;">
                                                    <a href='<%# "TTWorkFlowInfoPathDataViewForBrowse.aspx?XSNFile=" +strXSNFile + "&WLID=" +strWLID + "&StepID=" + DataBinder.Eval(Container.DataItem,"StepID") +"&ID=" + DataBinder.Eval(Container.DataItem,"ID")  %>'>琛ㄥ崟鏁版嵁</a>
            ...
            <center>
                <table style="width: 600px;">
                    <tr>
                        ...
                        <td class="ItemAlignLeft" style="width: 100px; padding-top: 5px;">
