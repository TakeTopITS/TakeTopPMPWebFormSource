    ...
    <script type="text/javascript">
        ...
        function UpdateWorkflowPlanType() {
            ...
            $.ajax({
                ...
                data: { "IsMainPlan": varIsMainPlan, "WFID": varWFID },             //鍙傛暟瑕佸搴?      
        ...
        <form id="form1" runat="server">
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" style="width: 50%; border-right: solid 1px #d0d0d0; padding: 2px 2px 2px 2px;">
                                                                        <table class="formBgStyle" cellpadding="3" cellspacing="0" style="width: 98%; margin-top: 2px; background-color: white;"
                                                                            ...
                                                                            <tr>
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="Label722" runat="server" Text="<%$ Resources:lang,ZhaoBiaoRen%>"></asp:Label>锛?/td>
                                                                                <td class="ItemAlignLeft" colspan="3">
                ...
                <div id="divToolBar" name="divTooBar" class="ToolBar" style="width: 100%; text-align: left; padding-top: 10px; padding-bottom: 20px; background-color: aliceblue;">
                    <table>
                        <tr>
                            ...
                            <td colspan="2"class="ItemAlignLeft" style="width: 300px;">
                            ...
                            <td colspan="2"class="ItemAlignLeft" style="width: 320px;">
                            ...
                            <td class="ItemAlignLeft" style="padding-left: 20px; display: none;">
            ...
            <div id="bgLayer" style="z-index: 9998; position: absolute; filter: alpha(style=0,opacity=100); width: 520px; display: none; background: #cccccc; height: 100px; left: 30%; top: 40%">
                <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Width="520px" Height="100px">
                    <table>
                        <tr>
                            <td style="width: 520px; padding: 5px 5px 5px 20px;" valign="top" class="ItemAlignLeft">
                        ...
                        <tr>
                            <td style="width: 520px; padding: 5px 25px 5px 5px;" valign="top" class="ItemAlignLeft">
                    ...
                    <td class="tdLeft" colspan="3" style="padding: 1px 1px 1px 1px; border-bottom: solid 1px #d0d0d0; border-right: solid 1px #d0d0d0;">
                        <table style="width: 530px;" cellpadding="3" cellspacing="0">
                            <tr>
                                ...
                                <td class="ItemAlignLeft" width="210">
                            ...
                            <tr style="display: none;">
                                <td class="tdLeft" width="50px">XML:
                                </td>
                                <td colspan="2"class="ItemAlignLeft" style="width: 320px;">
                            ...
                            <tr style="display: none;">
                                <td colspan="3" class="tdRight" style="text-align: center; width: 370px;">
                                    ...
                                    <asp:HyperLink ID="HL_OldWFXMLFile" runat="server"
                                        Target="_blank" Font-Names="瀹嬩綋" Text="<%$ Resources:lang,ShuJuWenJian%>"></asp:HyperLink>
                            ...
                            <tr style="display: none;">
                                ...
                                <td colspan="2"class="ItemAlignLeft" style="width: 320px;">
                                    ...
                                    <asp:HyperLink ID="HL_WLTem" runat="server" NavigateUrl="~/TTWorkFlowTemplate.aspx"
                                        Target="_blank" Font-Names="瀹嬩綋" Text="<%$ Resources:lang,TemplateMaintain%>"></asp:HyperLink>
