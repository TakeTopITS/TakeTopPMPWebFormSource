                        ...
                        <tr>
                            <td>
                                <table width="98%" cellpadding="0" cellspacing="0">
                                            ...
                                            <table width="95%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                ...
                                                <tr style="font-size: 10pt">
                                                    <td style="width: 100%;" class="formItemBgStyleForAlignLeft">
                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>:<asp:TextBox ID="TB_WLName" runat="server" Width="234px"></asp:TextBox>&nbsp;
                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,LeiXing%>"></asp:Label>:
                                                        ...
                                                        &nbsp;&nbsp;<asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,GongZuoLiuMuBan%>"></asp:Label>:<asp:DropDownList ID="DL_TemName" runat="server" DataTextField="TemName"
                                                            DataValueField="TemName" Width="180px">
                                                        </asp:DropDownList>
                                                        &nbsp; &nbsp;<asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,ChaXunGuanJianZi%>"></asp:Label>:<asp:TextBox ID="TB_KeyWord" runat="server" Width="60px"></asp:TextBox>
                                                ...
                                                <tr style="font-size: 10pt">
                                                    <td style="width: 100%; height: 51px;" class="formItemBgStyleForAlignLeft">
                                                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,ShuoMing%>"></asp:Label>:<asp:TextBox ID="TB_Description" runat="server" TextMode="MultiLine" Width="712px"
                                    ...
                                    <tr>
                                        <td>
                                            <table class="ItemAlignLeft" width="90%">
                                                <tr>
                                                    <td class="ItemAlignLeft">
                                                        <b>
                                                            <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,DuiYingGongZuoLiuLieBiao%>"></asp:Label>:</b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ItemAlignLeft">
                                                        ...
                                                        <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" Height="1px"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="CreateTime" HeaderText="申请时间" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}">
