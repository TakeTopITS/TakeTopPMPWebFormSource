...
public partial class TTUserRegisteredSAASForInner : System.Web.UI.Page
{
    ...
    protected void BT_Add_Click(object sender, EventArgs e)
    {
        ...
        if (strUserCode != "" & strUserName != "" & strPassword != "" & strEmail != "")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZCSBMMCDBXDYHDY8WJC") + "')", true);
                return;
            }
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click2", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZCCG") + "')", true);
            }
            catch (Exception err)
            {
                LogClass.WriteLogFile("Error page: " + Request.Url.ToString() + "\n" + err.Message.ToString() + "\n" + err.StackTrace);
