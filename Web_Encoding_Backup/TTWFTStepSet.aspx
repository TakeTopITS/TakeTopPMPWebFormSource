                                                                                    ...
                                                                                    <asp:Button ID="BT_AddStepDetail" runat="server" OnClick="BT_AddStepDetail_Click"
                                                                                        CssClass="inpu" Text="<%$ Resources:lang,XinJian %>" />&#160;<asp:Button ID="BT_UpdateStepDetail" runat="server"
                                                                                            Enabled="False" OnClick="BT_UpdateStepDetail_Click" CssClass="inpu" Text="<%$ Resources:lang,BaoCun %>" />&#160;<asp:Button
                                                                                                ID="BT_DeleteStepDetail" runat="server" Enabled="False" OnClick="BT_DeleteStepDetail_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                                                        ...
                                                                        <asp:Button ID="BT_AddChileTem" runat="server" CssClass="inpu"
                                                                            OnClick="BT_AddChileTem_Click" Text="<%$ Resources:lang,XinZeng %>" />&#160;<asp:Button ID="BT_UpdateChileTem" runat="server" CssClass="inpu"
                                                                                Enabled="False" OnClick="BT_UpdateChileTem_Click" Text="<%$ Resources:lang,BaoCun %>" />&#160;<asp:Button ID="BT_DeleteChileTem" runat="server" CssClass="inpu"
                                                                                    Enabled="False" OnClick="BT_DeleteChileTem_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu %>" /></td>
                                                                </tr>
                                                            </table>
                                                        </ContentTemplate>
                                                    </cc1:TabPanel>
                                                                                    ...
                                                                                    <table width="110%">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="60px" class="ItemAlignLeft">
                                                                                                <asp:LinkButton ID="LBT_DeleteModule" runat="server" CommandName="Delete" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="&lt;div&gt;&lt;img src=ImagesSkin/Delete.png border=0 alt='Deleted' /&gt;&lt;/div&gt;"></asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <br />
