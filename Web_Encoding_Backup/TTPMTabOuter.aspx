<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TTPMTabOuter.aspx.cs" Inherits="TTPMTabOuter" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="PMBTab-layout">
                    ...
                    <label class="PMBTab-nav PMBTab-bg-involved" for="PMBTab-home" onclick="JavaScript:parent.detailPMFrame.location.href='TTInvolvedProject.aspx'">
                        <span class="PMBTab-nav-content">
                            <!-- 使用团队图标 -->
                            <div class="PMBTab-icon PMBTab-icon-involved">
                                <i class="fas fa-users"></i>
                            </div>
                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,MyInvolvedProject%>"></asp:Label>
                        </span>
                    </label>
                    ...
                    <label class="PMBTab-nav PMBTab-bg-undertake" for="PMBTab-about" onclick="JavaScript:parent.detailPMFrame.location.href='TTUndertakeProject.aspx'">
                        <span class="PMBTab-nav-content">
                            <!-- 使用任务图标 -->
                    ...
                    <label class="PMBTab-nav PMBTab-bg-created" for="PMBTab-contact" onclick="JavaScript:parent.detailPMFrame.location.href='TTCreatedProject.aspx'">
                        <span class="PMBTab-nav-content">
                            <!-- 使用创建图标 -->
