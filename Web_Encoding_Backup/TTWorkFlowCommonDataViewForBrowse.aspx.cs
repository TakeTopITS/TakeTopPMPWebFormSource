        ...
        if (e.CommandName == "OpenAccount")
        {
            ...
            if (strStatus != "Recorded")
            {
                ...
                if (strWFStatus == "Passed" | strWFStatus == "CaseClosed")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZJZCG + "')", true);
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZYLCZTTGHJA") + "')", true);
                }
            }
            else
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZSBBNZFJZ + "')", true);
            }
        }
    }
