                                            ...
                                            <ItemTemplate>
                                                ...
                                                <table cellpadding="4" cellspacing="0" style="width: 100%;" class="bianTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%" class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"VendorCode") %> </td>

                                                        <td style="width: 10%; text-align: right;">

                                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,MingCheng%>"></asp:Label>: </td>

                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"VendorName") %></td>
