                                                ...
                                                <table width="98%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                    <tr>
                                                        <td>
                                                          ...
                                                          <%--          <td width="12%" class="ItemAlignLeft"><strong><asp:Label runat="server" Text="<%$ Resources:lang,ShouWenRiQi%>"></asp:Label></strong></td>
                                                                    <td width="10%" class="ItemAlignLeft"><strong><asp:Label runat="server" Text="<%$ Resources:lang,ShiFouXiaoHui%>"></asp:Label><strong></td>--%>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="9%" class="ItemAlignLeft"><strong>
                                                              ...
                                                              <%--      <td width="10%" class="ItemAlignLeft"><strong><asp:Label runat="server" Text="<%$ Resources:lang,ShangChuanZhe%>"></asp:Label></strong></td>--%>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                               ...
                                                               <%--     <td width="10%" class="ItemAlignLeft"><strong><asp:Label runat="server" Text="<%$ Resources:lang,QianShouRen%>"></asp:Label></strong></td>
                                                                    <td width="12%" class="ItemAlignLeft"><strong><asp:Label runat="server" Text="<%$ Resources:lang,DianZiBan%>"></asp:Label></strong></td>
                                                                    <td width="10%" class="ItemAlignLeft"><strong><asp:Label runat="server" Text="<%$ Resources:lang,ShiFouHuiShou%>"></asp:Label><strong></td>--%>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
