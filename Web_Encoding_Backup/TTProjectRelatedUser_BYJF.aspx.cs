...
public partial class TTProjectRelatedUser_BYJF : System.Web.UI.Page
{
    ...
    protected void DLC_JoinDate_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click111", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZTSCCYZCSJDYQTXMJX") + "')", true);
        }
    ...
    protected void BT_CreateActorGroup_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXZSBJSZZMBNWKJC") + "')", true);
        }
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            if (strAction == "Add")
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXZCGCJSZCYYJRCXMCYZ") + "')", true);
            }
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZSCCGSYCJSZCYDXMDXGCYYSC") + "')", true);
            }
