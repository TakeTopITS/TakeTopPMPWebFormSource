...
public partial class TTArchiveProject : System.Web.UI.Page
{
    ...
    protected void DataGrid3_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Archive")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCXMYGDBYZJXGDDZLJC") + "')", true);
                    return;
                }

                if (strStatus != "CaseClosed")
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCXMHMYJABNGDJC") + "')", true);
                    return;
                }
            ...
            else
            {
                if (strStatus != "Archived")
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCXMZTBWGDBNCXJC") + "')", true);
                ...
                try
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZCheXiaoLanguageHandleGetWord")+"')", true); 
                }
                catch
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZCheXiaoLanguageHandleGetWord")+"')", true); 
    ...
    protected void BT_ProjectIDFind_Click(object sender, EventArgs e)
    {
        ...
        strHQL += " and project.PMCode in (Select projectMember.UserCode From ProjectMember as projectMember Where projectMember.DepartCode in " + strDepartString + ") and project.ProjectID <> 1";
        strHQL += "order by project.ProjectID DESC";
