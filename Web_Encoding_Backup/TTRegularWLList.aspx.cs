...
public partial class TTReqularWLList : System.Web.UI.Page
{
    ...
    public void InitialWorkFlowTree(TreeView TreeView, String strUserCode)
    {
        ...
        node0.Text = "<table background='ImagesSkin/main_n_bj.jpg' border='0' cellpadding='0' cellspacing='0' width='165px'><tr><td style='width:165px;'><B><B> " + LanguageHandle.GetWord("CYLCSQ") + "</B></td></tr></table>";
        node0.Target = "0";
        node0.Expanded = true;
        TreeView.Nodes.Add(node0);

        node1 = new TreeNode();
        node1.Text = "<B>" + LanguageHandle.GetWord("CYLC") + "</B>";
        node1.Target = "1";
        node1.Expanded = true;
        ...
        node2 = new TreeNode();
        node2.Text = "<B>" + LanguageHandle.GetWord("ShenQingLeiXing") + "</B>";
        node2.Target = "1";
        node2.Expanded = true;
        ...
        node3 = new TreeNode();
        node3.Text = "<B>" + LanguageHandle.GetWord("BaoBiao") + "</B>";
        node3.Target = "1";
        node3.Expanded = true;
        ...
        node6.Text = "<A href=TTExpenseApplyWFView.aspx Target=Right>" + LanguageHandle.GetWord("FYSQHZ") + "</a>";
        ...
        node5.Text = "<A href=TTExpenseClaimView.aspx Target=Right>" + LanguageHandle.GetWord("FYBXHZ") + "</a>";
