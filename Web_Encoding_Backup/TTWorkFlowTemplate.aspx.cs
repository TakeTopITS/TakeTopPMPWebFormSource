...
public partial class TTWorkFlowTemplate : System.Web.UI.Page
{
    ...
    protected void BT_DeleteWFTemplate_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZJGSCSBJC + "')", true);
            //ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('删除失败，此模板已用于工作流或不是你建立的，请检查')", true);
        }
    }
        ...
        if (this.FUP_File.PostedFile != null)
        {
            ...
            if (strFileName1 != "")
            {
                ...
                try
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZSHANGCCG + "')", true);
                }
                catch
                {
