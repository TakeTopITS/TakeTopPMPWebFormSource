                                            ...
                                            <td class="ItemAlignLeft">
                                                <table width="180" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td background="ImagesSkin/main_top_bj.jpg" class="titlezi">成本绩效基准信息列表
                                                        </td>
                                                        <td width="5">
                                            ...
                                            <td class="ItemAlignLeft">
                                                <table width="220" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td background="ImagesSkin/main_top_bj.jpg" class="titlezi">手工录入成本绩效基准数据
                                                        </td>
                                                        <td width="5">
                                                            <%-- <img src="ImagesSkin/main_top_r.jpg" width="5" height="31" />--%>
                                                        </td>
                                            ...
                                            <td class="ItemAlignLeft">
                                                <table width="220" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td background="ImagesSkin/main_top_bj.jpg" class="titlezi">导入成本绩效基准数据
                                                        </td>
                                                        <td width="5">
                                                            <%-- <img src="ImagesSkin/main_top_r.jpg" width="5" height="31" />--%>
                                                        </td>
