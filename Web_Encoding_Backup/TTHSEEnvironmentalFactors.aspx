                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="10%" class="ItemAlignLeft">
                                                                        <strong>
                                                                            <asp:Label ID="Label17" runat="server" Text="<%$ Resources:lang,ChuLiZhong%>"></asp:Label></strong>
                                                                    </td>
                                                                    <td width="10%" class="ItemAlignLeft">
                                                                        <strong>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table cellpadding="2" cellspacing="0" class="formBgStyle" width="900px">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft" style="width: 150px">
                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ChuLiZhong%>"></asp:Label>:</td>
                                    <td class="formItemBgStyleForAlignLeft" colspan="3">
