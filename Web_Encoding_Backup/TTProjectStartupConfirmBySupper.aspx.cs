    ...
    protected void DataGrid3_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            else
            {
                ...
                {
                    ShareClass.RunSqlCommand(strHQL);
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZTZQDCG") + "')", true);
                }
                catch
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZTZQDSBQJC") + "')", true);
                }
            }
