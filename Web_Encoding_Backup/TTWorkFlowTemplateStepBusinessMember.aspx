                                                            ...
                                                            <table width="110%">
                                                                <tr>
                                                                    ...
                                                                    <td width="60px" class="ItemAlignLeft">
                                                                        <asp:LinkButton ID="LBT_DeleteMember" runat="server" CommandName="Delete" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="&lt;div&gt;&lt;img src=ImagesSkin/Delete.png border=0 alt='Deleted' /&gt;&lt;/div&gt;"></asp:LinkButton>
                                                                    </td>
                                                                    <td align="right">
