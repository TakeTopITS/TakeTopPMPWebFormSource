                                                                                     ...
                                                                                     <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                                         <ContentTemplate>
                                                                                             <div>
                                                                                                 ...
                                                                                                 <asp:Label ID="Label28" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/MaterialInitialDataImportTemplate.xls"><asp:Label ID="Label29" runat="server" Text="<%$ Resources:lang,QCSJDRMB%>"></asp:Label></a>
                                                                                                 <div id="ProgressBar">
