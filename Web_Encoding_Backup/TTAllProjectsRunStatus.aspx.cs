...
public partial class TTAllProjectsRunStatus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            strHQL += " and project.Status not in ('Deleted','Cancel') and project.ProjectID <> 1";
            ...
            DL_ProjectType.Items.Insert(0, new ListItem("--All Projects--", ""));
        }
    }
    ...
    protected void DL_ProjectType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        strHQL += " and project.Status not in ('Deleted','Archived') and project.ProjectID <> 1";
        strHQL += " Order by project.ProjectID DESC";
