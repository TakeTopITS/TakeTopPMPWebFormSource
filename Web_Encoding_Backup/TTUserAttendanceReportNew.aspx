                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="ItemAlignLeft" rowspan="2">
                                                        <strong>
                                                    ...
                                                    <td class="ItemAlignLeft" runat="server" id="leaveTd">
                                                        <strong>
                                                    ...
                                                    <td class="ItemAlignLeft" runat="server" id="overtimeTd">
                                                        <strong>
                                                            <asp:Label ID="Label33" runat="server" Text="加班时长(小时)"></asp:Label></strong>
                                                    </td>
                                                    <td class="ItemAlignLeft" runat="server" id="kqjgTd">
                                                        <strong>
                                                ...
                                                <asp:Repeater runat="server" ID="rpReport" OnItemDataBound="rpReport_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr class="reportTr">
                                                            <td class="ItemAlignLeft"><%#Eval("Name") %></td>

                                                            <td class="ItemAlignLeft"><%#Eval("Department") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("工号") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("Position") %></td>
                                                            <asp:Repeater runat="server" ID="rpReportLeave">
                                                                <ItemTemplate>
                                                                    <td class="ItemAlignLeft"><%#DataBinder.Eval((Container.Parent.Parent as RepeaterItem).DataItem,(GetDataItem() as DataRowView).Row["Type"].ToString()) %></td>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
                                                            <td class="ItemAlignLeft"><%#Eval("出勤天数") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("应出勤天数") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("迟到次数") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("迟到时长") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("旷工迟到次数") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("早退次数") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("早退时长") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("旷工天数") %></td>
                                                            <td class="ItemAlignLeft"><%#Eval("夜班天数") %></td>
