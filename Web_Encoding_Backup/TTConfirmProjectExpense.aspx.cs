    ...
    protected void DataList1_ItemCommand(object sender, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Update")
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZGXFYCG") + "')", true);
            }
            catch
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZGXFYSBJC") + "')", true);
            }
        }
    }
