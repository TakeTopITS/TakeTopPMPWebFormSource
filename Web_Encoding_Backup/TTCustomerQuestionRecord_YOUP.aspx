                            ...
                            <td>
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="padding: 5px 0px 0px 5px" valign="top" class="ItemAlignLeft">
                                                                        ...
                                                                        <tr>
                                                                            <td class="ItemAlignLeft">
                                                                                <asp:Button ID="BT_New" CssClass="inpu" runat="server" Text="<%$ Resources:lang,XinJian%>" OnClick="BT_New_Click" />&#160;<asp:Button ID="BT_Update" CssClass="inpu" runat="server" Text="<%$ Resources:lang,BaoCun%>" OnClick="BT_Update_Click"
                                                                                    Enabled="False" />&#160;<asp:Button ID="BT_Delete" CssClass="inpu" runat="server" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
