                ...
                <ContentTemplate>
                                    ...
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="text-align: right; padding-top: 5px;">
                                                <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,YuYan%>"></asp:Label>:</td>
                                            ...
                                            <td width="200px" class="ItemAlignLeft" style="padding-top: 2px;">
                                                <asp:Button ID="BT_CopyAllActorGroupForHomeLanguage" runat="server" CssClass="inpuLongest" OnClick="BT_CopyAlActorGroupForHomeLanguage_Click" Text="<%$ Resources:lang,CopyFromHomeLanguage%>" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-top: 5px;">
                                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                                                    <ItemTemplate>
                                                        <asp:Button ID="BT_GroupName" runat="server" CssClass="inpuLongRepeat" Text='<%# DataBinder.Eval(Container.DataItem,"HomeName") %>' ToolTip='<%# DataBinder.Eval(Container.DataItem,"GroupName") %>' />
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,MingChengBenYu%>"></asp:Label>
                                                            : </td>
                                                        <td>
                                                        ...
                                                        <td class="ItemAlignLeft" width="60PX">
                                        ...
                                        <tr>
                                            <td style="text-align: Center;">
                                                ...
                                                <asp:Button ID="BT_DeleteActorGroup" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeleteActorGroup_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChuJueSeZu%>" />
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="90%" class="bian">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align: left; padding: 5px 5px 5px 5px;">
                                                            <asp:Label ID="LB_ActorGroupHomeName" runat="server"></asp:Label>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="ItemAlignLeft" style="width: 220px; border-right: solid 1px #D8D8D8; padding: 5px 0px 0px 5px" valign="top">
                                                ...
                                                <td style="width: 165px;">
                                                    <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td width="7">
                                                                <asp:Button ID="BT_DeleteAllSelect" runat="server" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" OnClick="BT_DeleteAllSelect_Click" Text="X"></asp:Button>
                                                            </td>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
