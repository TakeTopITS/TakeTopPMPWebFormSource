...
public partial class TTWorkFlowDesignerJS : System.Web.UI.Page
{
    ...
    protected void BT_SaveWFDefinition_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('" + Resources.lang.ZZBCCG + "');</script>");
        }
        catch
        {
            ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('" + Resources.lang.ZZBCSB + "');</script>");
        }
    }
