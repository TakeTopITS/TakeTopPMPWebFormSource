...
public partial class TTProjectRelatedUserSAAS : System.Web.UI.Page
{
    ...
    protected void DataGrid2_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Update")
            {
                ...
                TB_RelatedUserCode.Text = relatedUser.UserCode.Trim();
                TB_RelatedUserName.Text = relatedUser.UserName.Trim();
    ...
    protected void DataGrid4_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        TB_RelatedUserCode.Text = strUserCode;
        TB_RelatedUserName.Text = strUserName;
    ...
    protected void AddUser()
    {
        ...
        string strUserCode = TB_RelatedUserCode.Text.Trim();
        string strUserName = TB_RelatedUserName.Text.Trim();
        ...
        //依据用户代码和名称检查用户是否存在
        if (ShareClass.CheckUserIsExistByUserCodeAndName(strUserCode, strUserName) == false)
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGCYHDMHXMBCZQXZC") + "')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','true') ", true);
            return;
        }
        ...
        if (strActor != "")
        {
            try
            {
                ...
                //添加项目成员到成员直接下级列表中
                string strHQL = "Select * From T_MemberLevel Where UserCode = '" + Session["UserCode"].ToString() + "' and UnderCode = '" + strUserCode + "'";
    ...
    protected void BT_PersonalSMS_Click(object sender, EventArgs e)
    {
        ...
        strRelatedUserCode = TB_RelatedUserCode.Text.Trim();
        strRelatedUserName = TB_RelatedUserName.Text.Trim();
