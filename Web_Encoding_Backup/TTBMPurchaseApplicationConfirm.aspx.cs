    ...
    protected string SubmitApply()
    {
        ...
        try
        {
            ...
            catch
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZShenQingShengChengLanguageHa") + LanguageHandle.GetWord("ZZSBJC") + "')", true); 
            }
