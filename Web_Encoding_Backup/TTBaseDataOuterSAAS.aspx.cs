...
public partial class TTBaseDataOuterSAAS : System.Web.UI.Page
{
    ...
    protected void DataGrid19_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            ...
            // 打开编辑模态框
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "openModal", "showModal('modalTaskRecord', document.getElementById('" + ((Button)e.Item.FindControl("BT_TaskRecordType")).ClientID + "'));", true);
        }
    }
    ...
    protected void DataGrid38_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "Edit")
        {
            ...
            // 打开编辑模态框
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "openModal", "showModal('modalReceivePay', document.getElementById('" + ((Button)e.Item.FindControl("BT_ReceivePayType")).ClientID + "'));", true);
        }
    }
    ...
    protected void BT_OperationNew_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                ...
                taskOperationBLL.UpdateTaskOperation(taskOperation, Operation: strOperation);
            }
            catch
            {
            }
    ...
    protected void BT_UnitNew_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                ...
                jnUnitBLL.UpdateJNUnit(jnUnit, UnitName: strUnitName);
            }
            catch
            {
            }
    ...
    protected void BT_ActorGroupNew_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                ...
                actorGroupTypeBLL.UpdateActorGroupType(actorGroupType, Type: strType);
            }
            catch
            {
            }
    ...
    protected void BT_TaskTypeNew_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                taskTypeBLL.UpdateTaskType(taskType, Type: strType);
            }
            catch
            {
            }
    ...
    protected void BT_TaskRecordNew_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                taskRecordTypeBLL.UpdateTaskRecordType(taskRecordType, Type: strType);
            }
            catch
            {
            }
        ...
        LoadTaskRecordType();
        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "closeModal", "hideModal('modalTaskRecord');", true);
    }
    ...
    protected void BT_AddReceivePayWay_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                receivePayWayBLL.UpdateReceivePayWay(receivePayWay, Type: strWay);
            }
            catch
            {
            }
        ...
        LoadReceivePayWay();
        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "closeModal", "hideModal('modalReceivePay');", true);
    }
    ...
    protected void BT_AddBank_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                bankBLL.UpdateBank(bank, BankName: strBankName);
            }
            catch
            {
            }
    ...
    protected void BT_AddCurrencyType_Click(object sender, EventArgs e)
    {
        ...
        catch
        {
            try
            {
                ...
                currencyTypeBLL.UpdateCurrencyType(currencyType, Type: strCurrencyType);
            }
            catch
            {
            }
