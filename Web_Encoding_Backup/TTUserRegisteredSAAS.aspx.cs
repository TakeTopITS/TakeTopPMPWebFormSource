...
public partial class TTUserRegisteredSAAS : System.Web.UI.Page
{
    ...
    protected void BT_Add_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZNDLSZYBJYCOOKIESNBXSZLYXSYCOOKIESXHCNSYBXT").ToString().Trim() + "');", true);
            TB_CheckCode.Text = "";
            return;
        }
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZYZMCWSRZDYZM").ToString().Trim() + "');", true);
            TB_CheckCode.Text = "";
        ...
        if (strUserCode != "" & strUserName != "" & strPassword != "" & strEmail != "")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCYHYJZCQHLYGSJHM") + "')", true);
                return;
            }
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click2", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZCCGQFHDLYSRZHMMDLPT") + "')", true);
            }
            catch
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click3", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZCSBJC") + "')", true);
            }
        }
        else
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click4", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGDHXBNWKJC") + "')", true);
        }
    }
    ...
    protected void BT_Find_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZMYCCYJCYHDMHMCSFZ") + "')", true);
        }
    }
