                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td class="ItemAlignLeft" valign="top">
                                                            <table width="99%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td colspan="4" class="ItemAlignLeft" style="padding-left: 20px; font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                                                            ...
                                                                                            <td>
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <strong>
                                                                                                                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:lang,WenDang%>"></asp:Label></strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
