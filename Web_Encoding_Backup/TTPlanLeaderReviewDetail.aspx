                                    ...
                                    <tr>
                                        <td style="text-align: Right;" colspan="2">
                                            ...
                                            <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td class="ItemAlignLeft" class="tdTopLine">
                                                        <b>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <table cellpadding="4" cellspacing="0" width="100%">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="tdLeft" style="width: 5%; text-align: center;">
                                                                                                    <asp:Button ID="BT_Delete" runat="server" CommandName="Delete" CssClass="inpuDelete" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="ItemAlignLeft" width="70%">
