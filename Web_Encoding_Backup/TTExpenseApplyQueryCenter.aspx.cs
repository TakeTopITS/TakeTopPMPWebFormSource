...
public partial class TTExpenseApplyQueryCenter : System.Web.UI.Page
{
    ...
    protected void BT_FindAOCode_Click(object sender, EventArgs e)
    {
        ...
        strHQL += " expenseApplyWL.ID = " + TB_AOCode.Text.Trim();
    ...
    protected void BT_Find_Click(object sender, EventArgs e)
    {
        ...
        strHQL = "from ExpenseApplyWL as expenseApplyWL where ";
        strHQL += " expenseApplyWL.ApplicantName Like " + "'%" + strApplicantName + "%'";
