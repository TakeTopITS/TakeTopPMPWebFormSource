...
public partial class TTSystemModuleSetForPage : System.Web.UI.Page
{
    ...
    protected void BT_DeleteDoubleModule_Click(object sender, EventArgs e)
    {
        ...
        string strModuleType, strUserType;
        ...
        strHQL = "delete from t_promodulelevelForPage where id not in (select max(id) from t_promodulelevelForPage group by modulename,parentmodule,moduletype,usertype,langcode);";
    ...
    {
        string strHQL;
        string strID, strModuleID, strUserType, strModuleType,strModuleName, strHomeModuleName,strParentModule, strVisible;
        ...
        try
        {
            for (j = 0; j < DataGrid4.Items.Count; j++)
            {
                ...
                strHQL = "Update T_ProModuleLevelForPage Set SortNumber = " + intSortNumber.ToString() + " Where ModuleName = '" + strModuleName + "' and trim(ParentModule)='" + strParentModule  + "'";
                ShareClass.RunSqlCommand(strHQL);
                ...
                strHQL = "Update T_ProModuleLevelForPage Set Visible = " + "'" + strVisible + "'" + " Where ModuleName = '" + strModuleName + "' and trim(ParentModule)='" + strParentModule + "'";
                ShareClass.RunSqlCommand(strHQL);
            }
