...
TB_Exception.Language = Session["LangCode"].ToString();
    ...
    protected void TreeView5_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        HL_ConstractReviewBYWF.NavigateUrl = "TTRelatedDIYWorkflowForm.aspx?RelatedType=Contract&RelatedID=" + constract.ConstractID.ToString();
        ...
        HL_WFTemName.NavigateUrl = "TTAttachWorkFlowTemplate.aspx?RelatedType=Contract&RelatedID=" + strConstractID;

        HL_TransferProject.Enabled = true;
        HL_TransferProject.NavigateUrl = "TTMakeProjectFromOther.aspx?RelatedType=Contract&RelatedID=" + strConstractID;

        HL_MakeCollaboration.Enabled = true;
        HL_MakeCollaboration.NavigateUrl = "TTMakeCollaboration.aspx?RelatedType=Contract&RelatedCode=" + strConstractCode;
    ...
    protected void BT_AddSaleOrder_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZJSBDDHCWWCDDSC") + "')", true);
        }
    ...
    protected void AddConstract()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZTSCHTTZYZDHTJC") + "')", true);
        ...
        if (intCount > 0)
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXZSBHTHZFJC") + "')", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZHTHHTMBNWKJC") + "')", true);
        ...
        else
        {
            ...
            try
            {
                ...
                //依项目类型添加关联的工作流模板
                ShareClass.AddRelatedWorkFlowTemplateByProjectType(strConstractType, strConstractID, "Contract", "Contract", "ConstractType");
                ...
                HL_WFTemName.Enabled = true;
                HL_WFTemName.NavigateUrl = "TTRelatedWorkFlowTemplate.aspx?RelatedType=Contract&RelatedID=" + strConstractID;
    ...
    protected void UpdateConstract()
    {
        ...
        if (strConstractCode != strConstractCode1)
        {
            ...
            if (intCount > 0)
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXGSBHTHZFJC") + "')", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZHTHHTMYWYBNWKJC") + "')", true);
        ...
        else
        {
            ...
            try
            {
                ...
                //依项目类型添加关联的工作流模板
                ShareClass.AddRelatedWorkFlowTemplateByProjectType(strConstractType, intConstractID.ToString(), "Contract", "Contract", "ConstractType");

                //BusinessForm，关联相应的业务表单模板
                ShareClass.SaveRelatedBusinessForm("Contract", intConstractID.ToString(), DL_WFTemplate.SelectedValue, DL_AllowUpdate.SelectedValue, strUserCode);
            ...
            catch
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZSBHHTBNZWZHTDZHTQJC") + "')", true);
    ...
    protected void DataGrid1_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Update" | e.CommandName == "Detail")
            {
                ...
                ShareClass.LoadBusinessForm("Contract", strConstractID, DL_WFTemplate.SelectedValue.Trim(), IFrame_RelatedInformation);
        ...
        if (e.CommandName == "Delete")
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGZHTCZZHTBNSCQJC") + "')", true);
                return;
            }
    ...
    protected void BT_StartupBusinessForm_Click(object sender, EventArgs e)
    {
        ...
        strURL = "TTRelatedDIYBusinessForm.aspx?RelatedType=Contract&RelatedID=" + strConstractID + "&IdentifyString=" + strIdentifyString;
    ...
    protected void AddSales()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXJSBJC") + "')", true);
    ...
    protected void BT_UserAuthoritySave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXSZCG") + "')", true);
        }
        catch
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXSZSB") + "')", true);
        }
