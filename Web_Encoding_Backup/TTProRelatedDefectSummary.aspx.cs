...
public partial class TTProRelatedDefectSummary : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //this.Title = LanguageHandle.GetWord("Project") + strProjectID + " 相关需求";
        ...
        if (Page.IsPostBack != true)
        {
            ...
            LB_ReportName.Text = LanguageHandle.GetWord("XiangMu") + ": " + strProjectID + " " + LanguageHandle.GetWord("QueXianBaoBiao");
