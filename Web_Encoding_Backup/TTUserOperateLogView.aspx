                        ...
                        <tr>
                            <td class="ItemAlignLeft">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td class="ItemAlignLeft" style="padding: 5px 5px 5px 5px; font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                            ...
                                                            <ItemTemplate>
                                                                <table cellpadding="4" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 20%;" class="tdLeft">
                                                                    ...
                                                                    <tr>
                                                                        <td class="ItemAlignLeft" valign="top" style="width: 10%; padding-left: 5px" class="tdLeft">
