                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="text-align: Left; padding: 5px 5px 5px 5px;">
                                            ...
                                            &nbsp;&nbsp;
                                                        <asp:Label ID="LB_TotalAccountBudget" runat="server" Text="<%$ Resources:lang,ShiZhuoYuSuan%>"></asp:Label>:
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="10%" class="ItemAlignLeft">
                                                                    <strong>
                                                                        <asp:Label ID="LB_dgAmount" runat="server" Text="<%$ Resources:lang,YuSuan%>"></asp:Label></strong>
                                                                </td>
                                                                ...
                                                                <td width="10%" class="ItemAlignLeft">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <div style="position: relative; height: 20px; width: 205px; margin-bottom: 2px;">
                                                                ...
                                                                <div style="position: absolute; top: 0; left: 5px; height: 20px; line-height: 20px; z-index: 3;">
                                                                    <asp:Label ID="LB_FinishPercent" runat="server" Font-Size="Small"
                                                                        Style="color: #000; background: transparent !important;"></asp:Label>
                                                                </div>
                                                            </div>

                                                            <!-- 第二行：预算显示 -->
                                                            <div style="position: relative; height: 20px; width: 205px;">
                                                                <!-- 预算文字 - 右对齐 -->
                                                                <div style="position: absolute; top: 0; right: 5px; height: 20px; line-height: 20px;">
                                                                    <asp:Label ID="LB_DefaultPercent" runat="server" Font-Size="Small"
                                                                        Style="color: #000; background: transparent !important; text-align: right;"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </ItemTemplate>
                            ...
                            <table style="width: 100%;" cellpadding="3" cellspacing="0" class="formBgStyle">
                                <tr>
                                    ...
                                    <td style="width: 35%; height: 19px;" class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_Account" runat="server" Width="150px" Enabled="false"></asp:TextBox>
                                        <asp:DropDownList ID="DL_Account" runat="server" AutoPostBack="True" DataTextField="AccountName"
                                            DataValueField="AccountName" Width="100px" Height="25px" OnSelectedIndexChanged="DL_Account_SelectedIndexChanged">
                                        </asp:DropDownList>
