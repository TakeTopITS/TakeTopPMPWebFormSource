                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="5" style="text-align: left; height: 2px;" class="formItemBgStyleForAlignLeft">&nbsp;
                                                                                      ...
                                                                                      <asp:Button ID="BT_Active" runat="server" CssClass="inpuActive" ToolTip="<%$ Resources:lang,JiHuo%>" Enabled="False" OnClick="BT_Active_Click" />
                                                                                                   &nbsp;
                                                                                                      <asp:Button ID="BT_Delete" runat="server" Enabled="False" ToolTip="<%$ Resources:lang,shanchu%>" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                                                                       CssClass="inpuDelete" />
                                                                                               </td>
                                                                                </td>
                                                                                <td style="padding-left: 20px;">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <table class="formBgStyle" style="width: 80%" cellpadding="3" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="ItemAlignLeft" colspan="4" class="formItemBgStyleForAlignLeft">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="3"  class="formItemBgStyleForAlignLeft">
                                                                                    ...
                                                                                    &nbsp;<asp:Button ID="BT_DeleteAssign" runat="server" CssClass="inpu" Enabled="False" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
