                                                        ...
                                                        <td  style="width: 100%; padding: 5px 5px 5px 5px;" class="formItemBgStyleForAlignLeft" valign="top">
                                                            <table class="formBgStyle">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="formItemBgStyleForAlignLeft"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,JiHuaBianZhi%>"></asp:Label>:<asp:Label ID="LB_PlanMarkerName" runat="server" Text="**"></asp:Label>
                                                                    </td>
                                                                    <td class="formItemBgStyleForAlignLeft"
