                                                            ...
                                                            <table class="formBgStyle">
                                                                ...
                                                                <tr>
                                                                    <td colspan="7"  class="formItemBgStyleForAlignLeft">
                                                                        ...
                                                                        <asp:Button ID="BT_NewDelete" runat="server" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_NewDelete_Click" CssClass="inpu" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"/>&nbsp;
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
