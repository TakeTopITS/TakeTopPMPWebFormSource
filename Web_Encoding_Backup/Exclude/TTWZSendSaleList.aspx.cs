...
public partial class TTWZSendSaleList : System.Web.UI.Page
{
    ...
    protected void BT_Save_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            wZSend.Progress = "录入";
            wZSend.IsMark = 0;
            wZSend.SendMethod = "蓝票";//strSendMethod;
            wZSend.ProjectCode = "-";//strProjectCode;
            wZSend.StoreRoom = strStoreRoom;
            wZSend.UnitCode = strUnitCode;
            wZSend.PickingUnit = strPickingUnit;
    ...
    protected void BT_SalePrice_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(strSendCode))
        {
            ...
            if (!string.IsNullOrEmpty(strSalePrice))
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('"+Resources.lang.ZZXSDJBXWXSHZZS+"')", true);
                    return;
                }
                else
                {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('"+Resources.lang.ZZXSDJBNWK+"')", true);
                return;
            }
        }
        else {
    ...
    protected void BT_ManageRate_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(strSendCode))
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('"+Resources.lang.ZZGLFLBNWK+"')", true);
                return;
            }
        }
        else
