                                                            ...
                                                            <table class="formBgStyle" width="1000px">
                                                                ...
                                                                <tr>
                                                                    <td class="formItemBgStyleForAlignLeft" colspan="6">
                                                                        ...
                                                                        <asp:Button ID="BT_NewDelete" runat="server" Text="<%$ Resources:lang,ShanChu%>" CssClass="inpu" Enabled="false" OnClick="BT_NewDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"/>&nbsp;
