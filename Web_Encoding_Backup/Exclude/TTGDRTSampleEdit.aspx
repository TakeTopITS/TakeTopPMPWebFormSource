                                            ...
                                            <td valign="top" style="padding-top: 5px;">
                                                <table style="width: 80%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        ...
                                                        <td  class="formItemBgStyleForAlignLeft">joint:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">RT Sample No:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_RTSampleNo" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">rt_instr_no:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_RTInstrNo" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">rt_sample_serial_no:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Remark:
                                                        </td>
