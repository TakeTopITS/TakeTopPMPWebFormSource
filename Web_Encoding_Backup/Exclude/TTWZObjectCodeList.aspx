                                                                ...
                                                                <table class="formBgStyle" width="60%">
                                                                    ...
                                                                    <tr>
                                                                        <td class="formItemBgStyleForAlignLeft" colspan="6">
                                                                            ...
                                                                            <asp:Button ID="BT_NewDelete" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_NewDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"/>&nbsp;
