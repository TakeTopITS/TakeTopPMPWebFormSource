                                            ...
                                            <td valign="top" style="padding-top: 5px;">
                                                <table style="width: 80%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        ...
                                                        <td  class="formItemBgStyleForAlignLeft">Fri1:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri2:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_Fri2" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri3:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_Fri3" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri4:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri5:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_Fri5" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri6:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_Fri6" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri7:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                    ...
                                                    <tr>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri8:
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">
                                                            <asp:TextBox ID="TXT_Fri8" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td  class="formItemBgStyleForAlignLeft">Fri9:
                                                        </td>
