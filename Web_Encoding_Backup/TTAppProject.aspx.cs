...
public partial class TTAppProject : System.Web.UI.Page
{
    ...
    protected void BT_AddProject_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMDMBCZQJC") + "')", true);
            return;
        }
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZNBZCXMYYCYZZQJC") + "')", true);
            return;
        }
