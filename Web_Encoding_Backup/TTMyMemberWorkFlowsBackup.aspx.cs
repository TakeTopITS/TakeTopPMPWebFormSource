...
public partial class TTMyMemberWorkFlowsBackup : System.Web.UI.Page
{
    ...
    protected void BT_AllWorkFlow_Click(object sender, EventArgs e)
    {
        ...
        LB_QueryScope.Text = LanguageHandle.GetWord("GongZuoLiu") + ": " + LanguageHandle.GetWord("SuoYou");
    ...
    protected void DataGrid2_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        else
        {
            if (LB_OperatorCode.Text == "")
            {
                ...
                strHQL += " and Status <> 'New'";
                strHQL += " Order by WLID DESC";
                LB_QueryScope.Text = LanguageHandle.GetWord("ZZZBuMen") + strDepartCode + " " + strDepartName + LanguageHandle.GetWord("ZhuangTai") + ":" + strStatus;
            }
            else
            {
                ...
                strHQL += " and Status <> 'New'";
                strHQL += " Order by WLID DESC";
                LB_QueryScope.Text = LanguageHandle.GetWord("ZZApplicant") + strOperatorCode + strOperatorName + LanguageHandle.GetWord("ZhuangTai") + ":" + strStatus;
            }
        }
        DataSet ds = ShareClass.GetDataSetFromSql(strHQL, "T_WorkFlowBackup");
        DataGrid3.DataSource = ds;
    ...
    protected void BT_Find_Click(object sender, EventArgs e)
    {
        ...
        LB_QueryScope.Text = LanguageHandle.GetWord("MingChen") + ":" + strWFName;
