...
public partial class TTCustomerManagement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", strUserCode);  //Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", "客户管理", strUserCode);
        ...
        if (Page.IsPostBack == false)
        {
            ...
            strHQL = "from Customer as customer ";
            strHQL += " Where customer.ReviewStatus = 'WAITING'";
    ...
    protected void BT_Find_Click(object sender, EventArgs e)
    {
        ...
        strHQL = "from Customer as customer where 1=1 ";
        strHQL += " and customer.ReviewStatus = 'WAITING'";
        strHQL += " and customer.Type like  " + "'" + strIndustryType + "'";
        strHQL += " and customer.BelongAgencyName Like " + "'" + strAgencyName + "'";
        strHQL += " and customer.State Like " + "'" + strState + "'";
        strHQL += " and customer.City Like " + "'" + strCity + "'";
