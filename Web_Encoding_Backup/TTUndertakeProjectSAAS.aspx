                                                            ...
                                                            <table style="width: 100%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td style="padding-right: 5px; text-align: right; height: 24px;" colspan="2">
                                                                        <asp:Button ID="BT_CreateProject" runat="server" CssClass="inpuYello" Text="<%$ Resources:lang,New%>" OnClientClick="clickMakeProject()" />
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="125px" class="ItemAlignLeft">
                                                                                    <strong>
                                                            ...
                                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Height="1px" PageSize="10"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn>
                                                                        ...
                                                                        <ItemStyle CssClass="itemBorder" HorizontalAlign="Left" Width="125px" />
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn>
                                                                        <ItemTemplate>
