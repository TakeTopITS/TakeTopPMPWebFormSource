                    ...
                    <table id="AboveTable" cellpadding="0" cellspacing="0" class="bian" width="100%">
                        <tr>
                            <td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="ItemAlignLeft" class="bian">
                                    <tr>
                                        ...
                                        <td>
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px 5px 0px 5px; vertical-align: top;" class="ItemAlignLeft">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ItemAlignLeft">
                                                                    <asp:Button ID="BT_DeletePlanVersion" runat="server" CssClass="inpu" Text="<%$ Resources:lang,Delete%>"
                                                                        OnClick="BT_DeletePlanVersion_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <hr />
