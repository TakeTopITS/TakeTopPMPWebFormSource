                            ...
                            <tr>
                                <td height="31" class="page_topbj">
                                    <table width="99%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="ItemAlignLeft" style="padding-bottom: 5px; padding-top: 10px;">
                                                <table width="100%">
                                                    <tr>
                                                        <td class="ItemAlignLeft" width="13%" background="ImagesSkin/main_top_bj.jpg" class="titlezi">
                                                        ...
                                                        <td class="ItemAlignLeft">
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:DropDownList ID="DL_WLType" runat="server" Width="110px" AutoPostBack="True" DataTextField="HomeName" DataValueField="Type" OnSelectedIndexChanged="DL_WLType_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:TextBox ID="TB_WFTemName" runat="server" Width="100px"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                                        <asp:DropDownList ID="DL_WLTem" runat="server" Width="100px" AutoPostBack="True" DataTextField="TemName" DataValueField="TemName" OnSelectedIndexChanged="DL_WLTem_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:TextBox ID="TB_WFCreatorName" Width="80px" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="Label50" runat="server" Text="<%$ Resources:lang,Cong%>"></asp:Label>
                                                                    </td>
                                                                  <td style="text-align: left;">
                                                                        <asp:TextBox ID="DLC_StartTime" ReadOnly="false" runat="server" Width="100px"></asp:TextBox>
                                                                    ...
                                                                    <td class="ItemAlignLeft">
                                                                        ...
                                                                        <asp:TextBox ID="DLC_EndTime" ReadOnly="false" runat="server"  Width="100px"></asp:TextBox>
                                                        ...
                                                        <td class="ItemAlignLeft" width="10%" background="ImagesSkin/main_top_bj.jpg" class="titlezi"></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="22%" class="ItemAlignLeft">
                                                                                                <strong>
