                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td colspan="3" class="ItemAlignLeft"><strong>工作流 </strong></td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="text-align: left;">
                                                                                            ...
                                                                                            <div onclick="popShowByURL('TTConstractMainContentEdit.aspx?ConstractID=<%# ShareClass.URLEncode(Eval("ConstractID").ToString()) %>','ConstractContent', 600, 500)">
                                                                                                  <span style="cursor:pointer;"><asp:Label ID="LB_OpenWord" Text="<%$ Resources:lang,BianJi %>" runat="server"></asp:Label></span> 
                                                                                            </div>
                                                                                ...
                                                                                <table style="width: 100%;">
                                                                                    <tr>
                                                                                        <td style="text-align: center;">
                                                                                            ...
                                                                                            <div onclick="popShowByURL('TTRelatedDIYWorkflowForm.aspx?RelatedType=Contract&RelatedID=<%# ShareClass.URLEncode(Eval("ConstractID").ToString()) %>','ConstractReview', 600, 500)">
                                                                                    ...
                                                                                    <%-- <tr>
                                                                                        <td style="text-align: center;">
                                                                                            <div onclick="popShowByURL('TTAttachWorkFlowTemplate.aspx?RelatedType=Contract&RelatedID=<%# ShareClass.URLEncode(Eval("ConstractID").ToString()) %>','ConstractReview', 600, 500)">
                            ...
                            <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer4" Width="100%" runat="server" ActiveTabIndex="0">
                                <cc1:TabPanel ID="TabPanel15" runat="server" HeaderText="基本信息" TabIndex="0">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td colspan="4" class="ItemAlignLeft" style="padding: 5px 5px 5px 5px;">
                                                            ...
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td class="ItemAlignLeft"><strong></strong></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
