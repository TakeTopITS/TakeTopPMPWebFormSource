                ...
                <ContentTemplate>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Button ID="BT_DeleteWFTemplate" runat="server" CssClass="inpu" Enabled="false"
                                                                                                    OnClick="BT_DeleteWFTemplate_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChuMuBan%>" /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <br />
                                                                                    <br />
                                                                                ...
                                                                                <td style="height: 14px; text-align: left">
                                                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                                        ...
                                                                                        <ContentTemplate>
                                                                                            ...
                                                                                            <asp:Button ID="BT_DeleteXSNFile" runat="server" OnClick="BT_DeleteXSNFile_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindowStepOperator"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <br />
                            <table class="ItemAlignLeft" cellpadding="2" cellspacing="0" class="formBgStyle" width="100%">
                                <tr>
