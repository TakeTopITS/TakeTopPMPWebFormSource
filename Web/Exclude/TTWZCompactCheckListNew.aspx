                                                ...
                                                <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft" width="100%">
                                                            ...
                                                            <asp:Button ID="BT_NewRecordDelete" runat="server" CssClass="inpu" Enabled="false" Text="<%$ Resources:lang,JiLuShanChu%>" OnClick="BT_NewRecordDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"/>&nbsp;
