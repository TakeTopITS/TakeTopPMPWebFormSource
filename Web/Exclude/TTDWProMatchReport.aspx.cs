    ...
    private void DataProductMatchBinder()
    {
        try
        {
            ...
            if (dtMatch != null && dtMatch.Rows.Count > 0)
            {
                ...
                #region 左边底部
                sbLeftFooter.Append("<tr><td class=\"formItemBgStyle\">总数量</td><td class=\"formItemBgStyle\">&nbsp;</td></tr><tr><td class=\"formItemBgStyle\">本色成本</td><td class=\"formItemBgStyle\">&nbsp;</td></tr><tr><td class=\"formItemBgStyle\">颜色料成本</td><td class=\"formItemBgStyle\">&nbsp;</td></tr><tr><td class=\"formItemBgStyle\">配方价</td><td class=\"formItemBgStyle\">&nbsp;</td></tr>");
                #endregion
            }
            else
            {
