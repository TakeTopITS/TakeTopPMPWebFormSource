                                                ...
                                                <table class="formBgStyle" width="40%">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center" class="formItemBgStyleForAlignLeft" valign="top" colspan="4">
                                                            ...
                                                            <asp:Button ID="BT_Delete" runat="server" Text="<%$ Resources:lang,ShanChuQuanBu%>" CssClass="inpu" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Visible="false" />&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
