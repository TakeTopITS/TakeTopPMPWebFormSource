...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ClickBarPrintMore() {
            ...
            if (intCount > 15) {
                showAlertAtMouse('每次选择不要超过15个资产代码进行打印，A4纸一版显示不完！');
                return false;
            }
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                   <td width="5%" class="ItemAlignLeft">
                                                                    ...
                                                                    <td width="62%" class="ItemAlignLeft">
                                                                        <strong>
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" class="ItemAlignLeft">
                                <tr>
                                    <td colspan="6" class="ItemAlignLeft" class="page_topbj">
                                                                        ...
                                                                        <td>
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="10%" class="ItemAlignLeft"><strong>IP</strong> </td>
                                                                                    <td width="10%" class="ItemAlignLeft"><strong>
