            ...
            <ContentTemplate>
                <div id="AboveDiv">
                    <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                        ...
                        <tr>
                            <td class="ItemAlignLeft" style="padding: 0px; overflow: hidden;" onmouseenter="javascript:displayScroll();" onmousemove="javascript:displayScroll();" onmouseover="javascript:displayScroll();" onmouseout="javascript:hideScroll();">
...
<script type="text/javascript">
        ...
        if (navigator.geolocation) {
            ...
            geolocation.getCurrentPosition(function (r) {
                if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                    ...
                    showAlertAtMouse('failed' + this.getStatus());
                }
    ...
    // 替换原来的单元素操作为多元素操作
    function hideAllLoadingDivs() {
        var loadingDivs = parent.window.document.getElementsByClassName('loading');
