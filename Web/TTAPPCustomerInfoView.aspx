                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <table cellpadding="4" cellspacing="0" style="width: 100%;" class="bianTable">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 20%" class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"CustomerCode") %> </td>
                                                                                        <td style="width: 10%; text-align: right;">
                                                                                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,KeHuMingCheng%>"></asp:Label>: </td>
                                                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"CustomerName") %></td>
                                                                                        <td style="width: 10%; text-align: right;">
                                                                                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,GuiShuBuMen%>"></asp:Label>: </td>
                                                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"BelongDepartCode") %>&nbsp;<%#DataBinder .Eval (Container .DataItem ,"BelongDepartName") %></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 100px" class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"Type") %></td>
                                                                                        <td style="width: 100px; text-align: right;">
                                                                                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ZhuYaoLianXiRen%>"></asp:Label>: </td>
                                                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"ContactName") %></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"Currency") %></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="text-align: right">
                                                                                        ...
                                                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"Discount") %></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="width: 100px; text-align: right">
                                                                                        ...
                                                                                        <td class="ItemAlignLeft"><%#DataBinder .Eval (Container .DataItem ,"CreditRate") %></td>
                                                                                    </tr>
                                                                                    <tr>
