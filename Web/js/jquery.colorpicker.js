...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position: absolute;margin-top:-205px;margin-left:-10px;display: none;"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" style="color:red;float: right;" id="_cclose">X</a> </td></tr></table></td></table>'
