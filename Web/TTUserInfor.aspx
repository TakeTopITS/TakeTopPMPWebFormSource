                                                ...
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="60%" class="ItemAlignLeft"><strong>
                        ...
                        <div id="popwindow_content12" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" colspan="2"  >
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button ID="BT_DeletePhoto" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeletePhoto_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu %>" />
                                                &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" colspan="2" class="ItemAlignLeft">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                &nbsp; 
                                                <asp:Button ID="BT_DeleteSignPicture" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeleteSignPicture_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu %>" />
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" colspan="2"  >
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button ID="BT_DeleteSignPicture2" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeleteSignPicture2_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu %>" />
                                                &nbsp;
                                    ...
                                    <td class="formItemBgStyleForAlignLeft" colspan="2"  >
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                &nbsp;
                                                <asp:Button ID="BT_DeleteSignPicture3" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeleteSignPicture3_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu %>" />
