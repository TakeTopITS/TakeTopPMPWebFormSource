    ...
    protected void DL_ChangeVersionType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (DL_VersionID.Items.Count > 0)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXGSBXMZTDZTZBWTGBNGBJHBBLXJC") + "')", true);
            }
        }
    }
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                DLC_BaseEndDate.Text = DateTime.Parse(ds.Tables[0].Rows[0][1].ToString().Trim()).AddDays(1).ToString("yyyy-MM-dd");
            }
            catch
            {
