...
public partial class TTItemBOMView : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            LB_ProductName.Text = LanguageHandle.GetWord("ChanPing") + LanguageHandle.GetWord("MingCheng") + ":" + ShareClass.GetItemName(strRelatedType) + "                 " + LanguageHandle.GetWord("ChanPinBianHao") + ":" + strRelatedType;
