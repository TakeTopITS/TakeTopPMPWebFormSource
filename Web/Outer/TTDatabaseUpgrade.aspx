...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../js/AllHandlerForDialog.js"></script>
    ...
    <center>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div id="AboveDiv" class="ItemAlignLeft">
...
<script type="text/javascript" language="javascript">
    ...
    var cssDirectory = '<%=Session["CssDirectory"] %>'; var oLink = document.getElementById('mainCss'); oLink.href = '../css/' + cssDirectory + '/' + 'bluelightmain.css';
