...
public partial class TTMakeProjectBudgetForAll : System.Web.UI.Page
{
    ...
    protected void AddBudget()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZBaoCunShiBaiYuSuanZongLiangB")+"')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','true') ", true);
            return;
        }
                    ...
                    for (int i = 0; i < dr.Length; i++)
                    {
                        if (dr[i][LanguageHandle.GetWord("XuHao")].ToString().Trim() != "")
                        {
                            ...
                            try
                            {
                                ...
                                string strXiangMuFenBu = dr[i]["ProjectDivision"].ToString().Trim();
                                string strXiangMuFenXiang = dr[i]["ProjectSubitem"].ToString().Trim();
                                string strXiangMuFenLei = dr[i]["ProjectCategory"].ToString().Trim();
                                string strMingChengGuiGe = dr[i]["ProjectNameOrSpecification"].ToString().Trim();
                                string strAccountName = dr[i]["AccountingSubject"].ToString().Trim();
                                string strDanWei = dr[i][LanguageHandle.GetWord("JiLiangChanWei")].ToString().Trim();

                                decimal deYuSuanDanJia = decimal.Parse(dr[i]["UnitOfMeasurement"].ToString().Trim());
                                decimal deYuSuanZongLiang = decimal.Parse(dr[i]["BudgetTotalQuantity"].ToString().Trim());
                                decimal deYuSuanZongE = decimal.Parse(dr[i]["BudgetTotalAmount"].ToString().Trim());

                                string strBeiZhu = dr[i]["Memo"].ToString().Trim();
        ...
        try
        {
            ...
            else
            {
                ...
                else
                {
                    for (int i = 0; i < dr.Length; i++)
                    {
                        string strXuHao = dr[i]["ID"].ToString().Trim();
                        if (strXuHao == "")
                        {
                        ...
                        string strDanWei = dr[i]["Unit"].ToString().Trim();
