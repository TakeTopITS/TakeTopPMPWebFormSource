                                    ...
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                <table width="450" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="29">
                                                            ...
                                                            <table style="width: 98%;">
                                                                <tr>
                                                                    <td style="background: #f0f0f0; text-align: left; width: 55%; height: 25px;" colspan="2">
                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ChaXunFanWeiShi%>"></asp:Label>:<asp:Label ID="LB_QueryScope" runat="server"  Font-Names="Arial,ËÎÌå"
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 15%;" class="tdLeft">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 15%;" class="ItemAlignLeft" class="tdLeft">
