                    ...
                    <table>
                        <tr>
                            <td style="padding-left: 20px;">
                                <table>
                                    <tr>
                                        <td class="ItemAlignLeft" width="40px">
                            ...
                            <tr>
                                ...
                                <td id="id_WFMain" width="300" style="padding: 5px 5px 5px 5px; vertical-align: top;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td class="ItemAlignLeft" width="100%" style="padding: 20px 1px 1px 1px;" onmousemove="document.getElementById('DL_WorkFlow').style.width = '500px'" onmouseout="document.getElementById('DL_WorkFlow').style.width = '300px'">
