    ...
    protected void BT_TransferProject_Click(object sender, EventArgs e)
    {
        ...
        if (strNewPMCode != "")
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMZSCG") + "')", true);
            }
            catch
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZSSBJC") + "')", true);
            }
        }
        else
        {
