...
public partial class TTAPPKPIManagement : System.Web.UI.Page
{
    string strUserCode;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", strUserCode);  //Label1.Text = ShareClass.GetPageTitle(this.GetType().BaseType.Name + ".aspx"); bool blVisible = TakeTopSecurity.TakeTopLicense.GetAuthobility(this.GetType().BaseType.Name + ".aspx", "绩效考核", strUserCode);
        if (blVisible == false)
        {
