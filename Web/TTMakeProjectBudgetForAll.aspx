                ...
                <ContentTemplate>
                    <table id="AboveTable" cellpadding="0" width="200%" cellspacing="0" class="bian">
                        <tr>
                            <td height="31" class="page_topbj" style="border-right: solid 1px #D8D8D8;">
                                <table width="95%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                    <tr>
                        ...
                        <tr>
                            <td class="ItemAlignLeft" style="padding: 5px 5px 5px 5px; vertical-align: top;">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div>
                                                        ...
                                                        :<a href="Template/ProjectComprehensiveBudgetImportTemplate.xls"><asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,XiangMuZengGeYuSuanDaoRuBiao%>"></asp:Label>
                                                        </a>
                                                        <div id="ProgressBar">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popDetailWindow" name="noConfirm"
                        ...
                        <div id="popwindow_content2" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                <tr>
                                    <td class="ItemAlignLeft" style="font-weight: bold; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')"><strong>&nbsp;&nbsp;<asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ChengYuan%>"></asp:Label>
