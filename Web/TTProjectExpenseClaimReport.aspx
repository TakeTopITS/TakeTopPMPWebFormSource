                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td width="200px" valign="top" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0; text-align: left;">
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td colspan="3" style="width: 100%;">
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td class="ItemAlignLeft" style="padding: 0px 5px 0 5px; font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                                    <table style="width: 100%">
                                                                        <tr>
