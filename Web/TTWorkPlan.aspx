            ...
            <ContentTemplate>
                <div id="AboveDiv">
                    <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                        <tr>
                            <td class="ItemAlignLeft" height="31" class="page_topbj" style="padding-top: 1px;">
                                <table width="950" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="ItemAlignLeft" style="padding-top: 5px;" background="ImagesSkin/main_top_bj.jpg">
                                        ...
                                        <td style="padding-top: 6px;">
                                            <asp:Button ID="BT_CopyVersion" runat="server" CssClass="inpu" OnClick="BT_CopyVersion_Click" OnClientClick="return confirmContinue(getCopyProjectPlanMsgByLangCode(), this, event)"
                            ...
                            <td>
                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                    <tr>
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:Label ID="LB_ChangVersionTypeMsg" runat="server" ForeColor="Red"></asp:Label>
                                                        <hr />
                                                        ...
                                                        <table class="FullBorderTable" style="width: 100%">
                                                            ...
                                                            <tr style="display: none;">
                                                                <td style="width: 100%; height: 25px; text-align: left;">
                                                                    ...
                                                                    <asp:Label ID="LB_DocTypeID" runat="server" Visible="false"></asp:Label>
                                                                    <asp:TextBox ID="TB_DocType" runat="server" Width="65px" Text="ProjectPlan"></asp:TextBox>
                                                                    ...
                                                                    <asp:Label ID="LB_Author" runat="server" Text="<%$ Resources:lang,Author%>" /><asp:TextBox
                                                                        ID="TB_Author" runat="server"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                    ...
                                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <div>
                                                                                ...
                                                                                <asp:Button ID="BtnUP" runat="server" CssClass="inpuLong" OnClientClick="javascript: displayIMWaiting();" OnClick="BtnUP_Click" Text="<%$ Resources:lang,Import%>" />
                                        ...
                                        <td style="width: 100%;" class="ItemAlignLeft" valign="top">
                                            <table style="width: 100%;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                ...
                                                <tr>
                                                    <td class="formItemBgStyleForAlignLeft" colspan="4">
                                                        <table width="100%" style="display: block; pointer-events: none; opacity: 0.6;">
                                                            <tr>
                        ...
                        0 0.00
                               ...
                               0 0.00
                                                            ...
                                                            <tr>
                                                                <td class="formItemBgStyleForAlignLeft">
                                                                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:lang,JiaoFuJingDu%>" />
                                                                </td>
                                                                <td class="formItemBgStyleForAlignLeft">
                       ...
                       0 0.00
                                                                    ...
                                                                    <asp:DropDownList ID="DL_UnitName" runat="server" DataTextField="UnitName" DataValueField="UnitName" CssClass="DDList" Visible="false">
                                                                    </asp:DropDownList>
