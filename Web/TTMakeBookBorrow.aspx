                                                                    ...
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                ...
                                                                                <%--   <td class="ItemAlignLeft" width="8%"><strong><asp:Label runat="server" Text="<%$ Resources:lang,GuiHuanRiQi%>"></asp:Label></strong></td>--%>
                                                                                ...
                                                                                <%--  <td class="ItemAlignLeft" width="8%"><strong><asp:Label runat="server" Text="<%$ Resources:lang,JieYueZhengJian%>"></asp:Label></strong></td>--%>
                                                                                <td class="ItemAlignLeft" width="8%"><strong>
                                                                                    <asp:Label ID="Label22" runat="server" Text="<%$ Resources:lang,ZhuangTai%>"></asp:Label></strong></td>
                                                                                <%-- <td class="ItemAlignLeft" width="2%"><strong><asp:Label runat="server" Text="<%$ Resources:lang,BeiZhu%>"></asp:Label></strong></td>--%>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                </tr>
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            <div id="DivID" style="width: 100%; height: 480px; overflow: auto;">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td class="ItemAlignLeft" style="width: 250px;" valign="top">
