...
public partial class TTMakeProjectForEngineeringIndustry : System.Web.UI.Page
{
    ...
    protected void AddProject()
    {
        ...
        if (!string.IsNullOrEmpty(DDL_ProjectAttribute.SelectedValue) && !string.IsNullOrEmpty(DDL_ProjectNature.SelectedValue))
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("LDZGCLYBNWK") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMMCBYXWKBC") + "')", true);
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMMCBNBHFFZF") + "')", true);
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMMCBNCG30GZF") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMJLBYXWKBC") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZKGRBYXWKBC") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZWGRBYXWKBC") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGYSBYXWKBC") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGYSBXWXSHZZS") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZGYSBYXWKBC") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZGYSBXWXSHZZS") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJSDWBYXWKBC") + "')", true);
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJSDWBNCG20GZF") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJLDWBYXWKBC") + "')", true);
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJLDWBNCG20GZF") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMMSBNBHFFZF") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMMSBNCG2000GZF") + "')", true);
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZDWLXBYXWKBC") + "')", true);
    ...
    protected void ProjectWZDetailData(string strProjectID, string strGold)
    {
        ...
        //if (!ShareClass.CheckIsNumber(strForCost))
        //{
        //    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('"+LanguageHandle.GetWord("ZZJGGSBXWXSHZZS")+"')", true);
        //    return;
        //}
        if (string.IsNullOrEmpty(strSelfCost))
        {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZWGRBXDYKGR") + "')", true);
        ...
        if (strGold == "1")//增加
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXMMCZFXG") + "')", true);
    ...
    protected void LoadProject(string strUserCode)
    {
        ...
        strHQL = "from Project as project where  project.UserCode = " + "'" + strUserCode + "'" + " and project.Status not in ('Archived','Deleted') order by project.ProjectID DESC";
        ProjectBLL projectBLL = new ProjectBLL();
        lst = projectBLL.GetAllProjects(strHQL);
        DataGrid2.DataSource = lst;
        DataGrid2.DataBind();
