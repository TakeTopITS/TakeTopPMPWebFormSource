                                ...
                                <td valign="top">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" valign="top" style="width: 40%">
                                                <table class="formBgStyle" style="width: 98%; text-align: left;" cellpadding="3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="ItemAlignLeft" rowspan="6" class="formItemBgStyleForAlignLeft" colspan="2">
                                                    ...
                                                    <tr>
                                                        <td class="formItemBgStyleForAlignLeft" colspan="4" style="text-align: center">
                                                            <asp:Button ID="BT_New" runat="server" CssClass="inpu" Text="<%$ Resources:lang,XinJian%>" OnClick="BT_New_Click" />&nbsp;&nbsp;&nbsp;
                                                                    ...
                                                                    <asp:Button ID="BT_Delete" runat="server" CssClass="inpu" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" Enabled="false" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        ...
                                                                        <asp:Label ID="Label26" runat="server" Text="<%$ Resources:lang,ShuJuXinZengMuBanGeShi%>"></asp:Label>:<a href="Template/UserInformationImportAddTemplate.xls"><asp:Label ID="Label27" runat="server" Text="<%$ Resources:lang,ChengYuanShuJuDaoRuXinZengMoBan%>"></asp:Label></a>
                                                                        <div id="ProgressBar">
