                                                                                ...
                                                                                <td style="text-align: left">
                                                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                                                        ...
                                                                                        <ContentTemplate>
                                                                                            ...
                                                                                            <asp:Button ID="BT_DeleteXSNFile" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeleteXSNFile_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
                                                                                        </ContentTemplate>
                                                                                    </asp:UpdatePanel>
                                                                                </td>
                                                                                <td style="padding-left: 10px; text-align: left">
