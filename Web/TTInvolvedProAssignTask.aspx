                                    ...
                                    <td colspan="3"  class="formItemBgStyleForAlignLeft">
                                        ...
                                        <asp:Button ID="BT_UpdateAssign" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_UpdateAssign_Click"
                                            Text="<%$ Resources:lang,BaoCun %>" />&#160;<asp:Button ID="BT_DeleteAssign" runat="server" CssClass="inpu" Enabled="False"
                                                OnClick="BT_DeleteAssign_Click" Text="<%$ Resources:lang,Delete %>" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />&#160;<asp:Button ID="BT_Assign" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_Assign_Click"
