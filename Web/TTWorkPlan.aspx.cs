...
public partial class TTWorkPlan : System.Web.UI.Page
{
    ...
    {
        // Session 超时或应用池重启后 Session 为空，重定向回登录页
        if (Session["UserCode"] == null || Session["LangCode"] == null)
        {
        ...
        if (Page.IsPostBack != true)
        {
            ...
            if (DL_VersionID.Items.Count > 0)
            {
                ...
                //插入项目计划文档类别
                ShareClass.InsertDocType("ProjectPlan");
    ...
    protected void BT_StartUp_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZQDCG") + "')", true);
        }
        catch
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZQDSBQJC") + "')", true);
        }
    ...
    protected void BT_CopyVersion_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click222", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZFZSBJC") + "')", true);
            }
        }
        catch (Exception err)
        {
        ...
        if (DL_VersionID.Items.Count > 0)
        {
            ...
            if (strStatusValue == "Passed" | strSystemVersionType == "SAAS")
            {
                if (strVerType == "Baseline" & strUserCode != strProjectCreatorCode)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGBZBBJHLXZNYLXZGBJC") + "')", true);
                    return;
                }
                ...
                if (strType == "Baseline" & strUserCode != strProjectCreatorCode)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGBZBBJHLXZNYLXZZDJC") + "')", true);
                    return;
                }
                else
                {
                ...
                try
                {
                    ...
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click1", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZBBLXYGG") + "')", true);
                }
                catch (Exception err)
                {
                    LogClass.WriteLogFile("Error page: " + Request.Url.ToString() + "\n" + err.Message.ToString() + "\n" + err.StackTrace);
            ...
            {
                DL_ChangeVersionType.SelectedValue = strVerType;
                LB_ChangVersionTypeMsg.Text = LanguageHandle.GetWord("ZZXGSBXMZTDZTZBWTGBNGBJHBBLXJC");
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click2", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXGSBXMZTDZTZBWTGBNGBJHBBLXJC") + "')", true);
            }
        }
    }
    ...
    protected void BtnUP_Click(object sender, EventArgs e)
    {
        if (AttachFile.HasFile)
        {
            ...
            string strDocTypeID = ShareClass.getDocTypeIDByType("ProjectPlan").ToString();
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCWCWJBSMSPROJECTGSMPPWJBNSC") + "')", true);
                return;
            }
            ...
            else
            {
                ...
                document.DocTypeID = ShareClass.getDocTypeIDByType("ProjectPlan");
                document.DocType = "ProjectPlan";
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZYSCDMSPROJECTJHWJ") + "')", true);
        }
    }
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DLC_EndDate.Text = workPlan.End_Date.AddDays(-1).ToString("yyyy-MM-dd");

            TB_PlanBudget.Amount = workPlan.Budget;


            NB_PlanWorkhour.Amount = GetWorkDays(strPlanID);
            ...
            try
            {
                ...
                DLC_BaseEndDate.Text = DateTime.Parse(ds.Tables[0].Rows[0][1].ToString().Trim()).AddDays(0).ToString("yyyy-MM-dd");
            }
            catch
            {
    ...
    protected void BT_New_Click(object sender, EventArgs e)
    {
        ...
        strBaseEndDate = DateTime.Parse(DLC_BaseEndDate.Text).AddDays(1).ToString("yyyy-MM-dd");
        ...
        try
        {
            ...
            if (strLeaderCode == "")
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGJHFZRBNWKQJC") + "')", true);
                return;
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCXMCBBDXMJHLCJHIDBCZXGSBJC") + "')", true);
            return;
        }
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJHHNRKSRJSRZYBNWKJC") + "')", true);
        }
        else
        {
            ...
            workPlan.End_Date = DateTime.Parse(strEndDate).AddDays(1);
            ...
            if (workPlan.Type.Trim() == "Milestone")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZLXWLCBDJHKSSJBXHJSSJXTXGSBJC") + "')", true);
                    return;
                }
            }
    ...
    protected void BT_Delete_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCJHCZZJHHZWLYJHDJHBNSCJC") + "')", true);
        }
    }
    ...
    protected void DL_LockStatus_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (strPlanID != "")
        {
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJHSZTGGCG") + "')", true);
            }
            catch
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJHSZTGGCCJC") + "')", true);
            }
        }
        else
        {
    ...
    public int GetWorkDays(string strPlanID)
    {
        string strHQL;
        strHQL = "Select duration From T_ImplePlan Where ID = " + strPlanID;
        DataSet ds = ShareClass.GetDataSetFromSql(strHQL, "T_ImplePlan");
        if (ds.Tables[0].Rows.Count > 0)
        {
