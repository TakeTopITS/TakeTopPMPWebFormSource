...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            // 为按钮添加触摸反馈
            $('.popup-button, .mobile-button, .inpu').addClass('touch-feedback');
        });
                    ...
                    <div class="mobile-content">
                        ...
                        <div class="mobile-section">
                            <div class="equal-buttons">
                                <asp:Button ID="BT_Accept" runat="server" CssClass="inpu mobile-button" OnClick="BT_Accept_Click" Text="<%$ Resources:lang,ShouLi%>" />
                                <asp:Button ID="BT_Exit" runat="server" CssClass="inpu mobile-button" OnClick="BT_Exit_Click" Text="<%$ Resources:lang,TuiChuShouLi%>" />
                                <asp:Button ID="BT_Finish" runat="server" CssClass="inpu mobile-button" OnClick="BT_Finish_Click" Text="<%$ Resources:lang,WanCheng%>" />
                                <asp:Button ID="BT_DeleteQuestion" runat="server" CssClass="inpu mobile-button yellow" Visible="false" Text="<%$ Resources:lang,ShanChu%>" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" OnClick="BT_DeleteQuestion_Click" />
                            </div>
                        ...
                        <div class="mobile-section">
                            ...
                            <div class="equal-buttons" style="margin-top: 15px;">
                                <asp:Button ID="BT_TransferOperator" runat="server" CssClass="inpu mobile-button" Text="<%$ Resources:lang,ZhiDingWeiShouLiRen%>" OnClick="BT_TransferOperator_Click" />
                            </div>
                        </div>
                        ...
                        <div class="mobile-section">
                            ...
                            <asp:DataList ID="DataList3" runat="server" CellPadding="0" ForeColor="#333333" OnItemCommand="DataList3_ItemCommand" Height="1px" Width="100%">
                                <ItemTemplate>
                                    <div class="data-item">
                                        <div class="data-row">
                                            <div class="data-value">
                                                <asp:Button ID="BT_ID" runat="server" CssClass="inpu" Text='<%#DataBinder.Eval(Container.DataItem, "ID") %>'  CommandName="Update" Style="width: auto; padding: 0 15px;" />
                                            </div>
                                        </div>
                        ...
                        <div style="display: none;">
                            ...
                            <div class="equal-buttons">
                                <asp:HyperLink ID="HL_RelatedDoc" runat="server" NavigateUrl="TTCollaborationRelatedDoc.aspx" CssClass="inpu mobile-button">
                                    <asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,XiangGuanWenJian%>"></asp:Label>
                                </asp:HyperLink>

                                <asp:HyperLink ID="HL_Expense" runat="server" NavigateUrl="TTProExpense.aspx" CssClass="inpu mobile-button">
                                    ---&gt;<asp:Label ID="Label38" runat="server" Text="<%$ Resources:lang,FeiYongMingXiYuBaoXiao%>"></asp:Label>
                                </asp:HyperLink>

                                <asp:HyperLink ID="HL_ResoveResultReview" runat="server" NavigateUrl="TTCustomerQuestionResultReviewWF.aspx" CssClass="inpu mobile-button">
                                    ---&gt;<asp:Label ID="Label39" runat="server" Text="<%$ Resources:lang,TiJiaoPingShen%>"></asp:Label>
                                </asp:HyperLink>

                                <asp:HyperLink ID="HL_QuestionToCustomer" runat="server" CssClass="inpu mobile-button">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popDetailWindow" name="fixedDiv"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table style="width: 100%; padding: 5px 0px 0px 5px" cellpadding="3" cellspacing="0" >
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_HandleWay" runat="server" Width="60%" CssClass="mobile-input"></asp:TextBox>
                                        <asp:DropDownList ID="DL_HandleWay" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DL_ContactWay_SelectedIndexChanged" CssClass="mobile-dropdown">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:DropDownList ID="DL_HandleStatus" runat="server" Width="99%" CssClass="mobile-dropdown">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <NickLee:NumberBox ID="NB_UsedTime" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" Width="60%" CssClass="mobile-input" Amount="1">1.00</NickLee:NumberBox>
                                        <asp:DropDownList ID="DL_TimeUnit" runat="server" CssClass="mobile-dropdown">
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_CustomerAcceptor" runat="server" Width="60%" CssClass="mobile-input"></asp:TextBox>
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="TB_AcceptorContactWay" runat="server" Width="90%" CssClass="mobile-input"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" Visible="false">
                                            <ContentTemplate>
                                                <div style="margin-top: 10px;">
                                                    <Upload:InputFile ID="AttachFile" runat="server" Width="180px" CssClass="mobile-input" />
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:TextBox ID="DLC_NextServiceTime" ReadOnly="false" runat="server" Width="99%" CssClass="date-input"></asp:TextBox>
                                ...
                                <tr>
                                    <td class="formItemBgStyleForAlignLeft">
                                        <NickLee:NumberBox ID="NB_PreDays" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" Precision="0" Width="90%" CssClass="mobile-input">0</NickLee:NumberBox>
                                        <asp:Label ID="Label15" runat="server" Text="<%$ Resources:lang,Tian%>"></asp:Label>
                                    </td>
                                </tr>
                                <tr style="display: none;">
                                    <td class="formItemBgStyleForAlignLeft">
                                        <asp:Button ID="BT_Add" runat="server" CssClass="inpu mobile-button" OnClick="BT_Add_Click" Text="<%$ Resources:lang,XinJian%>" />
                                        <asp:Button ID="BT_Update" runat="server" CssClass="inpu mobile-button" Enabled="false" OnClick="BT_Update_Click" Text="<%$ Resources:lang,BaoCun%>" />
                                        <asp:Button ID="BT_Delete" runat="server" CssClass="inpu mobile-button" Enabled="false" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
                                    </td>
                                </tr>
                            </table>
                        </div>
