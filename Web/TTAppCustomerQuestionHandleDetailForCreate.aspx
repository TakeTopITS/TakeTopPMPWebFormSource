                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    Text="<%$ Resources:lang,TuiChuShouLi%>" />
                                                                        ...
                                                                        <td class="ItemAlignLeft">
                                                                          ...
                                                                          <asp:Button ID="BT_DeleteQuestion" runat="server" CssClass="inpu" Visible ="false"  Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_DeleteQuestion_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                     </td>
                                                                 </tr>
                                                            </table>
                                                            </td>
