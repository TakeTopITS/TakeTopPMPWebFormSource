...
HE_Operation.Language = Session["LangCode"].ToString();
        ...
        if (strGoodsSN == null | strGoodsSN == "")
        {
            ...
            //ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXLHBNWKQJC") + "')", true);
            return;
        }
    ...
    protected void AddTask()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZRWKSRJSRZXRBNWKJC") + "')", true);
