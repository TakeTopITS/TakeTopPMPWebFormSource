<%@ WebHandler Language="C#" Class="UpdateWorkflowStepNextSortNumber" %>
...
public class UpdateWorkflowStepNextSortNumber : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            strHQL = string.Format(@"Update t_workflowtstep Set NextSortNumber = {0} Where GUID = '{1}'", strSortNumber, strGUID);
