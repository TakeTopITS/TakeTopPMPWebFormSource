                    ...
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; padding: 5px 5px 5px 5px;" valign="top" class="ItemAlignLeft">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                        <tr>
                                            <td width="7">
                                                <img src="ImagesSkin/main_n_l.jpg" width="7" height="26" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Button ID="BT_DeleteClaimDetail" runat="server" CssClass="tt-sms-btn" Text="<%$ Resources:lang,Delete%>" />
                                                                </ItemTemplate>
                        ...
                        <div id="popwindow_content1" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="ItemAlignLeft" style="height: 22px; text-align: left;"><strong>
                                ...
                                <tr>
                                    ...
                                    <td class="ItemAlignLeft" style="width: 100%; height: 22px; text-align: left;">
                                                ...
                                                <td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="55%" class="ItemAlignLeft"><strong>
                                        ...
                                        <asp:DataGrid ID="DataGrid4" runat="server" AutoGenerateColumns="False" Height="1px"
                                            ...
                                            <ItemStyle CssClass="itemStyle" BackColor="#f5f7fa" />
