        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="PMBTab-layout">
                    ...
                    <label class="PMBTab-nav PMBTab-bg-undertake" for="PMBTab-home" onclick="JavaScript:parent.detailPMFrame.location.href='TTUndertakeProject.aspx'">
                    ...
                    <label class="PMBTab-nav PMBTab-bg-involved" for="PMBTab-about" onclick="JavaScript:parent.detailPMFrame.location.href='TTInvolvedProject.aspx'">
                        <span class="PMBTab-nav-content">
                            <!-- 使用团队图标 -->
