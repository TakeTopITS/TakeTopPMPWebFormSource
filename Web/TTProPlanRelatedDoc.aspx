                            ...
                            <td style="text-align: left; padding-left: 10px; padding-top: 10px;">
                                <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0"
                                    ...
                                    <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="文档上传">
                                        <HeaderTemplate>
                                            <asp:Label ID="Label37222" runat="server" Text="<%$ Resources:lang,ShangChuanWenDang %>"></asp:Label>
                                        </HeaderTemplate>
                                        <ContentTemplate>
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td class="ItemAlignLeft" width="2%">
                                                                                <strong>
                                                    ...
                                                    <td>
                                                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                                            ...
                                                            <asp:View ID="View2" runat="server">
                                                                <table style="width: 98%" class="ItemAlignLeft" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                    <tr>
                                                                ...
                                                                <table width="98%" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td class="ItemAlignLeft" style="padding-top: 10px;">
                                                                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:lang,DuiYingPingShenJiLu %>"></asp:Label>:
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <table style="width: 100%" class="ItemAlignLeft">
                                                                                <tr>
                                                                                    <td>
                                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                                            <tr>
