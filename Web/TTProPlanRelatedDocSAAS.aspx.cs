...
public partial class TTProPlanRelatedDocSAAS : System.Web.UI.Page
{
    ...
    protected void DataGrid1_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            string strUploadMan = e.Item.Cells[7].Text.Trim();
            ...
            if (e.CommandName == "Delete")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZFFCZNBNSCBRSCDWJ + "')", true);
                }
            }
    ...
    protected void BtnUP_Click(object sender, EventArgs e)
    {
        if (AttachFile.HasFile)
        {
            ...
            if (strDocTypeID == "")
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZJGWDLXBNWKJC + "')", true);
                return;
            }
            string strDocType = GetDocTypeName(strDocTypeID);
            string strDepartCode = GetDepartCode(strUserCode);
            ...
            if (strSystemVersionType == "SAAS" || strProductType.IndexOf("SAAS") > -1)
            {
                ...
                //    {
                //        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZJGBNSCDYSZDWJ + "')", true);
                //        return;
                //    }
            }
    ...
    protected void BT_SubmitApply_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZWJPSSSCDGZLGLYMJHCGZLS + "')", true);
            }
            else
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZGZLFQCG + "')", true);
            }
        }
        catch
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + Resources.lang.ZZWJPSSSB + "')", true);
        }
    }
