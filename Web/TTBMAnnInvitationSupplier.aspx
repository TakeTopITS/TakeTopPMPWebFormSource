                                ...
                                <td height="31" class="page_topbj" colspan="2">
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" width="100px">
                                ...
                                <td class="ItemAlignLeft" style="padding-top: 5px; width: 50%">
                                    <table cellpadding="2" cellspacing="0" class="formBgStyle" width="98%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="ItemAlignLeft" class="auto-style5" colspan="3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="formItemBgStyleForAlignLeft" colspan="3" style="height: 30px">
                                                ...
                                                <asp:Button ID="BT_Delete" runat="server" CssClass="inpu" Visible="False" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
