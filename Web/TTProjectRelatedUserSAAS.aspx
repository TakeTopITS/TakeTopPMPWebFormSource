                            ...
                            <tr>
                                <td height="31" class="page_topbj">
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="245" class="ItemAlignLeft">
                                    ...
                                    <td class="formItemBgStyleForAlignLeft">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:TextBox ID="TB_RelatedUserCode" runat="server" Style="text-align: left"></asp:TextBox>
                                                </td>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:Label ID="LB_tbUserName" runat="server" Text="<%$ Resources:lang,UserName %>" />:
                                                </td>
                                                <td class="formItemBgStyleForAlignLeft">
                                                    <asp:TextBox ID="TB_RelatedUserName" runat="server"></asp:TextBox>
                                                </td>
