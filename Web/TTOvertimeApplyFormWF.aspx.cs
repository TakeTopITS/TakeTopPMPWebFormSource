...
public partial class TTOvertimeApplyFormWF : System.Web.UI.Page
{
    ...
    protected void AddOvertime()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJLXWBXBXBZYJLXKJC") + "')", true);
            RB_OvertimeType.Focus();
            return;
        }
        if (DLC_StartTime.Text.Trim() == "" || DLC_EndTime.Text.Trim() == "")
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZKSSJYJSSJDBNWKJC") + "')", true);
            DLC_StartTime.Focus();
            DLC_EndTime.Focus();
        ...
        if (DLC_StartTime.Text.Trim() != DLC_EndTime.Text.Trim())
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZJingGaoKaiShiShiJianHeJieShu")+"')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','false') ", true);
            return;
        }
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZKSSJBNDYJSSJJC") + "')", true);
            DLC_StartTime.Focus();
            DLC_EndTime.Focus();
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZJingGaoBuNengShenQingKuaNian")+"')", true);
            DLC_StartTime.Focus();
            DLC_EndTime.Focus();
    ...
    protected string SubmitApply()
    {
        ...
        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJBSCCG") + "')", true);
        //}
        //catch
        //{
        //    strWLID = "0";

        //    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZJSSCSBKNSMCZSGDJC") + "')", true);
        //}
