                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="ItemAlignLeft">
                                        <table width="205" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                            <tr>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" width="220px" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0" class="ItemAlignLeft">
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="width: 100%;" class="bian" cellpadding="4" cellspacing="0" >
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,RenLiYuSuan%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right;">
                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,GongShiYuSuan%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right">
                                                                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,JieShuRiQi%>"></asp:Label>:
                                                                    </td>
                                                                    <td style="text-align: left">
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="width: 100%;" class="bian" cellpadding="4" cellspacing="0" >
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 30%; height: 20px;" class="ItemAlignLeft">
                                                                        <%#DataBinder .Eval (Container .DataItem ,"UserName") %>
                                                                    </td>
