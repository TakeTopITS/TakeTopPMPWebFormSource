                        ...
                        <tr>
                            <td>
                                ...
                                <DayPilot:DayPilotMenu ID="DayPilotMenu1" runat="server" ShowMenuTitle="true">
                                    ...
                                    <%--  <DayPilot:MenuItem Text="Send" Action="JavaScript" JavaScript="showAlertAtMouse('Sending event (id ' + e.value() +')');"></DayPilot:MenuItem>--%>
                                    ...
                                    <%--    <DayPilot:MenuItem Action="NavigateUrl" NavigateUrl="javascript:showAlertAtMouse('Going somewhere else (id {0})');" Text="NavigateUrl test" />
                                    ...
                                    <DayPilot:MenuItem Text="Sub menu">
                                        <DayPilot:MenuItem Action="JavaScript" JavaScript="showAlertAtMouse('test');" Text="Test" />
                                    </DayPilot:MenuItem>--%>
                                ...
                                <DayPilot:DayPilotMenu ID="DayPilotMenuSelection" runat="server" ClientObjectName="cmSelection">
                                    ...
                                    <%--    <DayPilot:MenuItem Text="-"></DayPilot:MenuItem>--%>
                                    <DayPilot:MenuItem Action="JavaScript" JavaScript="if (!copied) { showAlertAtMouse('You need to copy an event first.'); return; } dpc1.commandCallBack('paste', {id:copied, start: e.start});" Text="<%$ Resources:lang,NianTie%>" />
                                    <%--  <DayPilot:MenuItem Text="-"></DayPilot:MenuItem>
