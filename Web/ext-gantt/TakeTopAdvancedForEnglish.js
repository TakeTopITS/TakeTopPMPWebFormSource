...
App.Gantt = {
    ...
    createGantt: function () {
        ...
        g.on({
            ...
            Ext.Msg.showAlertAtMouse('Hey', Ext.String.format('You clicked the link between "{0}" and "{1}"', from, to));
            },*/
            timeheaderdblclick: function (col, start, end) {
                Ext.Msg.showAlertAtMouse('Hey', 'You click header cell : ' + Ext.Date.format(start, 'Y-m-d') + ' - ' + Ext.Date.format(end, 'Y-m-d'));
            },
            scope: this
        });
