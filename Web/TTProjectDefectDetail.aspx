                                    ...
                                    <tr>
                                        <td style="vertical-align: top;" class="ItemAlignLeft">
                                            <table style="width: 98%;">
                                                ...
                                                <tr>
                                                    <td colspan="2" valign="top" class="ItemAlignLeft" style="padding-top: 5px">
                                                                                                    ...
                                                                                                    <td colspan="3" class="formItemBgStyleForAlignLeft">
                                                                                                        <asp:Button ID="BT_UpdateAssign" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_UpdateAssign_Click"
                                                                                                            Text="修  改" />&nbsp;<asp:Button ID="BT_DeleteAssign" runat="server" CssClass="inpu"
                                                                                                                Enabled="False" OnClick="BT_DeleteAssign_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu %>" />&#160;&#160;<asp:Button
