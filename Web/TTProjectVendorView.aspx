                                            ...
                                            <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False" Height="1px" ShowHeader="true"
                                                ...
                                                <Columns>
                                                    <asp:TemplateColumn HeaderText="Code">
                                                        <ItemTemplate>
                                                            <asp:Button ID="BT_VendorCode" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"VendorCode") %>' CssClass="tt-sms-btn" />
                                                        </ItemTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <table style="width: 100%;" class="bian" cellpadding="4" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 100px" class="ItemAlignLeft">
