...
public partial class TTWorkFlowCommonDataView : System.Web.UI.Page
{
    ...
    protected void DataList6_ItemCommand(object sender, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "OpenAccount")
        {
            ...
            if (strStatus != "Recorded")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZZhiYouLiuChengZhuangTaiWeiTo")+"')", true);
                }
            }
            else
            {
    ...
    protected void DataList35_ItemCommand(object sender, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "SaveImpact")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZZhiYouLiuChengZhuangTaiBuWei")+"')", true);
            }
        }
