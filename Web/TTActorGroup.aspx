                                    ...
                                    <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="text-align: right; padding-top: 5px;">
                                                <asp:Label ID="Label20" runat="server" Text="<%$ Resources:lang,YuYan%>"></asp:Label>:</td>
                                        ...
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:lang,MingChengBenYu%>"></asp:Label>
                                                            : </td>
                                                        <td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                                <tr>
                                    <td style="border-right: solid 1px #D8D8D8; padding: 5px 0px 0px 5px"
                                        valign="top" class="ItemAlignLeft" colspan="3"></td>
                                </tr>
                                <tr>
