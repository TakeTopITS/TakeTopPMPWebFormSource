...
public partial class TTAPPGetUserPositionForIOSAndroid : System.Web.UI.Page
{
    ...
    protected void BT_SavePosition_Click(object sender, EventArgs e)
    {
        ...
        ClientScript.RegisterStartupScript(this.GetType(), "5555", "<script>showAlertAtMouse('OK');</script>");
    }
    ...
    protected void BT_Attendance_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "333", "<script>showAlertAtMouse('" + LanguageHandle.GetWord("ZZQXZBCLX") + "');</script>");
                return;
            }
        }
        catch (Exception err)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "222", "<script>showAlertAtMouse('" + err.Message.ToString() + "');</script>");
        }

        ClientScript.RegisterStartupScript(this.GetType(), "111", "<script>showAlertAtMouse('OK');</script>");
    }
    ...
    protected void CreateUserAttendanceRule(string strUserCode, string strLongitude, string strLatitude)
    {
        ...
        {
            //LogClass.WriteLogFile("Error page: " + "\n" + err.Message.ToString() + "\n" + err.StackTrace);
            //ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('" + LanguageHandle.GetWord("ZZSCHENGSBQJC") + "');</script>");
        }
    }
