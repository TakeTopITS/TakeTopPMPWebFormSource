                                ...
                                <table width="96%" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="ItemAlignLeft">
                                            <table width="1780" border="0" class="ItemAlignLeft" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="29">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <div>
                                                                    ...
                                                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:lang,ShuJuXingZhengMoBanGeShi%>"></asp:Label>:<a href="Template/ItemImportTemplate.xls"><asp:Label ID="Label12" runat="server" Text="<%$ Resources:lang,ShuJuDaoRuMuBan%>"></asp:Label></a>
                                            ...
                                            <table style="width: 680px;" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <td class="formItemBgStyleForAlignLeft" colspan="2">
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;<asp:Button ID="BT_DeletePhoto" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_DeletePhoto_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleForAlignLeft" style="text-align: left;">
                                                        ...
                                                        <asp:DropDownList ID="DL_PackingType" runat="server" DataTextField="Type"
                                                            DataValueField="Type" Width="50%" AutoPostBack="True" OnSelectedIndexChanged="DL_PackingType_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formItemBgStyleForAlignLeft" colspan="3">
                                                        ...
                                                        &nbsp;
                                                        <asp:Button ID="BT_Delete" runat="server" CssClass="inpu" Enabled="False" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" OnClick="BT_Delete_Click" Text="<%$ Resources:lang,ShanChu%>" />
                                                    </td>
                                                </tr>
                                                <tr>
