                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center">
                                    <asp:TextBox ID="TB_UserCode" runat="server" placeholder="<%$ Resources:lang,QingShuRuNiDeDaiMa%>" onFocus="javascript:if(this.value =='«Î ‰»Îƒ„µƒµ«¬º’ ∫≈(UserCode)'){ this.value='';};document.getElementById('LB_ErrorMsg').style.display = 'none';" ForeColor="#000000" class="dengl" Width="103%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">&nbsp;</td>
