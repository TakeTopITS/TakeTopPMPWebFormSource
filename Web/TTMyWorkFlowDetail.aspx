            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div id="AboveDiv">
                        ...
                        <table style="width: 100%; background-color: buttonface;" cellpadding="2" cellspacing="0" class="formBgStyle" >
                            <tr>
                                <td style="width: 100px; text-align: left; font-weight: bold; color: #394f66;">
                                    <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,WoDeChuLiFangFaHeYiJian%>"></asp:Label>
                                </td>

                                <td style="width: 500px; text-align: left; font-weight: bold; color: #394f66; ">

                                    <asp:TextBox ID="TB_Content" TextMode="MultiLine" runat="server" Width="99%" Height="60px"></asp:TextBox>
                                </td>

                                <td style="width: 100px; text-align: center; color: #394f66; ">
                                ...
                                <td style="width: 100px; text-align: center; font-weight: bold; color: #394f66;">
                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindowWFTStepDetail" name="fixedDivNoConfirm"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td valign="top" style="padding: 5px 5px 5px 5px;" class="ItemAlignLeft">
