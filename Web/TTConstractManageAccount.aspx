                                    ...
                                    <div style="margin: 5px;">
                                        <div style="float: left;">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="LB_Contractid" runat="server" Text="<%$ Resources:lang,GeTongBianHao%>"> </asp:Label>:</td>
                                                        <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label3" runat="server" Text="<%$ Resources:lang,HeTongLeiXing%>"> </asp:Label>:
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,ZZXZHT%>"> </asp:Label></td>
                                                        <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,HeTongZhuangTai%>" > </asp:Label>:
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:lang,QianShuRiQi%>" > </asp:Label>
                                                    </td>
                                                    <td>
