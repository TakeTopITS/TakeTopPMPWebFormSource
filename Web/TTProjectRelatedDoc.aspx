...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //            showAlertAtMouse('No rows selected.');
        //            return;
        //        }
                                    ...
                                    <cc1:TabContainer CssClass="ajax_tab_menu" ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <%--   <td width="10%" class="ItemAlignLeft">
                                                                                    <strong>
                                                                                         <asp:Label ID="Label2881" runat="server" Text="<%$ Resources:lang,FuLei %>"></asp:Label></strong>
                                                                                </td>--%>
                                                                                <td width="10%" class="ItemAlignLeft">
                                                                                    <strong>
                                        ...
                                        <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="模板下载">
                                            ...
                                            <ContentTemplate>
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="width: 20%; text-align: left; padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0;"
                                                            valign="top">
