...
public partial class TTContactListSAAS : System.Web.UI.Page
{
    ...
    protected void AddContact()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click4", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZYHDMYHMCMMZWEMAILDBNWKJC") + "')", true);
        }
    }
    ...
    protected void BT_Send_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXXYTSGSMSXRYDEMAILHSJQJSTXTM") + "')", true);
    }
