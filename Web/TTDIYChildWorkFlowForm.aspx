                            ...
                            <td style="padding-left: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="2" class="tdRight" style="width: 320px;" class="ItemAlignLeft">
                                              <asp:TextBox ID="TB_WLDescription" runat="server" Font-Size="10pt"      Width="99%" ></asp:TextBox>
                                        </td>
                                        <td class="tdLeft"></td>
                                        <td colspan="2"class="ItemAlignLeft" style="cursor:pointer; background-color:forestgreen;color:white;">
                ...
                <tr>
                    <td id="td_WFMain" width="370" style="padding: 5px 5px 5px 5px; vertical-align: top;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="ItemAlignLeft" style="padding: 20px 1px 1px 1px;" onmousemove="document.getElementById('DL_WorkFlow').style.width = '500px'" onmouseout="document.getElementById('DL_WorkFlow').style.width = '370px'">
