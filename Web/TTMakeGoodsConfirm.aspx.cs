...
public partial class TTMakeGoodsConfirm : System.Web.UI.Page
{
    ...
    protected void DataGrid5_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Delete")
            {
                if (ts.Days > 3)
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZShanChuShiBaiZhiNengShanChuS")+"')", true);
                    return;
                }
    ...
    protected void AddDetail()
    {
        ...
        if (strSourceType == "GoodsPJRecord")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click2333", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZDiShiRuKuLiangChaoChuXuQiuLi")+"')", true);
            }
        }

        if (strOwnerCode == "" | strType == "" | strGoodsCode == "" | strSpec == "" | strPosition == "")
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click3432424234", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZYSRHYXDBNWKJC") + "')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','true','popDetailWindow') ", true);
    ...
    protected void UpdateDetail()
    {
        ...
        if (strOwnerCode == "" | strType == "" | strGoodsCode == "" | strSpec == "" | strPosition == "")
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "clickDFFASDDFASF", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZYSRHYXDBNWKJC") + "')", true);
            ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "pop", "popShow('popwindow','true','popDetailWindow') ", true);
        ...
        else
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click3444", "showAlertAtMouse('" + err.Message.ToString() + "')", true);
