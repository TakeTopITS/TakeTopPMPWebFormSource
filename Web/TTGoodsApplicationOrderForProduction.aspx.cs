        ...
        if (strSourceType == "GoodsPJRecord")
{
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click2333", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZDiShiLingLiaoLiangChaoChuXuQ")+"')", true);
            }
        }
