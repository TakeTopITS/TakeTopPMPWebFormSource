...
public partial class TTCarApplyForm : System.Web.UI.Page
{
    ...
    protected void AddCarAppply()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZHCSJBNXYYCSJJC") + "')", true);
    ...
    protected string SubmitApply()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCLSSCCG") + "')", true);
            }
            catch
            {
                strWLID = "0";

                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCLSSCSBKNSMCZSGDJC") + "')", true);
            }
