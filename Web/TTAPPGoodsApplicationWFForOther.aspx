                    ...
                    <div class="layui-layer layui-layer-iframe" id="popwindow" name="fixedDiv"
                        ...
                        <div id="popwindow_content" class="layui-layer-content" style="overflow: auto; padding: 0px 5px 0px 5px;">
                            <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="ItemAlignLeft" style="width: 60%; vertical-align: middle;">
                                                ...
                                                <td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="ItemAlignLeft" width="5%"><strong></td>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td class="ItemAlignLeft" colspan="2" style="height: 6px; text-align: right;">
                                        <table width="100%">
                                            <tr>
                                                <td class="ItemAlignLeft" style="width: 550px; height: 27px"><span style="font-size: 10pt">(<asp:Label ID="Label37" runat="server" Text="<%$ Resources:lang,YaoQiuShouDaoXingXi%>"></asp:Label>:</span><asp:CheckBox ID="CB_SMS" runat="server"
