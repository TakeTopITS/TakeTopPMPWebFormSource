                            ...
                            <tr>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="ItemAlignLeft" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0;">
                                                <table width="98%" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="formItemBgStyleForAlignLeft" colspan="3" >
                                                            ...
                                                            &nbsp;<asp:Button ID="BT_DeletePO" runat="server" CssClass="inpu" Enabled="False" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        ...
                                                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/EquipmentDataImportTemplate.xls"><asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,SBSJDRMB%>"></asp:Label></a>
                                                                        <div id="ProgressBar">
