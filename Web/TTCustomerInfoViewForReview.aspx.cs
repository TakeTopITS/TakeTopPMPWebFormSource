...
public partial class TTCustomerInfoViewForReview : System.Web.UI.Page
{
    ...
    protected void BT_Approve_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZPZBACG") + "')", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZPZBASBQJC") + "')", true);
        }
    }
    ...
    protected void BT_Refuse_Click(object sender, EventArgs e)
    {
        ...
        {
            customerBLL.UpdateCustomer(customer, strCustomerCode);
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZQQBACG") + "')", true);
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZQQBASBQJC") + "')", true);
        }
    }
