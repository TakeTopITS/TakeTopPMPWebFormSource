...
public partial class DefaultSAAS : System.Web.UI.Page
{
    ...
    protected void LB_Login_Click(object sender, EventArgs e)
    {
        ...
        if (strVerificationCode == "YES")
        {
            ...
            //    if (strSMSCode == "")
            //    {
            //        ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGYSJDXMYZXDDXM") + "');</script>");
            //        return;
            //    }
            //    else
            //    {
            ...
            //        {
            //            ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('" + LanguageHandle.GetWord("ZZJGDXYZMCWJC") + "');</script>");
            //            return;
            //        }
            //    }
            //}
