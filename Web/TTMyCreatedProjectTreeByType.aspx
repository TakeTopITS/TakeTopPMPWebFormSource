                ...
                <tr>
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="230" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0" valign="top"
                                    class="ItemAlignLeft">
                                ...
                                <td style="width: 100%; height: 1px; vertical-align: top;">
                                    <table width="98%" cellpadding="0" cellspacing="5" class="ItemAlignLeft">
                                        <tr>
                                            <td class="ItemAlignLeft">
                                                    ...
                                                    <ItemTemplate>
                                                        <table style="width: 100%;" cellpadding="4" cellspacing="0" class="bian">
                                                            <tr>
                                                                ...
                                                                <td style="width: 40%; height: 20px;" class="ItemAlignLeft">
                                                                    <%#DataBinder .Eval (Container .DataItem ,"UserName") %>
                                                                </td>
                                                                <td style="width: 10%; height: 20px; text-align: right">
