                                                    ...
                                                    <table style="text-align: center; display: none;">
                                                        <tr>
                                                            <td class="formItemBgStyleForAlignLeft">
                                                                ...
                                                                <asp:Button ID="BT_DeletePhoto" runat="server" Visible="false" CssClass="inpu" Enabled="False" OnClick="BT_DeletePhoto_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
