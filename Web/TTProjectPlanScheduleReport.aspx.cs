...
public partial class TTProjectPlanScheduleReport : System.Web.UI.Page
{
    ...
    private string getReportTable(DateTime dtBegin, DateTime dtEnd)
    {
        ...
        rt.monthNum = nMonth;
        //标题
        rt.Report_Title = LanguageHandle.GetWord("XiangMu") + LanguageHandle.GetWord("JiHuaWanCheng") + LanguageHandle.GetWord("JinDu") + LanguageHandle.GetWord("BaoBiao");
        //画表头
        ...
        HeaderLevel.headrow.Add(new Report_Frame_Cell(LanguageHandle.GetWord("JiHua")+ LanguageHandle.GetWord("BuZou"), 1, 2, 500));
