                ...
                <ContentTemplate>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        ...
                                                                        <asp:Label ID="Label29" runat="server"></asp:Label><asp:Label ID="Label30" runat="server" Text="<%$ Resources:lang,SJDRMBGS%>"></asp:Label>:<a href="Template/NewTemplateForKPIIndicatorLibraryImport.xls"><asp:Label ID="Label31" runat="server" Text="<%$ Resources:lang,SJDRMB%>"></asp:Label></a>
                                                                        <div id="ProgressBar">
                                                ...
                                                <table class="formBgStyle" style="width: 100%; text-align: left;" cellpadding="3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="formItemBgStyleForAlignLeft">
                                                            ...
                                                            &nbsp;<asp:Button ID="BT_Delete" runat="server" Enabled="False" CssClass="inpu" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Style="display: none;">
                        <div class="modalPopup-text" style="width: 273px; height: 400px; overflow: auto;">
                            <table>
                                <tr>
                                    <td style="width: 220px; padding: 5px 5px 5px 5px;" valign="top" class="ItemAlignLeft"></td>
                                    <td style="width: 60px; padding: 5px 5px 5px 5px;" valign="top" class="ItemAlignLeft"></td>
                                </tr>
                            </table>
                        </div>
                    </asp:Panel>
