                                            ...
                                            <table style="width:99%">
                                                ...
                                                <tr>
                                                    <td class="ItemAlignLeft">
                                                        ...
                                                        &nbsp;<asp:Button CssClass="inpu" ID="BT_GoodsTypeDelete" runat="server" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_GoodsTypeDelete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
