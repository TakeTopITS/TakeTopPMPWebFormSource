                ...
                <ContentTemplate>
                    <div id="AboveDiv">
                        <table id="AboveTable" cellpadding="0" width="100%" cellspacing="0" class="bian">
                            <tr id="TR_FullScreen">
                                <td class="ItemAlignLeft" style="width: 100%; padding-left: 1px;" class="page_topbj">
                                    <table>
                                        <tr>
                            ...
                            <tr>
                                <td class="ItemAlignLeft" style="width: 100%; padding-left: 1px;">
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td width="110px" class="ItemAlignLeft">
                                                                                    <strong>
                                                                                ...
                                                                                <td width="60px" class="ItemAlignLeft">
                                                                                    <strong>
                                                                                ...
                                                                                <td class="ItemAlignLeft">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:lang,PingHe%>"></asp:Label></strong>
                                                                                </td>
                                                                                <td class="ItemAlignLeft">
                                                                                    <strong>
                                                                                        <asp:Label ID="Label123" runat="server" Text="<%$ Resources:lang,Plan%>"></asp:Label></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                                    ...
                                                                                    <table width="1250px">
                                                                                        <tr>
                                                                                            <td width="400px">
                                                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td style="width: 230px; padding: 5px 0px 0px 5px" valign="top" class="ItemAlignLeft">
                                                                                                            <table>
                                                                                                                <tr>
                                                                                                        ...
                                                                                                        <td valign="top" width="220px" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0;">
