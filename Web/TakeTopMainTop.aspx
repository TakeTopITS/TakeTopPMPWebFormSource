                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td width="40px" align="center" style="padding-top: 0px; padding-bottom: 5px;">
                                                                <a href="#" onclick="return confirmExit(getExitMsgByLangCode(), this, event, 'Default.aspx');" class="tt-logout-btn" style="display:inline-flex;align-items:center;gap:4px;padding:4px 10px;font-size:12px;text-decoration:none;white-space:nowrap;">&#x23FB; �˳�</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
