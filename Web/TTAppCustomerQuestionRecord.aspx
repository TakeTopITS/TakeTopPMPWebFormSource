...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .datagrid-table .custom-delete-icon {
            cursor: pointer;
        ...
        .datagrid-table .custom-delete-icon:active {
            background: #f5f5f5;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* 确保弹窗底部按钮可见 */
            .layui-layer-iframe #popwindow_footer {
                position: relative;
                bottom: 0;
                left: 0;
                right: 0;
            ...
            .datagrid-table .itemBorder:first-child {
                width: 50px;
            }

            .datagrid-table .itemBorder:nth-child(2) {
                width: 50px;
            }
            ...
            .form-input-group .mobile-input,
            .form-input-group .mobile-button {
                width: 100%;
            }
        }
