                        ...
                        <td align="center">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td class="ItemAlignLeft" style="padding-top: 7px;padding-left:20px;">
                                    ...
                                    <td id="TD_Printer" runat="server" class="ItemAlignLeft" style="padding-left: 30px; padding-top: 5px;">
                                        <a id="aPrintForm" runat="server" href="#" onclick="preview1()">
                                            <img src="ImagesSkin/print.gif" alt="鎵撳嵃" border="0" />
                                        </a>
                                    </td>
                                    <td class="ItemAlignLeft" style="padding-top: 7px;padding-left:20px;">
                                        <asp:Button ID="BT_DeleteWorkflowTemplate" runat="server" CssClass="inpuDelete" Text="X" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" OnClick="BT_DeleteWorkflowTemplate_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
