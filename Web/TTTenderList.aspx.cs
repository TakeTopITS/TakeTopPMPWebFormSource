...
public partial class TTTenderList : System.Web.UI.Page
{
    ...
    protected void AddMain()
    {
        try
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZZBBHYJCZBNZF") + "')", true);
                return;
            }
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZCuoWuTouBiaoBaoJiaHeKongZhiJ")+"')", true);
                return;
            }
        ...
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                if (lst != null && lst.Count > 0)
                {
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZShiBaiCiTouBiaoYiWanChengBuN")+"')", true);
                    }
                }
                else
                {
    ...
    protected void DataGrid3_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXZTBCNZJCY") + "')", true);
        }
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName != "Page")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZXZKHCNZJCY") + "')", true);
            }
    ...
    protected string SubmitApply()
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZTouBiaoShenQingShengChengChe")+"')", true);
        }
        catch
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZJingGaoTouBiaoShenQingShengC")+"')", true);
