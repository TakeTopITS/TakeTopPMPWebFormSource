                        ...
                        <div id="DIV_HidePrint">
                            <table>
                                <tr>
                                    ...
                                    <td width="100px" class="ItemAlignLeft" style="padding-top: 5px;">
                        ...
                        <div id="DIV_LargeTable" style="text-align: center; padding: 10px 10px 10px 10px; width: 2000px;">
                            ...
                            <table border="1" cellpadding="0" cellspacing="0" width="2000" style="border-collapse: collapse;">
                                <tr class="xl69">
                                    ...
                                    <td colspan="3" class="auto-style262" width="216" class="ItemAlignLeft">日期:<asp:Label ID="LB_ReportTime" runat="server"></asp:Label>
                                    </td>
                                    <td class="auto-style374" width="186" class="ItemAlignLeft" colspan="6">
                                ...
                                <tr class="xl117">
                                    ...
                                    <td class="xl160" width="209" class="ItemAlignLeft" colspan="4" rowspan="6">主要内容:
                                    <br />
                                ...
                                <tr>
                                    <td width="40%">
                                        <table border="1" cellpadding="0" cellspacing="0" width="800" style='border-collapse: collapse; text-align: center;'>
                                            <tr height="53" style="height: 39.65px">
                                                <td colspan="3" height="53" class="ItemAlignLeft" style="height: 39.65px; font-size: x-large;">
                                                    <br />
                                                    奖金包干总额月度奖金额明细表
                                                    <br />
                                                    <br />
                                            ...
                                            <tr height="17" style="height: 13.0px">
                                                <td colspan="3" height="17" class="ItemAlignLeft" style="height: 13.0px; border-top-style: none; border-top-color: inherit; border-top-width: medium;">
                                    ...
                                    <td width="60%">
                                        <table border="1" cellpadding="0" cellspacing="0" width="1180px" style='border-collapse: collapse;'>
                                            <tr height="53">
                                                <td height="53" class="ItemAlignLeft" style="font-size: x-large;">
                                                    <br />
                                                    项目成本收入分析总图
                                                    <br />
                                                    <br />
