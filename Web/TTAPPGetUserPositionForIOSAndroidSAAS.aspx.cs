...
public partial class TTAPPGetUserPositionForIOSAndroidSAAS : System.Web.UI.Page
{
    ...
    protected void BT_SavePosition_Click(object sender, EventArgs e)
    {
        ...
        ClientScript.RegisterStartupScript(this.GetType(), "444", "<script>showAlertAtMouse('OK');</script>");
    }
    ...
    protected void BT_Attendance_Click(object sender, EventArgs e)
    {
        ...
        if (strLeaderCode == "")
        {
            ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('" + LanguageHandle.GetWord("ZZBNQDGSZGBNWKQJC") + "');</script>");
            return;
        }
        ...
        ClientScript.RegisterStartupScript(this.GetType(), "", "<script>showAlertAtMouse('OK');</script>");
