                                        ...
                                        <tr>
                                            <td style="padding-top: 5px">
                                                <table width="98%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="ItemAlignLeft" style="font-weight: bold; height: 24px; color: #394f66; background-image: url('ImagesSkin/titleBG.jpg')">
                                                            ...
                                                            <table width="98%">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="BT_DeleteQuestion" runat="server" CssClass="inpu" OnClick="BT_DeleteQuestion_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" Text="<%$ Resources:lang,ShanChu%>" />
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="ItemAlignLeft" valign="top">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan="5"  class="formItemBgStyleForAlignLeft">
                                                                                                <asp:Button ID="BT_Add" CssClass="inpu" runat="server" Text="<%$ Resources:lang,XinJian %>" OnClick="BT_Add_Click" /><asp:Button ID="BT_Update" runat="server" CssClass="inpu" Enabled="False"
                                                                                                    OnClick="BT_Update_Click" Text="<%$ Resources:lang,BaoCun %>" /><asp:Button ID="BT_Delete" runat="server" CssClass="inpu" Enabled="False" OnClick="BT_Delete_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)"
                                                                        ...
                                                                        <table style="width: 98%; padding: 5px 0px 0px 5px" cellpadding="3" cellspacing="0" class="formBgStyle">
                                                                            <tr>
                                                                                <td width="200px" valign="top" class="formItemBgStyleForAlignLeft">
                                                                                    <table width="98%">
                                                                                        <tr>
                                                                                            <td width="200px" class="ItemAlignLeft" valign="top">
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" background="ImagesSkin/main_n_bj.jpg">
                                                                                                    <tr>
                                                                                                        <td width="7">
                                                                                                            <img src="ImagesSkin/main_n_l.jpg" width="7" height="26" /></td>
                                                                                                        <td>
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    <td width="95%" class="ItemAlignLeft"><strong>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td width="200px" class="ItemAlignLeft" valign="top">
                                                                                                ...
                                                                                                <asp:TextBox ID="TB_CandidateName" runat="server"></asp:TextBox><asp:Button ID="BT_AddCandidate" runat="server" Text="<%$ Resources:lang,XinZeng %>"
                                                                                                    CssClass="inpu" OnClick="BT_AddCandidate_Click" />&#160;&#160;<asp:Button ID="BT_DeleteCandidate" runat="server" CssClass="inpu" Text="<%$ Resources:lang,ShanChu %>" OnClick="BT_DeleteCandidate_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" /></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                        ...
                                                                                        <asp:DataList ID="DataList1" runat="server" CellPadding="4" ForeColor="#333333" Width="98%">
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <table style="width: 100%; table-layout: fixed;">
                                                                                                    <tr>
                                                                                                        <td class="ItemAlignLeft" style="color: Blue; font-style: italic;">
