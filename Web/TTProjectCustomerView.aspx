                                                            ...
                                                            <ItemTemplate>
                                                                <table cellpadding="4" cellspacing="0" class="bian" style="width: 100%;">
                                                                    <tr>
                                                                        ...
                                                                        <td class="ItemAlignLeft" style="width: 20%"><%# DataBinder.Eval(Container.DataItem,"CustomerCode") %></td>
                                                                        <td style="width: 10%; text-align: right;">
                                                                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:lang,KeHuMingCheng%>"></asp:Label>: </td>
                                                                        <td class="ItemAlignLeft" colspan="3"><%# DataBinder.Eval(Container.DataItem,"CustomerName") %></td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="ItemAlignLeft" style="width: 100px"><%# DataBinder.Eval(Container.DataItem,"Type") %></td>
                                                                        <td style="width: 100px; text-align: right;">
