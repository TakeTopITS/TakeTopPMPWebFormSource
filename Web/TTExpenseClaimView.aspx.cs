...
public partial class TTExpenseClaimView : System.Web.UI.Page
{
    ...
    protected void BT_FindAOCode_Click(object sender, EventArgs e)
    {
        ...
        strHQL += " expenseClaim.ApplicantCode = '" + strUserCode + "'";
        strHQL += " and expenseClaim.ECID = " + TB_AOCode.Text.Trim();
    ...
    protected void BT_Find_Click(object sender, EventArgs e)
    {
        ...
        strHQL += " and expenseClaim.ApplicantCode = '" + strUserCode + "'";
    ...
    protected void LoadExpenseClaim(string strApplicantCode)
    {
        string strHQL;
        IList lst;
        decimal deExpense = 0;

        strHQL = "from ExpenseClaim as expenseClaim where expenseClaim.ApplicantCode = " + "'" + strApplicantCode + "'";
        strHQL += " Order by expenseClaim.ECID DESC";
        ExpenseClaimBLL expenseClaimBLL = new ExpenseClaimBLL();
        lst = expenseClaimBLL.GetAllExpenseClaims(strHQL);
