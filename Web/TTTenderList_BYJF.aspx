                            ...
                            <td>
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="border-right: solid 1px #d0d0d0; padding: 5px 5px 5px 5px;"
                                            valign="top">
                                            ...
                                            <table background="ImagesSkin/main_n_bj.jpg" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td colspan="2" width="10%" class="ItemAlignLeft">
                                                        <strong>
                                                    ...
                                                    <td width="26%" class="ItemAlignLeft">
                                                        <strong>
                ...
                <div class="layui-layer layui-layer-iframe" id="popwindow"
                    ...
                    <div id="popwindow_content" class="layui-layer-content" style="text-align: left; overflow: auto; padding: 0px 5px 0px 5px;">
                        ...
                        <table width="60%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="100%" class="ItemAlignLeft" style="padding: 5px 5px 0px 5px; border-right: solid 1px #d0d0d0; vertical-align: top;">
