    ...
    protected void FinishPercentPicture3()
    {
        ...
        for (i = 0; i < DataGrid3.Items.Count; i++)
        {
            ...
            System.Web.UI.HtmlControls.HtmlGenericControl progressBar =
                (System.Web.UI.HtmlControls.HtmlGenericControl)DataGrid3.Items[i].FindControl("ProgressBar3");
            ...
            // 设置文字Label - 保持原有逻辑
            Label lbFinishPercent = (Label)DataGrid3.Items[i].FindControl("LB_FinishPercent");
