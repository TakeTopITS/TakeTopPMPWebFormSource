                                                                                    ...
                                                                                    <table cellpadding="4" cellspacing="0" style="width: 100%;">
                                                                                        <tr>
                                                                                            <td style="width: 15%; text-align: right;">
                                                                                                ...
                                                                                                : </td>
                                                                                            <td class="ItemAlignLeft" style="width: 20%"><%# DataBinder.Eval(Container.DataItem,"ID") %></td>
                                                                                            ...
                                                                                            <td style="text-align: right">
                                                                                                ...
                                                                                                : </td>
                                                                                            <td class="ItemAlignLeft"><%# DataBinder.Eval(Container.DataItem,"ManHour") %></td>
                                                                                            <td style="text-align: right">
                                                                                                <asp:Label ID="Label14" runat="server" Text="<%$ Resources:lang,FeiYong%>"></asp:Label>
                                                                                                : </td>
                                                                                            <td class="ItemAlignLeft"><%# DataBinder.Eval(Container.DataItem,"Expense") %></td>
                                                                                        ...
                                                                                        <tr style="display: none;">
                                                                                            <td style="text-align: right;">
                                                                                                ...
                                                                                                : </td>
                                                                                            <td class="ItemAlignLeft"><%# DataBinder.Eval(Container.DataItem,"BeginDate","{0:yyyy/MM/dd}") %></td>
                                                                                            <td style="text-align: right;">
                                                                                                <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,JieShuShiJian%>"></asp:Label>
                                                                                                : </td>
                                                                                            <td class="ItemAlignLeft"><%# DataBinder.Eval(Container.DataItem, "EndDate", "{0:yyyy/MM/dd}")%></td>
                                                                                            <td style="text-align: right;">
                                                                        ...
                                                                        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="ajax_tab_menu" Width="98%">
                                                                            <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TaskHandling">
                                                                                ...
                                                                                <ContentTemplate>
                                                                                                ...
                                                                                                <table cellpadding="3" cellspacing="0" class="formBgStyle" width="100%">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="formItemBgStyleForAlignLeft">
                                                                                                            ...
                                                                                                            :
                                                                                                            <NickLee:NumberBox ID="NB_ManHour" runat="server" MaxAmount="1000000000000" MinAmount="-1000000000000" OnBlur="" OnFocus="" OnKeyPress="" PositiveColor="" Width="60px">0.00</NickLee:NumberBox><asp:Label ID="Label4811" runat="server" Text="<%$ Resources:lang,Tian %>"></asp:Label>
                                                                                    ...
                                                                                    <b>
                                                                                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:lang,SuoYouFenPaiJiLu%>"></asp:Label></b>
                                                                                    <br />
