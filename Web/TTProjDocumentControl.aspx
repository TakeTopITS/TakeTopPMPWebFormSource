                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="bian">
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <table class="ItemAlignLeft" width="98%">
                                    <tr>
                                        <td class="ItemAlignLeft" style="padding: 10px 5px 5px 5px;">
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="8%" class="ItemAlignLeft"></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            </tr>
                                    ...
                                    <td class="ItemAlignLeft">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItemBgStyleForAlignLeft" style="text-align: left;">
                                                    <asp:TextBox ID="txtSortNo" runat="server" ToolTip="大于或等于0的整数" Width="100px">0</asp:TextBox>  <asp:Button ID="BT_NewDocType" runat="server" Text="<%$ Resources:lang,ZengJiaZiJieDian%>" CssClass="inpu" Enabled="False" OnClick="BT_NewDocType_Click" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItemBgStyleForAlignLeft">
                                               ...
                                               <td class="formItemBgStyleForAlignLeft">
                                                  ...
                                                  <asp:Button ID="BT_UpdateDocType" runat="server" Enabled="False" CssClass="inpu" Text="<%$ Resources:lang,BaoCun%>" OnClick="BT_UpdateDocType_Click" />
                                                    &nbsp;&nbsp;<asp:Button ID="BT_DeleteDocType" runat="server" Enabled="False" CssClass="inpu" Text="<%$ Resources:lang,ShanChu%>" OnClick="BT_DeleteDocType_Click" />
