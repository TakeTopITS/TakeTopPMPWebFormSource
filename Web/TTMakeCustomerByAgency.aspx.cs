...
public partial class TTMakeCustomerByAgency : System.Web.UI.Page
{
        ...
        if (e.CommandName != "Page")
        {
            ...
            if (e.CommandName == "SubmitReview")
            {
                if (strCustomerCode != "")
                {
                    ...
                    if (strReviewStatus == "SUCCESS")
                    {
                        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZYJBACGQBYCFTJ") + "')", true);
                        return;
                    }
                    ...
                    try
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZTJBACG") + "')", true);
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZTJBASBQJC") + "')", true);
                }
            ...
            if (e.CommandName == "Delete")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZSBCZKFJLBNSCJC") + "')", true);
                    return;
                }
    ...
    protected void AddCustomer()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZKHDMMCHLXBNWKJC") + "')", true);
        }
    }
