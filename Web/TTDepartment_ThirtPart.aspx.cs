...
public partial class TTDepartment_ThirtPart : System.Web.UI.Page
{
    ...
    protected void AddDepartment()
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZBMDMBMMCHSJBMBNWKJC") + "')", true);
        }
    }
    ...
    protected void DataGrid2_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCBMBSNCJNBNSCGLXYH") + "')", true);
            }
        }
    }
    ...
    protected void DataGrid3_ItemCommand(object sender, DataGridCommandEventArgs e)
    {
        ...
        if (e.CommandName != "Page")
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("ZZCBMBSNCJNBNTJGLYH") + "')", true);
            }
        }
    }
