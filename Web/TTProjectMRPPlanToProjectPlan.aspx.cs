...
public partial class TTProjectMRPPlanToProjectPlan : System.Web.UI.Page
{
    ...
    public bool DeleteProjectPlan(string strProjectID, string strPlanVerID)
    {
        ...
        catch (Exception err)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZDiShiQingXianShuaZeXiangMu")+"')", true);
                return false;
            }
        }
    ...
    protected void BT_TransferPlan_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZShiBaiQingXianShuaZeXiangMuH")+"')", true);
        }
    }
    ...
    public static int CopyImplePlanDependencyAndResources(int intPID, int intNewPID)
    {
        ...
        {
            ///抛出异常
            //ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" +LanguageHandle.GetWord("ZZChuShiHuaMoZuShuJuShiBai")+"')", true);
