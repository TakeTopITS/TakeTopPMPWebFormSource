                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="100%" class="ItemAlignLeft" style="padding: 5px 5px 5px 5px;">
                                                <table width="100%">
                                                    <tr>
                                                        <td width="80%" class="ItemAlignLeft">
                                                            <table width="900px">
                                                                <tr>
                                                                    ...
                                                                    <td width="15%" align="right">
                                                                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:lang,Status%>"></asp:Label>:</td>
                                                                    <td width="25%" class="ItemAlignLeft">
                                                                        <asp:DropDownList ID="DL_FindStatus" runat="server" DataTextField="HomeName"
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2" width="10%" align="center">
                                                                        <strong>
                                                                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:lang,FenPeiYuShuan%>" />
                                                                        </strong>
                                                                    </td>
                                                                    <td width="5%" class="ItemAlignLeft">
                                                                        <strong></strong>
                                                            ...
                                                            <ItemTemplate>
                                                                <div>
                                                                    <asp:HyperLink ID="HL_ProjectReport" runat="server" NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.ProjectID", "TTProjectReportMain.aspx?ProjectID={0}") %>'
                                                                        Target="_blank" Text="<%$ Resources:lang,BaoBiao%>"></asp:HyperLink>
                                                                </div>
                                                            </ItemTemplate>
                                                            <ItemStyle CssClass="itemBorder" HorizontalAlign="left" Width="5%" />
                                                        </asp:TemplateColumn>
                                                            ...
                                                            <td>
                                                                <table width="100%" cellpadding="2" cellspacing="0" class="formBgStyle">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3" class="ItemAlignLeft" style="width: 100%;" class="formItemBgStyleForAlignLeft">
