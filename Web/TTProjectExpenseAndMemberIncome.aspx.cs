...
public partial class TTProjectExpenseAndMemberIncome : System.Web.UI.Page
{
    ...
    protected void BT_RefreshWorkhour_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("SuoXingWanCheng") + "')", true);
        }
        catch
        {
            ScriptManager.RegisterStartupScript(this.UpdatePanel1, this.GetType(), "click", "showAlertAtMouse('" + LanguageHandle.GetWord("SuoXingWanChengQingJianCha") + "')", true);
        }
    }
