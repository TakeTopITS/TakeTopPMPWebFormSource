...
public partial class TTConstractChangeReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack != true)
        {
            ...
            //strHQL = "Select * From V_ConatractChangeReport Where 1=1 ";
            ...
            //strHQL += " Order by ChangeTime DESC";
    ...
    {
        string strHQL;
        string strConstractCode, strConstractName, strProjectName;
        ...
        {
            strHQL += " and ChangeTime >= " + "'" + strStartTime + "'";
        }
        if (!string.IsNullOrEmpty(strEndTime))
        {
            strHQL += " and ChangeTime <=" + "'" + strEndTime + "'";
        }
        strHQL += " Order by ChangeTime DESC";
    ...
    {
        int i;
        decimal deChangeAmount = 0;

        for (i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            deChangeAmount += decimal.Parse(ds.Tables[0].Rows[i]["ChangeBalance"].ToString());
       
        }

        LB_TotalChangeAmount.Text = deChangeAmount.ToString();
    }
