                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" class="bian">
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" class="ItemAlignLeft" style="font-size: smaller;">
                                                                                <strong>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table width="100%">
                                                            <tr>
                                                                <td class="ItemAlignLeft" width="40%" style="padding: 1px 1px 1px 1px;">
                                                                ...
                                                                <td class="ItemAlignLeft" width="60%" style="padding: 1px 1px 1px 1px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="3" class="tdRight" style="text-align: center; padding: 2px 0px 2px 5px; width: 370px;">
                                                                    <asp:Button ID="BT_DeleteTem" runat="server" Text="<%$ Resources:lang,ShanChu%>" CssClass="inpu" Enabled="false"
                                                                        OnClick="BT_DeleteTem_Click" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" />
                                                                    &nbsp;&nbsp;
