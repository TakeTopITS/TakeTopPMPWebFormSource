                                            ...
                                            <ContentTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:DropDownList ID="DL_WFTemplate" runat="server" DataTextField="TemName" DataValueField="TemName"
                                                        ...
                                                        <asp:Button ID="BT_DeleteByID" CssClass="inpu" runat="server" Text="<%$ Resources:lang,ShanChu%>" OnClientClick="return confirmContinue(getDeleteMsgByLangCode(), this, event)" OnClick="BT_DeleteByID_Click" Visible="false"/>
                                                    </td>
                                                </tr>
